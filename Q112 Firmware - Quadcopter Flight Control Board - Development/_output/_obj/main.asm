...
CFILE 0000H 00000F71H "main\\main.c"
...
CLINEA 0000H 0001H 021CH 0003H 004BH
	bl	_Initialization

;;		main_clrWDT();				//kick the dog...1.34uS duration
CLINEA 0000H 0001H 021DH 0003H 0034H
	bl	_main_clrWDT

;;		CalibrateMotors();			//Time-consuming ~6s
CLINEA 0000H 0001H 021EH 0003H 002BH
	bl	_CalibrateMotors

;;		CalibrateGyro();			//Enter Calibration Sequence for Gyro
CLINEA 0000H 0001H 021FH 0003H 003AH
	bl	_CalibrateGyro

;;			Accel_Zcal[0] = -162;
CLINEA 0000H 0001H 0226H 0004H 0018H
	mov	er0,	#0 
	mov	r2,	#022h
	mov	r3,	#0c3h
...
CLINEA 0000H 0001H 0238H 0003H 004BH
	mov	r0,	#00h
	st	r0,	NEAR _Accel_SavIndex

;;		Accel_RetIndex = 0;
CLINEA 0000H 0001H 0239H 0003H 0015H
	st	r0,	NEAR _Accel_RetIndex

;;		for(i=0; i<10; i++){
CLINEA 0000H 0001H 023AH 0003H 0016H
	mov	er4,	#0 
_$L34 :
CBLOCK 257 3 570
...
;;		for(i=0; i<10; i++){
CLINEA 0000H 0000H 023AH 0003H 0016H
	add	er4,	#1 
	cmp	r4,	#0ah
	cmpc	r5,	#00h
	blts	_$L34
...
CLINEA 0000H 0001H 0242H 0003H 0031H
	sb	0f011h.7

;;		SoftStart();				//Smoothly bring up the Motor RPM
CLINEA 0000H 0001H 0245H 0003H 0033H
	bl	_SoftStart

;;		while(PrePIDCount < 10){
CLINEA 0000H 0000H 0246H 0001H 000BH
	bal	_$L58

;;		while(PrePIDCount < 10){
CLINEA 0000H 0000H 0246H 0003H 001AH
_$L40 :
CBLOCK 257 4 582

;;			if(AccGyro_ReadFlag >= 1){		//Triggered by External Interrupt (flag set in AccelGyroDataReady_ISR)
CLINEA 0000H 0001H 0247H 0004H 0065H
...
;;				Get_AccGyroData();
CLINEA 0000H 0001H 0249H 0005H 0016H
	bl	_Get_AccGyroData

;;				AccGyro_ReadFlag = 0;
CLINEA 0000H 0001H 024BH 0005H 0019H
	mov	r0,	#00h
	st	r0,	NEAR _AccGyro_ReadFlag
CBLOCKEND 257 5 588

;;			}
CLINEA 0000H 0000H 024CH 0004H 0004H
_$L42 :

;;			if(AccGyro_CF_FlagCounter > 0){	//This Value is incremented after Get_AccGyroData(); is called
CLINEA 0000H 0001H 024DH 0004H 0061H
...
;;				Run_AccGyroCF();
CLINEA 0000H 0001H 024FH 0005H 0014H
	bl	_Run_AccGyroCF
...
CLINEA 0000H 0000H 0251H 0005H 00A1H
...
CLINEA 0000H 0001H 0253H 0004H 00CBH
...
CLINEA 0000H 0001H 0255H 0005H 001FH
...
CLINEA 0000H 0001H 0260H 0001H 0049H
CLABEL 0030H "Fast_Loop"
_$L48 :

;;		main_clrWDT();				//kick the dog...1.34uS duration
CLINEA 0000H 0001H 0262H 0003H 0034H
	bl	_main_clrWDT

;;		ClearVariables();			//Fresh start each loop...
CLINEA 0000H 0001H 0263H 0003H 0030H
	bl	_ClearVariables

;;		if(AccGyro_ReadFlag >= 1){		//Triggered by External Interrupt (flag set in AccelGyroDataReady_ISR)
CLINEA 0000H 0001H 027EH 0003H 0064H
	l	r0,	NEAR _AccGyro_ReadFlag
	cmp	r0,	#01h
	blt	_$L49
CBLOCK 257 8 638
...
;;			Get_AccGyroData();
CLINEA 0000H 0001H 0280H 0004H 0015H
	bl	_Get_AccGyroData

;;			AccGyro_ReadFlag = 0;
CLINEA 0000H 0001H 0282H 0004H 0018H
	mov	r0,	#00h
	st	r0,	NEAR _AccGyro_ReadFlag
CBLOCKEND 257 8 643
...
;;		if(AccGyro_CF_FlagCounter > 0){	//This Value is incremented after Get_AccGyroData(); is called
CLINEA 0000H 0001H 0284H 0003H 0060H
	l	r0,	NEAR _AccGyro_CF_FlagCounter
	cmp	r0,	#00h
	ble	_$L51
CBLOCK 257 9 644
...
;;			Run_AccGyroCF();
CLINEA 0000H 0001H 0286H 0004H 0013H
	bl	_Run_AccGyroCF

;;			AccGyro_CF_FlagCounter--;	//Decremented because this value is not a static 1/0... number shows number of items in buffer that have not gone though the CF yet
CLINEA 0000H 0000H 0288H 0004H 00A0H
	lea	OFFSET _AccGyro_CF_FlagCounter
	dec	[ea]
CBLOCKEND 257 9 649

;;		}
CLINEA 0000H 0000H 0289H 0003H 0003H
_$L51 :

;;		if(Accel_PID_GoCounter>= 1){		//This increments in the Run_AccGyroCF()... I don't know if this is the best trigger.. but for now, it works.  Calls GetAccGyroData and AccGyroCF once within the routine.
CLINEA 0000H 0001H 028AH 0003H 00CAH
	l	r0,	NEAR _Accel_PID_GoCounter
	cmp	r0,	#01h
	blt	_$L53
CBLOCK 257 10 650
...
;;			AccelSensorControlPID(); 		
CLINEA 0000H 0001H 028CH 0004H 001EH
	bl	_AccelSensorControlPID
...
CLINEA 0000H 0001H 02A3H 0003H 003EH
	l	er0,	NEAR _TestingEndTimer
	cmp	r0,	#0f4h
	cmpc	r1,	#01h
	blt	_$L48
...
;;	LED_2 = 1;			//B7, Pin 11
CLINEA 0000H 0001H 04A3H 0002H 001AH
	sb	0f258h.7
...
;;	LED_4 = 0;		//C2, Pin 14
CLINEA 0000H 0001H 04CBH 0002H 0019H
	rb	0f260h.2
...
CLINEA 0000H 0001H 04E8H 0003H 001DH
	l	er0,	NEAR _CF_Gyro_YPitch
	l	er2,	NEAR _CF_Gyro_YPitch+02h
	st	er0,	NEAR _CF_YPitch
	st	er2,	NEAR _CF_YPitch+02h
...
CLINEA 0000H 0001H 04E9H 0003H 001BH
	l	er0,	NEAR _CF_Gyro_XRoll
	l	er2,	NEAR _CF_Gyro_XRoll+02h
CBLOCKEND 222 4 1258

;;	}
CLINEA 0000H 0000H 04EAH 0002H 0002H
_$L155 :
	st	er0,	NEAR _CF_XRoll
	st	er2,	NEAR _CF_XRoll+02h

;;	Accel_RetIndex++;
CLINEA 0000H 0000H 04ECH 0002H 0012H
	lea	OFFSET _Accel_RetIndex
	inc	[ea]
	l	r0,	NEAR _Accel_RetIndex

;;	if(Accel_RetIndex > 9){
CLINEA 0000H 0001H 04EDH 0002H 0018H
	cmp	r0,	#09h
	ble	_$L156
CBLOCK 222 5 1261

;;		Accel_RetIndex = 0;
CLINEA 0000H 0001H 04EEH 0003H 0015H
	mov	r0,	#00h
	st	r0,	NEAR _Accel_RetIndex
CBLOCKEND 222 5 1263
...
CLINEA 0000H 0000H 0509H 0002H 004BH
	lea	OFFSET _Accel_PID_GoCounter
	inc	[ea]
CBLOCKEND 222 2 1291
...
CLINEA 0000H 0001H 050EH 0001H 0017H
	push	lr
	push	fp
	mov	fp,	sp
	add	sp,	#-08
...
;;	_flgI2CFin = 0;														//reset I2C completed flag
CLINEA 0000H 0001H 0510H 0002H 0038H
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin

;;	i2c_stop();															//Make sure I2C is not currently running
CLINEA 0000H 0001H 0511H 0002H 0043H
	bl	_i2c_stop

;;	i2c_startSend( HMC5883Address, &Mag_ModeReg, 1, &Mag_ModeReg_Contents, 1, (cbfI2c)_funcI2CFin);		//Begin I2C Receive Command
CLINEA 0000H 0001H 0512H 0002H 007DH
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	mov	er0,	#1 
...
;;	while(_flgI2CFin != 1){												//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 0513H 0001H 0001H
	bal	_$L175

;;	while(_flgI2CFin != 1){												//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 0513H 0002H 004EH
_$L161 :
CBLOCK 223 3 1299
...
;;	_flgI2CFin = 0;																	//reset I2C completed Flag
CLINEA 0000H 0001H 0517H 0002H 003BH
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin

;;	i2c_stop();																		//Make sure I2C is not currently running
CLINEA 0000H 0001H 0518H 0002H 0046H
	bl	_i2c_stop

;;	i2c_startReceive(HMC5883Address, &Mag_ReadData, 1, &Mag_Data, 6, (cbfI2c)_funcI2CFin);	//Begin I2C Recieve Command
CLINEA 0000H 0001H 0519H 0002H 0073H
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	mov	er0,	#6 
...
;;	while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 051AH 0001H 0001H
	bal	_$L176

;;	while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 051AH 0002H 0051H
_$L165 :
CBLOCK 223 4 1306

;;		main_clrWDT();
CLINEA 0000H 0001H 051BH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 223 4 1308
...
CLINEA 0000H 0001H 0520H 0002H 002BH
...
CLINEA 0000H 0001H 0522H 0002H 001CH
...
;;	if(Mag_Yout >= 0){
CLINEA 0000H 0001H 0525H 0002H 0013H
	push	xr0
	mov	er0,	#0 
	mov	er2,	#0 
	push	xr0
...
CLINEA 0000H 0000H 0526H 0003H 003FH
...
CBLOCKEND 223 5 1319

;;	}
CLINEA 0000H 0000H 0527H 0002H 0002H
_$L167 :

;;	if(Mag_Yout < 0){
CLINEA 0000H 0001H 0528H 0002H 0012H
	l	er0,	NEAR _Mag_Yout
	l	er2,	NEAR _Mag_Yout+02h
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0000H 0529H 0003H 0040H
	l	er0,	NEAR _Mag_Xout
	l	er2,	NEAR _Mag_Xout+02h
	push	xr0
	l	er0,	NEAR _Mag_Yout
...
CLINEA 0000H 0001H 052CH 0002H 0037H
...
;;	if(Mag_Angle >=360){
CLINEA 0000H 0001H 052DH 0002H 0015H
	push	xr0
	mov	er0,	#0 
	mov	r2,	#0b4h
	mov	r3,	#043h
...
;;		Mag_Angle -= 360;
CLINEA 0000H 0001H 052EH 0003H 0013H
	l	er0,	NEAR _Mag_Angle
	l	er2,	NEAR _Mag_Angle+02h
	push	xr0
	mov	er0,	#0 
...
;;	if(Mag_Angle < 0){
CLINEA 0000H 0001H 0530H 0002H 0013H
	l	er0,	NEAR _Mag_Angle
	l	er2,	NEAR _Mag_Angle+02h
	push	xr0
	mov	er0,	#0 
...
;;		Mag_Angle += 360;
CLINEA 0000H 0001H 0531H 0003H 0013H
	l	er0,	NEAR _Mag_Angle
	l	er2,	NEAR _Mag_Angle+02h
	push	xr0
	mov	er0,	#0 
	...
	st	er0,	NEAR _Mag_Angle
	st	er2,	NEAR _Mag_Angle+02h
CBLOCKEND 223 8 1330

;;	}
CLINEA 0000H 0000H 0532H 0002H 0002H
_$L173 :
CBLOCKEND 223 2 1331
...
CLINEA 0000H 0001H 0535H 0001H 001AH
CBLOCK 224 2 1333
...
;;	Mag_Yout = 0;
CLINEA 0000H 0001H 0538H 0002H 000EH
	st	er0,	NEAR _Mag_Yout
...
;;	Mag_Angle = 0;
CLINEA 0000H 0001H 053AH 0002H 000FH
	st	er0,	NEAR _Mag_Angle
	st	er0,	NEAR _Mag_Angle+02h

;;	Ping_timer = 0;
CLINEA 0000H 0001H 053BH 0002H 0010H
	st	er0,	NEAR _Ping_timer
...
CLINEA 0000H 0001H 053DH 0002H 000FH
	st	er0,	NEAR _Range_out
CBLOCKEND 224 2 1342

;;}
CLINEA 0000H 0001H 053EH 0001H 0001H
	rt
CBLOCKEND 224 1 1342
CFUNCTIONEND 224
...
CLINEA 0000H 0001H 0540H 0001H 001CH
	push	lr
CBLOCK 225 2 1344
CRET 0000H
...
CLINEA 0000H 0001H 0547H 0002H 008CH
...
_$L190 :
	...
	cmp	r0,	#01h
	bne	_$L188
CBLOCKEND 225 2 1363

;;}
CLINEA 0000H 0001H 0553H 0001H 0001H
	pop	pc
CBLOCKEND 225 1 1363
CFUNCTIONEND 225
...
CLINEA 0000H 0001H 0555H 0001H 001BH
	push	lr
CBLOCK 226 2 1365
CRET 0000H
CLOCAL 47H 0002H 0024H 0002H "i" 02H 00H 01H
...
;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 0557H 0002H 0017H
	mov	er0,	#0 
_$L194 :
CBLOCK 226 3 1368

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 0559H 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 226 3 1370

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0557H 0002H 0017H
	add	er0,	#1 
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L194
...
CLINEA 0000H 0001H 055DH 0002H 0047H
	mov	r0,	#BYTE1 OFFSET _Accel_Zout
	mov	r1,	#BYTE2 OFFSET _Accel_Zout
	push	er0
	mov	r0,	#BYTE1 OFFSET _Accel_Yout
...
;;	_flgUartFin = 0;
CLINEA 0000H 0001H 0563H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 0564H 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(SensorReturn, 150, _funcUartFin);
CLINEA 0000H 0001H 0565H 0002H 0031H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	r2,	#096h
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0566H 0001H 0001H
	bal	_$L203

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0566H 0002H 0019H
_$L201 :
CBLOCK 226 4 1382

;;		main_clrWDT();
CLINEA 0000H 0001H 0567H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 226 4 1384
...
_$L203 :
	...
	cmp	r0,	#01h
	bne	_$L201
CBLOCKEND 226 2 1385

;;}
CLINEA 0000H 0001H 0569H 0001H 0001H
	pop	pc
CBLOCKEND 226 1 1385
CFUNCTIONEND 226
...
CLINEA 0000H 0001H 056BH 0001H 0019H
	push	lr
CBLOCK 227 2 1387
CRET 0000H
CLOCAL 47H 0002H 0024H 0002H "i" 02H 00H 01H
...
;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 056DH 0002H 0017H
	mov	er0,	#0 
_$L207 :
CBLOCK 227 3 1390

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 056FH 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 227 3 1392

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 056DH 0002H 0017H
	add	er0,	#1 
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L207
...
CLINEA 0000H 0001H 0571H 0002H 0028H
	l	er0,	NEAR _Mag_Angle
	l	er2,	NEAR _Mag_Angle+02h
	push	xr0
	add	sp,	#-4
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 0573H 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 0574H 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 057AH 0001H 0001H
	bal	_$L216

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 057AH 0002H 0019H
_$L214 :
CBLOCK 227 4 1402

;;		main_clrWDT();
CLINEA 0000H 0001H 057BH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 227 4 1404
...
_$L216 :
	...
	cmp	r0,	#01h
	bne	_$L214
CBLOCKEND 227 2 1405

;;}
CLINEA 0000H 0001H 057DH 0001H 0001H
	pop	pc
CBLOCKEND 227 1 1405
CFUNCTIONEND 227
...
CLINEA 0000H 0001H 0585H 0001H 001BH
CBLOCK 228 2 1413
...
;;	PCRUN = 0;
CLINEA 0000H 0001H 05C4H 0002H 000BH
	rb	0f917h.0

;;	PWF0D = PWMSafeDuty; //Can't be running to change
CLINEA 0000H 0001H 05C6H 0002H 0032H
...
;;	PWCD = PWMSafeDuty;
CLINEA 0000H 0001H 05C9H 0002H 0014H
	st	er0,	0f912h
...
;;	Mag_PIDCounter = 0;
CLINEA 0000H 0001H 05D0H 0002H 0014H
	mov	er0,	#0 
	st	er0,	NEAR _Mag_PIDCounter

;;	CF_Gyro_Counter = 0;
CLINEA 0000H 0001H 05D1H 0002H 0015H
	st	er0,	NEAR _CF_Gyro_Counter
	st	er0,	NEAR _CF_Gyro_Counter+02h

;;	Accel_PID_XRollCounter = 0;
CLINEA 0000H 0001H 05D2H 0002H 001CH
	st	er0,	NEAR _Accel_PID_XRollCounter

;;	Accel_PID_YPitchCounter = 0;
CLINEA 0000H 0001H 05D3H 0002H 001DH
	st	er0,	NEAR _Accel_PID_YPitchCounter

;;	Range_PIDCounter = 0;
CLINEA 0000H 0001H 05D4H 0002H 0016H
	st	er0,	NEAR _Range_PIDCounter
CBLOCKEND 228 2 1512

;;}
CLINEA 0000H 0001H 05E8H 0001H 0001H
	rt
CBLOCKEND 228 1 1512
CFUNCTIONEND 228
...
CLINEA 0000H 0001H 05EBH 0001H 0019H
	push	lr
	push	er4
CBLOCK 229 2 1515
CRET 0002H
...
;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 05EFH 0002H 0017H
	mov	er0,	#0 
_$L221 :
CBLOCK 229 3 1520

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 05F1H 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 229 3 1522

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 05EFH 0002H 0017H
	add	er0,	#1 
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L221
...
CLINEA 0000H 0001H 05F3H 0002H 0066H
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 05F5H 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 05F6H 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 05F8H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 05F9H 0002H 000DH
	bl	_uart_stop
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 05FBH 0001H 0001H
	bal	_$L255

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 05FBH 0002H 0019H
_$L228 :
CBLOCK 229 4 1531

;;		NOP1000();
CLINEA 0000H 0001H 05FCH 0003H 000CH
	bl	_NOP1000

;;		main_clrWDT();
CLINEA 0000H 0001H 05FDH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 229 4 1534
...
;;	_flgUartFin = 0;
CLINEA 0000H 0001H 0601H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 0602H 0002H 000DH
	bl	_uart_stop

;;	uart_startReceive(RecWorld, 2, _funcUartFin);
CLINEA 0000H 0001H 0603H 0002H 002EH
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	er2,	#2 
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0604H 0001H 0001H
	bal	_$L256

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0604H 0002H 0019H
_$L232 :
CBLOCK 229 5 1540
...
;;	i = 0;
CLINEA 0000H 0001H 0608H 0002H 0007H
	mov	er4,	#0 

;;	EPB3 = 1;					//Enable Accel/Gyro Interrupt Pin
CLINEA 0000H 0001H 060AH 0002H 0030H
	sb	0f011h.7

;;	while(i < 10){
CLINEA 0000H 0000H 060BH 0002H 000FH
_$L236 :
CBLOCK 229 6 1547

;;		if(AccGyro_ReadFlag >= 1){		//Triggered by External Interrupt (flag set in AccelGyroDataReady_ISR)
CLINEA 0000H 0001H 060CH 0003H 0064H
	l	r0,	NEAR _AccGyro_ReadFlag
	cmp	r0,	#01h
	bge	_$M16
	b	_$L238
...
;;			_flgI2CFin = 0;																	//reset I2C completed Flag
CLINEA 0000H 0001H 0610H 0004H 003DH
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin

;;			i2c_stop();																		//Make sure I2C is not currently running
CLINEA 0000H 0001H 0611H 0004H 0048H
	bl	_i2c_stop

;;			I20MD = 1;		//Switch to I2C Fast Operation (400kbps)
CLINEA 0000H 0001H 0612H 0004H 0037H
	sb	0f2a4h.1

;;			i2c_startReceive(MPU6050Address, &AccGyro_ReadData, 1, &AccGyro_Data, 14, (cbfI2c)_funcI2CFin);	//Begin I2C Receive Command
CLINEA 0000H 0001H 0613H 0004H 007EH
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	mov	er0,	#14
...
;;			while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 0614H 0001H 0001H
	bal	_$L257

;;			while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 0614H 0004H 0053H
_$L242 :
CBLOCK 229 8 1556

;;				main_clrWDT();	
CLINEA 0000H 0001H 0615H 0005H 0013H
	bl	_main_clrWDT
CBLOCKEND 229 8 1558
...
CLINEA 0000H 0001H 061AH 0004H 0037H
	l	r0,	NEAR _AccGyro_Data+08h
	mov	r1,	#00h
	mov	r3,	r0
	mov	r2,	#00h
...
CLINEA 0000H 0001H 061BH 0004H 0039H
	l	r0,	NEAR _AccGyro_Data+0ah
	mov	r1,	#00h
	mov	r3,	r0
	mov	r2,	#00h
...
CLINEA 0000H 0001H 061CH 0004H 0039H
	l	r0,	NEAR _AccGyro_Data+0ch
	mov	r1,	#00h
	mov	r3,	r0
	mov	r2,	#00h
...
CLINEA 0000H 0001H 061DH 0004H 003BH
	l	r0,	NEAR _AccGyro_Data+01h
	mov	r1,	#00h
	l	r2,	NEAR _AccGyro_Data
	mov	r3,	r2
...
CLINEA 0000H 0001H 061EH 0004H 003BH
	l	r0,	NEAR _AccGyro_Data+02h
	mov	r1,	#00h
	mov	r3,	r0
	mov	r2,	#00h
...
;;			i++;
CLINEA 0000H 0000H 061FH 0004H 0007H
	add	er4,	#1 
CBLOCKEND 229 7 1568

;;		}
CLINEA 0000H 0000H 0620H 0003H 0003H
_$L238 :
CBLOCKEND 229 6 1569

;;	while(i < 10){
CLINEA 0000H 0000H 060BH 0000H 0000H
	cmp	r4,	#0ah
	cmpc	r5,	#00h
	bges	_$M17
	b	_$L236
...
;;	Gyro_Ycal /= 10;
CLINEA 0000H 0001H 0623H 0002H 0011H
	l	er0,	NEAR _Gyro_Ycal
	l	er2,	NEAR _Gyro_Ycal+02h
	push	xr0
	mov	er0,	#0 
...
;;	Gyro_Zcal /= 10;
CLINEA 0000H 0001H 0624H 0002H 0011H
	l	er0,	NEAR _Gyro_Zcal
	l	er2,	NEAR _Gyro_Zcal+02h
	push	xr0
	mov	er0,	#0 
...
;;	Accel_Xcal[0] /= 10;
CLINEA 0000H 0001H 0625H 0002H 0015H
	l	er0,	NEAR _Accel_Xcal
	l	er2,	NEAR _Accel_Xcal+02h
	push	xr0
	mov	er0,	#0 
...
;;	Accel_Ycal[0] /= 10;
CLINEA 0000H 0001H 0626H 0002H 0015H
	l	er0,	NEAR _Accel_Ycal
	l	er2,	NEAR _Accel_Ycal+02h
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0001H 0627H 0002H 0030H
	rb	0f011h.7
...
CLINEA 0000H 0001H 0645H 0002H 0035H
...
_$L258 :
	...
	cmp	r0,	#01h
	bne	_$L253
CBLOCKEND 229 2 1616

;;}
CLINEA 0000H 0001H 0650H 0001H 0001H
	pop	er4
	pop	pc
CBLOCKEND 229 1 1616
CFUNCTIONEND 229
...
CLINEA 0000H 0001H 0652H 0001H 001AH
	push	lr
	push	er8
CBLOCK 230 2 1618
CRET 0002H
...
;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 0656H 0002H 0017H
	mov	er0,	#0 
_$L262 :
CBLOCK 230 3 1623

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 0658H 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 230 3 1625

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0656H 0002H 0017H
	add	er0,	#1 
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L262
...
CLINEA 0000H 0001H 065AH 0002H 0059H
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 065BH 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 065CH 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 065EH 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 065FH 0002H 000DH
	bl	_uart_stop
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0661H 0001H 0001H
	bal	_$L352

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0661H 0002H 0019H
_$L269 :
CBLOCK 230 4 1633

;;		NOP1000();
CLINEA 0000H 0001H 0662H 0003H 000CH
	bl	_NOP1000

;;		main_clrWDT();
CLINEA 0000H 0001H 0663H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 230 4 1636
...
;;	_flgUartFin = 0;
CLINEA 0000H 0001H 0666H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin
...
;;	uart_startReceive(RecWorld, 2, _funcUartFin);
CLINEA 0000H 0001H 0668H 0002H 002EH
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	er2,	#2 
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0669H 0001H 0001H
	bal	_$L353

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0669H 0002H 0019H
_$L273 :
CBLOCK 230 5 1641
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0669H 000DH 0011H
	l	r0,	NEAR __flgUartFin
	cmp	r0,	#01h
	bne	_$L273

;;	for(i = 0; i<10; i++){
CLINEA 0000H 0001H 066DH 0006H 000BH
	mov	er8,	#0 

;;	for(i = 0; i<10; i++){
CLINEA 0000H 0000H 066DH 0013H 0015H
_$L277 :
CBLOCK 230 6 1645

;;		_flgI2CFin = 0;																	//reset I2C completed Flag
CLINEA 0000H 0001H 0671H 0003H 003CH
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin

;;		i2c_stop();																		//Make sure I2C is not currently running
CLINEA 0000H 0001H 0672H 0003H 0047H
	bl	_i2c_stop

;;		I20MD = 1;		//Switch to I2C Fast Operation (400kbps)
CLINEA 0000H 0001H 0673H 0003H 0036H
	sb	0f2a4h.1

;;		i2c_startReceive(MPU6050Address, &AccGyro_ReadData, 1, &AccGyro_Data, 14, (cbfI2c)_funcI2CFin);	//Begin I2C Receive Command
CLINEA 0000H 0001H 0674H 0003H 007DH
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	mov	er0,	#14
...
;;		while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 0675H 0001H 0001H
	bal	_$L354

;;		while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 0675H 0003H 0052H
_$L283 :
CBLOCK 230 7 1653

;;			main_clrWDT();	
CLINEA 0000H 0001H 0676H 0004H 0012H
	bl	_main_clrWDT
CBLOCKEND 230 7 1655
...
;;		while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 0675H 000DH 0011H
	l	r0,	NEAR __flgI2CFin
	cmp	r0,	#01h
	bne	_$L283

;;		Accel_Xcal[1] += (AccGyro_Data[0]<<8)+(AccGyro_Data[1]);
CLINEA 0000H 0001H 067CH 0003H 003AH
	l	r0,	NEAR _AccGyro_Data+01h
	mov	r1,	#00h
	l	r2,	NEAR _AccGyro_Data
	mov	r3,	r2
...
CLINEA 0000H 0001H 067DH 0003H 003AH
	l	r0,	NEAR _AccGyro_Data+02h
	mov	r1,	#00h
	mov	r3,	r0
	mov	r2,	#00h
...
;;	for(i = 0; i<10; i++){
CLINEA 0000H 0000H 066DH 000DH 0011H
	cmp	r8,	#0ah
	cmpc	r9,	#00h
	bges	_$M19
	b	_$L277
...
;;	Accel_Xcal[1] /= 10;
CLINEA 0000H 0001H 067FH 0002H 0015H
	l	er0,	NEAR _Accel_Xcal+04h
	l	er2,	NEAR _Accel_Xcal+06h
	push	xr0
	mov	er0,	#0 
...
;;	Accel_Ycal[1] /= 10;
CLINEA 0000H 0001H 0680H 0002H 0015H
	l	er0,	NEAR _Accel_Ycal+04h
	l	er2,	NEAR _Accel_Ycal+06h
	push	xr0
	mov	er0,	#0 
...
;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 0682H 0002H 0017H
	mov	er0,	#0 
_$L287 :
CBLOCK 230 8 1667

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 0684H 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 230 8 1669

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0682H 0002H 0017H
	add	er0,	#1 

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0682H 000DH 0012H
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L287
...
;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0688H 0014H 0016H
_$L293 :
CBLOCK 230 9 1673

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 068AH 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 230 9 1675
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 068DH 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 068EH 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 0690H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 0691H 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(SensorReturn, 150, _funcUartFin);
CLINEA 0000H 0001H 0692H 0002H 0031H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	r2,	#096h
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0693H 0001H 0001H
	bal	_$L355

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0693H 0002H 0019H
_$L300 :
CBLOCK 230 10 1683

;;		NOP1000();
CLINEA 0000H 0001H 0694H 0003H 000CH
	bl	_NOP1000

;;		main_clrWDT();
CLINEA 0000H 0001H 0695H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 230 10 1686
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0693H 000DH 0012H
	l	r0,	NEAR __flgUartFin
	cmp	r0,	#01h
	bne	_$L300

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 0698H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 0699H 0002H 000DH
	bl	_uart_stop

;;	uart_startReceive(RecWorld, 2, _funcUartFin);
CLINEA 0000H 0001H 069AH 0002H 002EH
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	er2,	#2 
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 069BH 0002H 0019H
_$L304 :
CBLOCK 230 11 1691
...
;;	for(i = 0; i<10; i++){
CLINEA 0000H 0001H 069FH 0006H 000BH
	mov	er8,	#0 

;;	for(i = 0; i<10; i++){
CLINEA 0000H 0000H 069FH 0013H 0015H
_$L308 :
CBLOCK 230 12 1695

;;		_flgI2CFin = 0;																	//reset I2C completed Flag
CLINEA 0000H 0001H 06A3H 0003H 003CH
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin

;;		i2c_stop();																		//Make sure I2C is not currently running
CLINEA 0000H 0001H 06A4H 0003H 0047H
	bl	_i2c_stop

;;		I20MD = 1;		//Switch to I2C Fast Operation (400kbps)
CLINEA 0000H 0001H 06A5H 0003H 0036H
	sb	0f2a4h.1

;;		i2c_startReceive(MPU6050Address, &AccGyro_ReadData, 1, &AccGyro_Data, 14, (cbfI2c)_funcI2CFin);	//Begin I2C Receive Command
CLINEA 0000H 0001H 06A6H 0003H 007DH
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	mov	er0,	#14
...
;;		while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 06A7H 0001H 0001H
	bal	_$L357

;;		while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 06A7H 0003H 0052H
_$L314 :
CBLOCK 230 13 1703

;;			main_clrWDT();	
CLINEA 0000H 0001H 06A8H 0004H 0012H
	bl	_main_clrWDT
CBLOCKEND 230 13 1705
...
;;		while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 06A7H 000DH 0011H
	l	r0,	NEAR __flgI2CFin
	cmp	r0,	#01h
	bne	_$L314

;;		Accel_Zcal[1] += (AccGyro_Data[4]<<8)+(AccGyro_Data[5]);
CLINEA 0000H 0001H 06AEH 0003H 003AH
	l	r0,	NEAR _AccGyro_Data+04h
	mov	r1,	#00h
	mov	r3,	r0
	mov	r2,	#00h
...
CLINEA 0000H 0001H 06AFH 0003H 003AH
	l	r0,	NEAR _AccGyro_Data+02h
	mov	r1,	#00h
	mov	r3,	r0
	mov	r2,	#00h
...
;;	for(i = 0; i<10; i++){
CLINEA 0000H 0000H 069FH 000DH 0011H
	cmp	r8,	#0ah
	cmpc	r9,	#00h
	bges	_$M20
	b	_$L308
...
;;	Accel_Zcal[1] /= 10;
CLINEA 0000H 0001H 06B1H 0002H 0015H
	l	er0,	NEAR _Accel_Zcal+04h
	l	er2,	NEAR _Accel_Zcal+06h
	push	xr0
	mov	er0,	#0 
...
;;	Accel_Ycal[2] /= 10;
CLINEA 0000H 0001H 06B2H 0002H 0015H
	l	er0,	NEAR _Accel_Ycal+08h
	l	er2,	NEAR _Accel_Ycal+0ah
	push	xr0
	mov	er0,	#0 
...
;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 06B7H 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 230 14 1720

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 06B5H 0002H 0017H
	add	er0,	#1 
...
CLINEA 0000H 0001H 06B9H 0002H 0075H
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 06BAH 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 06BBH 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 06BDH 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 06C0H 0001H 0001H
	bal	_$L358

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 06C0H 0002H 0019H
_$L325 :
CBLOCK 230 15 1728

;;		NOP1000();
CLINEA 0000H 0001H 06C1H 0003H 000CH
	bl	_NOP1000

;;		main_clrWDT();
CLINEA 0000H 0001H 06C2H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 230 15 1731
...
;;	_flgUartFin = 0;
CLINEA 0000H 0001H 06C5H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 06C6H 0002H 000DH
	bl	_uart_stop

;;	uart_startReceive(RecWorld, 2, _funcUartFin);
CLINEA 0000H 0001H 06C7H 0002H 002EH
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	er2,	#2 
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 06C8H 0001H 0001H
	bal	_$L359

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 06C8H 0002H 0019H
_$L329 :
CBLOCK 230 16 1736
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 06C8H 000DH 0011H
	l	r0,	NEAR __flgUartFin
	cmp	r0,	#01h
	bne	_$L329

;;	for(i = 0; i<10; i++){
CLINEA 0000H 0001H 06CCH 0006H 000BH
	mov	er8,	#0 

;;	for(i = 0; i<10; i++){
CLINEA 0000H 0000H 06CCH 0013H 0015H
_$L333 :
CBLOCK 230 17 1740

;;		_flgI2CFin = 0;																	//reset I2C completed Flag
CLINEA 0000H 0001H 06D0H 0003H 003CH
	mov	r0,	#00h
	st	r0,	NEAR __flgI2CFin

;;		i2c_stop();																		//Make sure I2C is not currently running
CLINEA 0000H 0001H 06D1H 0003H 0047H
	bl	_i2c_stop

;;		I20MD = 1;		//Switch to I2C Fast Operation (400kbps)
CLINEA 0000H 0001H 06D2H 0003H 0036H
	sb	0f2a4h.1

;;		i2c_startReceive(MPU6050Address, &AccGyro_ReadData, 1, &AccGyro_Data, 14, (cbfI2c)_funcI2CFin);	//Begin I2C Receive Command
CLINEA 0000H 0001H 06D3H 0003H 007DH
	mov	r0,	#BYTE1 OFFSET __funcI2CFin
	mov	r1,	#BYTE2 OFFSET __funcI2CFin
	push	er0
	mov	er0,	#14
...
;;		while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 06D4H 0003H 0052H
_$L339 :
CBLOCK 230 18 1748

;;			main_clrWDT();	
CLINEA 0000H 0001H 06D5H 0004H 0012H
	bl	_main_clrWDT
CBLOCKEND 230 18 1750
...
;;		while(_flgI2CFin != 1){															//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 06D4H 000DH 0011H
	l	r0,	NEAR __flgI2CFin
	cmp	r0,	#01h
	bne	_$L339

;;		Accel_Zcal[2] += (AccGyro_Data[4]<<8)+(AccGyro_Data[5]);
CLINEA 0000H 0001H 06DBH 0003H 003AH
	l	r0,	NEAR _AccGyro_Data+04h
	mov	r1,	#00h
	mov	r3,	r0
	mov	r2,	#00h
...
CLINEA 0000H 0001H 06DCH 0003H 003AH
	l	r0,	NEAR _AccGyro_Data+01h
	mov	r1,	#00h
	l	r2,	NEAR _AccGyro_Data
	mov	r3,	r2
...
;;	for(i = 0; i<10; i++){
CLINEA 0000H 0000H 06CCH 000DH 0011H
	cmp	r8,	#0ah
	cmpc	r9,	#00h
	bges	_$M21
	b	_$L333
...
;;	Accel_Zcal[2] /= 10;
CLINEA 0000H 0001H 06DEH 0002H 0015H
	l	er0,	NEAR _Accel_Zcal+08h
	l	er2,	NEAR _Accel_Zcal+0ah
	push	xr0
	mov	er0,	#0 
...
;;	Accel_Xcal[2] /= 10;
CLINEA 0000H 0001H 06DFH 0002H 0015H
	l	er0,	NEAR _Accel_Xcal+08h
	l	er2,	NEAR _Accel_Xcal+0ah
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0001H 06E2H 0002H 0031H
	l	er0,	NEAR _Accel_Xcal+04h
	l	er2,	NEAR _Accel_Xcal+06h
	push	xr0
	l	er0,	NEAR _Accel_Xcal+08h
...
CLINEA 0000H 0001H 06E3H 0002H 0031H
	l	er0,	NEAR _Accel_Ycal+04h
	l	er2,	NEAR _Accel_Ycal+06h
	push	xr0
	l	er0,	NEAR _Accel_Ycal+08h
...
CLINEA 0000H 0001H 06E4H 0002H 0031H
	l	er0,	NEAR _Accel_Zcal+04h
	l	er2,	NEAR _Accel_Zcal+06h
	push	xr0
	l	er0,	NEAR _Accel_Zcal+08h
...
;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 06E7H 0002H 0017H
	mov	er0,	#0 
_$L343 :
CBLOCK 230 19 1768

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 06E9H 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 230 19 1770

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 06E7H 0002H 0017H
	add	er0,	#1 
...
CLINEA 0000H 0001H 06EBH 0002H 0036H
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 06ECH 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 06EDH 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h
...
;;		NOP1000();
CLINEA 0000H 0001H 06F3H 0003H 000CH
	bl	_NOP1000

;;		main_clrWDT();
CLINEA 0000H 0001H 06F4H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 230 20 1781
...
;;{
CLINEA 0000H 0001H 06FAH 0001H 0001H
	push	lr
CBLOCK 231 2 1786
CRET 0000H
...
;;		for(j = 0; j<150; j++)
CLINEA 0000H 0001H 06FDH 0003H 0018H
	mov	er0,	#0 
_$L365 :
CBLOCK 231 3 1790

;;			SensorReturn[j] = 0x20;
CLINEA 0000H 0001H 06FFH 0004H 001AH
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 231 3 1792

;;		for(j = 0; j<150; j++)
CLINEA 0000H 0000H 06FDH 0003H 0018H
	add	er0,	#1 

;;		for(j = 0; j<150; j++)
CLINEA 0000H 0000H 06FDH 000DH 0011H
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L365
...
CLINEA 0000H 0001H 0702H 0003H 0097H
	l	er0,	NEAR _CF_LPF
...
;;		SensorReturn[148] = 0x0D;	//CR
CLINEA 0000H 0001H 0704H 0003H 0020H
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;		SensorReturn[149] = 0x0A;	//LF
CLINEA 0000H 0001H 0705H 0003H 0020H
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h
...
;;		uart_startSend(SensorReturn, 150, _funcUartFin);
CLINEA 0000H 0001H 070AH 0003H 0032H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	r2,	#096h
...
CLINEA 0000H 0000H 070BH 000DH 0011H
	...
	cmp	r0,	#01h
	bne	_$L372
CBLOCKEND 231 2 1806

;;}
CLINEA 0000H 0001H 070EH 0001H 0001H
	pop	pc
CBLOCKEND 231 1 1806
CFUNCTIONEND 231
...
;;{
CLINEA 0000H 0001H 0712H 0001H 0001H
	push	lr
CBLOCK 232 2 1810
CRET 0000H
...
;;		for (k=0;k<7;k++)
CLINEA 0000H 0001H 0719H 0008H 000BH
	mov	er0,	#0 

;;		for (k=0;k<7;k++)
CLINEA 0000H 0000H 0719H 0010H 0012H
_$L379 :
CBLOCK 232 3 1818

;;			RecWorld[k] = 0;	//ie: to set ki to 1.5 =>send ki1.50000
CLINEA 0000H 0001H 071BH 0004H 003BH
	mov	r2,	#00h
	st	r2,	NEAR _RecWorld[er0]
CBLOCKEND 232 3 1820
...
;;		for (k=0;k<7;k++)
CLINEA 0000H 0000H 0719H 000CH 000FH
	cmp	r0,	#07h
	cmpc	r1,	#00h
	blts	_$L379

;;		ETM8 = 0; //Turn OFF TIMER8/9 ISR for this function...
CLINEA 0000H 0001H 071EH 0003H 0038H
	rb	0f013h.2

;;		ETM9 = 0; //Turn OFF TIMER8/9 ISR for this function...
CLINEA 0000H 0001H 071FH 0003H 0038H
	rb	0f013h.3

;;		_flgUartFin = 0;
CLINEA 0000H 0001H 0722H 0003H 0012H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;		uart_stop();
CLINEA 0000H 0001H 0723H 0003H 000EH
	bl	_uart_stop

;;		uart_startReceive(RecWorld, 8, _funcUartFin);
CLINEA 0000H 0001H 0724H 0003H 002FH
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	er2,	#8 
...
;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 0725H 0001H 0001H
	bal	_$L424

;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 0725H 0003H 001AH
_$L385 :
CBLOCK 232 4 1829

;;			main_clrWDT();
CLINEA 0000H 0001H 0726H 0004H 0011H
	bl	_main_clrWDT
CBLOCKEND 232 4 1831
...
;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 0725H 000CH 000FH
	l	r0,	NEAR __flgUartFin
	cmp	r0,	#01h
	bne	_$L385

;;		if(RecWorld[0] == 0x6B){			//if RECWORLD == "kpi"
CLINEA 0000H 0001H 0765H 0003H 0033H
	l	r0,	NEAR _RecWorld
	cmp	r0,	#06bh
	beq	_$M24
	b	_$L391
...
;;			if(RecWorld[1] == 0x70){
CLINEA 0000H 0001H 0766H 0004H 001BH
...
;;				if(RecWorld[2] == 0x69){
CLINEA 0000H 0001H 0767H 0005H 001CH
...
CLINEA 0000H 0001H 076CH 0006H 0021H
...
CLINEA 0000H 0001H 076EH 0006H 0027H
...
CLINEA 0000H 0001H 076FH 0006H 0021H
	l	er0,	NEAR _NewVar
...
CLINEA 0000H 0001H 0772H 0006H 0024H
	l	er0,	NEAR _NewVar
	l	er2,	NEAR _NewVar+02h
	push	xr0
	mov	er0,	#0 
...
CBLOCKEND 232 7 1907

;;				}
CLINEA 0000H 0000H 0773H 0005H 0005H
_$L391 :
CBLOCKEND 232 6 1908
CBLOCKEND 232 5 1909
...
;;			if(RecWorld[1] == 0x70){
CLINEA 0000H 0001H 0778H 0004H 001BH
	l	r0,	NEAR _RecWorld+01h
	cmp	r0,	#070h
	bne	_$L395
CBLOCK 232 9 1912
...
;;				sscanf(NewVar_Str, "%f", &NewVar);
CLINEA 0000H 0001H 0780H 0005H 0026H
	mov	r0,	#BYTE1 OFFSET _NewVar
	mov	r1,	#BYTE2 OFFSET _NewVar
	push	er0
	mov	r0,	#BYTE1 OFFSET $$S211
...
;;				Accel_PID_YPitch_kp = NewVar;
CLINEA 0000H 0001H 0782H 0005H 0021H
	st	er0,	NEAR _Accel_PID_YPitch_kp
	st	er2,	NEAR _Accel_PID_YPitch_kp+02h
CBLOCKEND 232 9 1949

;;			}
CLINEA 0000H 0000H 079DH 0004H 0004H
_$L395 :
CBLOCKEND 232 8 1950

;;		if(RecWorld[0] == 0x6B){			//if RECWORLD == "ki"
CLINEA 0000H 0001H 07A0H 0003H 0032H
	l	r0,	NEAR _RecWorld
	cmp	r0,	#06bh
	bne	_$L399
CBLOCK 232 10 1952
...
;;			if(RecWorld[1] == 0x69){
CLINEA 0000H 0001H 07A1H 0004H 001BH
	l	r0,	NEAR _RecWorld+01h
	cmp	r0,	#069h
	bne	_$L399
CBLOCK 232 11 1953
...
CLINEA 0000H 0001H 07ABH 0005H 0021H
	st	er0,	NEAR _Accel_PID_YPitch_ki
	st	er2,	NEAR _Accel_PID_YPitch_ki+02h
CBLOCKEND 232 11 1986

;;			}
CLINEA 0000H 0000H 07C2H 0004H 0004H
_$L399 :
CBLOCKEND 232 10 1987

;;		if(RecWorld[0] == 0x6B){			//if RECWORLD == "kd"
CLINEA 0000H 0001H 07C5H 0003H 0032H
	l	r0,	NEAR _RecWorld
	cmp	r0,	#06bh
	bne	_$L403
CBLOCK 232 12 1989
...
;;			if(RecWorld[1] == 0x64){
CLINEA 0000H 0001H 07C6H 0004H 001BH
	l	r0,	NEAR _RecWorld+01h
	cmp	r0,	#064h
	bne	_$L403
CBLOCK 232 13 1990
...
;;				sscanf(NewVar_Str, "%f", &NewVar);
CLINEA 0000H 0001H 07CDH 0005H 0026H
	mov	r0,	#BYTE1 OFFSET _NewVar
	mov	r1,	#BYTE2 OFFSET _NewVar
	push	er0
	mov	r0,	#BYTE1 OFFSET $$S211
...
CLINEA 0000H 0001H 07CFH 0005H 0021H
	st	er0,	NEAR _Accel_PID_YPitch_kd
	st	er2,	NEAR _Accel_PID_YPitch_kd+02h
CBLOCKEND 232 13 2000

;;			}
CLINEA 0000H 0000H 07D0H 0004H 0004H
_$L403 :
CBLOCKEND 232 12 2001

;;		if(RecWorld[0] == 0x61){			//if RECWORLD == "a1"
CLINEA 0000H 0001H 07D3H 0003H 0032H
	l	r0,	NEAR _RecWorld
	cmp	r0,	#061h
	beq	_$M27
	b	_$L407
...
;;			if(RecWorld[1] == 0x31){
CLINEA 0000H 0001H 07D4H 0004H 001BH
	l	r0,	NEAR _RecWorld+01h
	cmp	r0,	#031h
	bne	_$L407
CBLOCK 232 15 2004
...
;;				NewVar_Str[0] = RecWorld[2];
CLINEA 0000H 0001H 07D5H 0005H 0020H
	l	r0,	NEAR _RecWorld+02h
	st	r0,	NEAR _NewVar_Str

;;				NewVar_Str[1] = RecWorld[3];
CLINEA 0000H 0001H 07D6H 0005H 0020H
	l	r0,	NEAR _RecWorld+03h
	st	r0,	NEAR _NewVar_Str+01h

;;				NewVar_Str[2] = RecWorld[4];
CLINEA 0000H 0001H 07D7H 0005H 0020H
	l	r0,	NEAR _RecWorld+04h
	st	r0,	NEAR _NewVar_Str+02h
...
;;				sscanf(NewVar_Str, "%f", &NewVar);
CLINEA 0000H 0001H 07DBH 0005H 0026H
	mov	r0,	#BYTE1 OFFSET _NewVar
	mov	r1,	#BYTE2 OFFSET _NewVar
	push	er0
	mov	r0,	#BYTE1 OFFSET $$S211
...
;;				CF_HPF = NewVar;
CLINEA 0000H 0001H 07DCH 0005H 0014H
	l	er0,	NEAR _NewVar
	l	er2,	NEAR _NewVar+02h
	st	er0,	NEAR _CF_HPF
...
;;				CF_LPF = 1-NewVar;
CLINEA 0000H 0001H 07DDH 0005H 0016H
	mov	er0,	#0 
	mov	r2,	#080h
	mov	r3,	#03fh
	push	xr0
...
CBLOCKEND 232 15 2014

;;			}
CLINEA 0000H 0000H 07DEH 0004H 0004H
_$L407 :
CBLOCKEND 232 14 2015

;;		if(RecWorld[0] == 0x61){			//if RECWORLD == "a2"
CLINEA 0000H 0001H 07E1H 0003H 0032H
	l	r0,	NEAR _RecWorld
	cmp	r0,	#061h
	beq	_$M28
	b	_$L411
...
;;			if(RecWorld[1] == 0x32){
CLINEA 0000H 0001H 07E2H 0004H 001BH
	l	r0,	NEAR _RecWorld+01h
	cmp	r0,	#032h
	bne	_$L411
CBLOCK 232 17 2018
...
;;				NewVar_Str[3] = RecWorld[5];
CLINEA 0000H 0001H 07E6H 0005H 0020H
	l	r0,	NEAR _RecWorld+05h
	st	r0,	NEAR _NewVar_Str+03h
...
;;				NewVar_Str[5] = RecWorld[7];
CLINEA 0000H 0001H 07E8H 0005H 0020H
	l	r0,	NEAR _RecWorld+07h
	st	r0,	NEAR _NewVar_Str+05h

;;				sscanf(NewVar_Str, "%f", &NewVar);
CLINEA 0000H 0001H 07E9H 0005H 0026H
	mov	r0,	#BYTE1 OFFSET _NewVar
	mov	r1,	#BYTE2 OFFSET _NewVar
	push	er0
	mov	r0,	#BYTE1 OFFSET $$S211
...
;;				CF_HPF = 1-NewVar;
CLINEA 0000H 0001H 07EAH 0005H 0016H
	mov	er0,	#0 
	mov	r2,	#080h
	mov	r3,	#03fh
	push	xr0
...
;;				CF_LPF = NewVar;
CLINEA 0000H 0001H 07EBH 0005H 0014H
	l	er0,	NEAR _NewVar
	l	er2,	NEAR _NewVar+02h
	st	er0,	NEAR _CF_LPF
	st	er2,	NEAR _CF_LPF+02h
CBLOCKEND 232 17 2028

;;			}
CLINEA 0000H 0000H 07ECH 0004H 0004H
_$L411 :
CBLOCKEND 232 16 2029

;;		for(k = 0; k<150; k++)
CLINEA 0000H 0001H 07EFH 0007H 000CH
	mov	er0,	#0 

;;		for(k = 0; k<150; k++)
CLINEA 0000H 0000H 07EFH 0015H 0017H
_$L415 :
CBLOCK 232 18 2032

;;			SensorReturn[k] = 0x20;
CLINEA 0000H 0001H 07F1H 0004H 001AH
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 232 18 2034
...
CLINEA 0000H 0001H 07F4H 0003H 0093H
	l	er0,	NEAR _CF_LPF
	l	er2,	NEAR _CF_LPF+02h
	push	xr0
	add	sp,	#-4
...
;;		SensorReturn[148] = 0x0D;	//CR
CLINEA 0000H 0001H 07F6H 0003H 0020H
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;		SensorReturn[149] = 0x0A;	//LF
CLINEA 0000H 0001H 07F7H 0003H 0020H
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h

;;		_flgUartFin = 0;
CLINEA 0000H 0001H 07FAH 0003H 0012H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;		uart_stop();
CLINEA 0000H 0001H 07FBH 0003H 000EH
	bl	_uart_stop

;;		uart_startSend(SensorReturn, 150, _funcUartFin);
CLINEA 0000H 0001H 07FCH 0003H 0032H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	r2,	#096h
...
;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 07FDH 0001H 0001H
	bal	_$L425

;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 07FDH 0003H 001AH
_$L422 :
CBLOCK 232 19 2045

;;			main_clrWDT();
CLINEA 0000H 0001H 07FEH 0004H 0011H
	bl	_main_clrWDT
CBLOCKEND 232 19 2047
...
;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 07FDH 000EH 0013H
	l	r0,	NEAR __flgUartFin
	cmp	r0,	#01h
	bne	_$L422

;;		ETM8 = 1;	//Turn TIMER8/9 ISR Back ON
CLINEA 0000H 0001H 0801H 0003H 0027H
	sb	0f013h.2

;;		ETM9 = 1;	//Turn TIMER8/9 ISR Back ON		
CLINEA 0000H 0001H 0802H 0003H 0029H
	sb	0f013h.3
CBLOCKEND 232 2 2051

;;}
CLINEA 0000H 0001H 0803H 0001H 0001H
	pop	pc
CBLOCKEND 232 1 2051
CFUNCTIONEND 232
...
;;{
CLINEA 0000H 0001H 0807H 0001H 0001H
	push	lr
CBLOCK 233 2 2055
CRET 0000H

;;		PWED += PWMtoRPMOffset_Mot2;	
CLINEA 0000H 0001H 0809H 0003H 001FH
	l	er0,	0f932h
...
CLINEA 0000H 0001H 080AH 0003H 001FH
	l	er0,	0f912h
...
CLINEA 0000H 0001H 080BH 0003H 001EH
	l	er0,	0f922h
...
CLINEA 0000H 0001H 080DH 0003H 0020H
	bal	_$L427
_$L429 :
CBLOCK 233 3 2061

;;			NOPms(50);
CLINEA 0000H 0001H 080EH 0004H 000DH
	mov	er0,	#50
	bl	_NOPms

;;			PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 080FH 0004H 001CH
	rb	0f973h.0
...
;;			PCRUN = 0;
CLINEA 0000H 0001H 0812H 0004H 000DH
	rb	0f917h.0

;;			PWF0D += 1; 		//Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0813H 0004H 0042H
	l	er0,	0f962h
	add	er0,	#1 
	st	er0,	0f962h

;;			PWED += 1;	
CLINEA 0000H 0001H 0814H 0004H 000EH
	l	er0,	0f932h
	add	er0,	#1 
	st	er0,	0f932h

;;			PWDD += 1;	
CLINEA 0000H 0001H 0815H 0004H 000EH
	l	er0,	0f922h
	add	er0,	#1 
	st	er0,	0f922h

;;			PWCD += 1;
CLINEA 0000H 0001H 0816H 0004H 000DH
	l	er0,	0f912h
	add	er0,	#1 
	st	er0,	0f912h

;;			PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0818H 0004H 001BH
	sb	0f973h.0
...
CLINEA 0000H 0001H 081BH 0004H 000DH
	sb	0f917h.0
CBLOCKEND 233 3 2076

;;		}
CLINEA 0000H 0000H 081CH 0003H 0003H
_$L427 :

;;		while(PWF0D < PWMIdleDutyRun){
CLINEA 0000H 0000H 080DH 000EH 0013H
	l	er0,	0f962h
	l	er2,	NEAR _PWMIdleDutyRun
	cmp	er0,	er2
	blt	_$L429
CBLOCKEND 233 2 2077

;;}
CLINEA 0000H 0001H 081DH 0001H 0001H
	pop	pc
CBLOCKEND 233 1 2077
CFUNCTIONEND 233
...
CLINEA 0000H 0001H 0822H 0001H 001BH
CBLOCK 234 2 2082

;;	if(PWMCounter < PWMSensorResPerInc){
CLINEA 0000H 0001H 0823H 0002H 0025H
...
;;		PWMCounter++;
CLINEA 0000H 0000H 0824H 0003H 000FH
	add	r0,	#01h
	st	r0,	NEAR _PWMCounter
CBLOCKEND 234 3 2085

;;	else{
CLINEA 0000H 0001H 0826H 0002H 0006H
	rt
_$L432 :
CBLOCK 234 4 2086

;;		if(PWED < PWMUpperDutyLimitCalib){
CLINEA 0000H 0001H 0827H 0003H 0024H
	l	er0,	0f932h
...
;;			if(PWMflag == 0){
CLINEA 0000H 0001H 0828H 0004H 0014H
	l	r0,	NEAR _PWMflag
	bne	_$L437
CBLOCK 234 6 2088

;;				PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0829H 0005H 001DH
	rb	0f973h.0
...
;;				PDRUN = 0;
CLINEA 0000H 0001H 082BH 0005H 000EH
	rb	0f927h.0

;;				PCRUN = 0;
CLINEA 0000H 0001H 082CH 0005H 000EH
	rb	0f917h.0

;;				PWF0D += MotorStep; //Can't be running to change (Only this variable)
CLINEA 0000H 0001H 082DH 0005H 0049H
	l	er0,	0f962h
...
;;				PWED += MotorStep;
CLINEA 0000H 0001H 082EH 0005H 0016H
	l	er0,	0f932h
	add	er0,	er2
	st	er0,	0f932h

;;				PWDD += MotorStep;
CLINEA 0000H 0001H 082FH 0005H 0016H
	l	er0,	0f922h
	add	er0,	er2
	st	er0,	0f922h

;;				PWCD += MotorStep;
CLINEA 0000H 0001H 0830H 0005H 0016H
	l	er0,	0f912h
	add	er0,	er2
	st	er0,	0f912h

;;				PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0831H 0005H 001CH
	sb	0f973h.0

;;				PERUN = 1;
CLINEA 0000H 0001H 0832H 0005H 000EH
	sb	0f937h.0

;;				PDRUN = 1;
CLINEA 0000H 0001H 0833H 0005H 000EH
	sb	0f927h.0

;;				PCRUN = 1;
CLINEA 0000H 0001H 0834H 0005H 000EH
	sb	0f917h.0
CBLOCKEND 234 6 2101

;;			}
CLINEA 0000H 0000H 0835H 0004H 0004H
_$L437 :

;;			if(PWMflag == 1){
CLINEA 0000H 0001H 0836H 0004H 0014H
	l	r0,	NEAR _PWMflag
	cmp	r0,	#01h
	bne	_$L441
CBLOCK 234 7 2102
...
;;				PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0837H 0005H 001DH
	rb	0f973h.0
...
;;				PDRUN = 0;
CLINEA 0000H 0001H 0839H 0005H 000EH
	rb	0f927h.0

;;				PCRUN = 0;
CLINEA 0000H 0001H 083AH 0005H 000EH
	rb	0f917h.0

;;				PWF0D -= MotorStep; //Can't be running to change (Only this variable)
CLINEA 0000H 0001H 083BH 0005H 0049H
	l	er0,	0f962h
	l	er2,	NEAR _MotorStep
	sub	r0,	r2
	subc	r1,	r3
...
;;				PWED -= MotorStep;
CLINEA 0000H 0001H 083CH 0005H 0016H
	l	er0,	0f932h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f932h
...
;;				PWDD -= MotorStep;
CLINEA 0000H 0001H 083DH 0005H 0016H
	l	er0,	0f922h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f922h
...
;;				PWCD -= MotorStep;
CLINEA 0000H 0001H 083EH 0005H 0016H
	l	er0,	0f912h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f912h
...
;;				PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 083FH 0005H 001CH
	sb	0f973h.0
...
;;				if(PWED <= PWMSafeDuty){
CLINEA 0000H 0001H 0843H 0005H 001CH
	l	er0,	0f932h
...
;;					PWMflag = 2;
CLINEA 0000H 0001H 0844H 0006H 0011H
	mov	r0,	#02h
	st	r0,	NEAR _PWMflag
CBLOCKEND 234 8 2117

;;				}
CLINEA 0000H 0000H 0845H 0005H 0005H
_$L441 :
CBLOCKEND 234 7 2118
CBLOCKEND 234 5 2119

;;		if(PWED >= PWMUpperDutyLimitCalib){
CLINEA 0000H 0001H 0848H 0003H 0025H
	l	er0,	0f932h
	l	er2,	NEAR _PWMUpperDutyLimitCalib
	cmp	er0,	er2
	blt	_$L443
...
;;			PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0849H 0004H 001CH
	rb	0f973h.0
...
;;			PCRUN = 0;
CLINEA 0000H 0001H 084CH 0004H 000DH
	rb	0f917h.0

;;			PWF0D -= MotorStep; //Can't be running to change (Only this variable)
CLINEA 0000H 0001H 084DH 0004H 0048H
	l	er0,	0f962h
	l	er2,	NEAR _MotorStep
	sub	r0,	r2
	subc	r1,	r3
...
;;			PWED -= MotorStep;
CLINEA 0000H 0001H 084EH 0004H 0015H
	l	er0,	0f932h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f932h
...
;;			PWDD -= MotorStep;
CLINEA 0000H 0001H 084FH 0004H 0015H
	l	er0,	0f922h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f922h
...
;;			PWCD -= MotorStep;
CLINEA 0000H 0001H 0850H 0004H 0015H
	l	er0,	0f912h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f912h
...
;;			PWMflag = 1;
CLINEA 0000H 0001H 0851H 0004H 000FH
	mov	r0,	#01h
	st	r0,	NEAR _PWMflag

;;			PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0852H 0004H 001BH
	sb	0f973h.0

;;			PERUN = 1;
CLINEA 0000H 0001H 0853H 0004H 000DH
	sb	0f937h.0

;;			PDRUN = 1;
CLINEA 0000H 0001H 0854H 0004H 000DH
	sb	0f927h.0

;;			PCRUN = 1;
CLINEA 0000H 0001H 0855H 0004H 000DH
	sb	0f917h.0
CBLOCKEND 234 9 2134

;;		}
CLINEA 0000H 0000H 0856H 0003H 0003H
_$L443 :

;;		PWMCounter = 0;
CLINEA 0000H 0001H 0857H 0003H 0011H
	mov	r0,	#00h
	st	r0,	NEAR _PWMCounter
CBLOCKEND 234 4 2136

;;	}
CLINEA 0000H 0000H 0858H 0002H 0002H
CBLOCKEND 234 2 2137

;;}
CLINEA 0000H 0001H 0859H 0001H 0001H
	rt
CBLOCKEND 234 1 2137
CFUNCTIONEND 234
...
;;		PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 085CH 0003H 001BH
	rb	0f973h.0
...
;;		PDRUN = 0;
CLINEA 0000H 0001H 085EH 0003H 000CH
	rb	0f927h.0

;;		PCRUN = 0;
CLINEA 0000H 0001H 085FH 0003H 000CH
	rb	0f917h.0

;;		PWF0D += MotorStep; //Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0860H 0003H 0047H
	l	er0,	0f962h
	l	er2,	NEAR _MotorStep
	add	er0,	er2
	st	er0,	0f962h
...
;;		PWED += MotorStep;
CLINEA 0000H 0001H 0861H 0003H 0014H
	l	er0,	0f932h
	add	er0,	er2
	st	er0,	0f932h

;;		PWDD += MotorStep;
CLINEA 0000H 0001H 0862H 0003H 0014H
	l	er0,	0f922h
	add	er0,	er2
	st	er0,	0f922h

;;		PWCD += MotorStep;
CLINEA 0000H 0001H 0863H 0003H 0014H
	l	er0,	0f912h
	add	er0,	er2
	st	er0,	0f912h

;;		PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0864H 0003H 001AH
	sb	0f973h.0

;;		PERUN = 1;
CLINEA 0000H 0001H 0865H 0003H 000CH
	sb	0f937h.0

;;		PDRUN = 1;
CLINEA 0000H 0001H 0866H 0003H 000CH
	sb	0f927h.0

;;		PCRUN = 1;
CLINEA 0000H 0001H 0867H 0003H 000CH
	sb	0f917h.0
CBLOCKEND 235 3 2152

;;	}			
CLINEA 0000H 0000H 0868H 0002H 0005H
_$L446 :

;;	if(Range_out > 75){	//4Ft Level
CLINEA 0000H 0001H 0869H 0002H 0020H
	l	er0,	NEAR _Range_out
	cmp	r0,	#04bh
	cmpc	r1,	#00h
	ble	_$L453
...
;;		PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 086AH 0003H 001BH
	rb	0f973h.0
...
;;		PDRUN = 0;
CLINEA 0000H 0001H 086CH 0003H 000CH
	rb	0f927h.0

;;		PCRUN = 0;
CLINEA 0000H 0001H 086DH 0003H 000CH
	rb	0f917h.0

;;		PWF0D -= MotorStep; //Can't be running to change (Only this variable)
CLINEA 0000H 0001H 086EH 0003H 0047H
	l	er0,	0f962h
	l	er2,	NEAR _MotorStep
	sub	r0,	r2
	subc	r1,	r3
...
;;		PWED -= MotorStep;
CLINEA 0000H 0001H 086FH 0003H 0014H
	l	er0,	0f932h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f932h
...
;;		PWDD -= MotorStep;
CLINEA 0000H 0001H 0870H 0003H 0014H
	l	er0,	0f922h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f922h
...
;;		PWCD -= MotorStep;
CLINEA 0000H 0001H 0871H 0003H 0014H
	l	er0,	0f912h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f912h
...
;;		PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0872H 0003H 001AH
	sb	0f973h.0
...
CLINEA 0000H 0001H 0875H 0003H 000CH
	sb	0f917h.0
CBLOCKEND 235 4 2166

;;	}
CLINEA 0000H 0000H 0876H 0002H 0002H
_$L453 :
CBLOCKEND 235 2 2210

;;}
CLINEA 0000H 0001H 08A2H 0001H 0001H
	pop	pc
CBLOCKEND 235 1 2210
CFUNCTIONEND 235
...
CLINEA 0000H 0001H 08E1H 0001H 001CH
	push	lr
CBLOCK 236 2 2273
CRET 0000H

;;	if((Mag_Angle > Mag_CWThres)&&(Mag_Angle < Mag_OpposingPole)){
CLINEA 0000H 0001H 08E2H 0002H 003FH
	l	er0,	NEAR _Mag_Angle
	l	er2,	NEAR _Mag_Angle+02h
	push	xr0
...
;;		PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 08E3H 0003H 001BH
	rb	0f973h.0
...
CLINEA 0000H 0001H 08E7H 0003H 004BH
	l	er0,	0f962h
...
;;		PWED -= Mag_MotorStep;
CLINEA 0000H 0001H 08E8H 0003H 0018H
	l	er0,	0f932h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f932h
...
;;		PWDD -= Mag_MotorStep;
CLINEA 0000H 0001H 08E9H 0003H 0018H
	l	er0,	0f922h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f922h
...
;;		PWCD += Mag_MotorStep;
CLINEA 0000H 0001H 08EAH 0003H 0018H
	l	er0,	0f912h
	add	er0,	er2
	st	er0,	0f912h

;;		PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 08EBH 0003H 001AH
	sb	0f973h.0
...
;;		PDRUN = 1;
CLINEA 0000H 0001H 08EDH 0003H 000CH
	sb	0f927h.0

;;		PCRUN = 1;
CLINEA 0000H 0001H 08EEH 0003H 000CH
	sb	0f917h.0
CBLOCKEND 236 3 2287

;;	}
CLINEA 0000H 0000H 08EFH 0002H 0002H
_$L456 :

;;	if((Mag_Angle < Mag_CCWThres)&&(Mag_Angle > Mag_OpposingPole)){
CLINEA 0000H 0001H 08F0H 0002H 0040H
	l	er0,	NEAR _Mag_Angle
	l	er2,	NEAR _Mag_Angle+02h
	push	xr0
...
;;		PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 08F1H 0003H 001BH
	rb	0f973h.0
...
;;		PWF0D -= Mag_MotorStep; //Can't be running to change (Only this variable)
CLINEA 0000H 0001H 08F5H 0003H 004BH
	l	er0,	0f962h
	l	er2,	NEAR _Mag_MotorStep
	sub	r0,	r2
	subc	r1,	r3
...
;;		PWED += Mag_MotorStep;
CLINEA 0000H 0001H 08F6H 0003H 0018H
	l	er0,	0f932h
	add	er0,	er2
	st	er0,	0f932h

;;		PWDD += Mag_MotorStep;
CLINEA 0000H 0001H 08F7H 0003H 0018H
	l	er0,	0f922h
	add	er0,	er2
	st	er0,	0f922h

;;		PWCD -= Mag_MotorStep;
CLINEA 0000H 0001H 08F8H 0003H 0018H
	l	er0,	0f912h
	sub	r0,	r2
	subc	r1,	r3
	st	er0,	0f912h
...
;;		PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 08F9H 0003H 001AH
	sb	0f973h.0
...
CLINEA 0000H 0001H 08FCH 0003H 000CH
	sb	0f917h.0
CBLOCKEND 236 4 2301

;;	}
CLINEA 0000H 0000H 08FDH 0002H 0002H
_$L463 :
CBLOCKEND 236 2 2302

;;}
CLINEA 0000H 0001H 08FEH 0001H 0001H
	pop	pc
CBLOCKEND 236 1 2302
CFUNCTIONEND 236
...
CLINEA 0000H 0001H 0900H 0001H 001FH
	push	lr
	push	xr4
CBLOCK 237 2 2304
CRET 0004H
...
CLINEA 0000H 0001H 0905H 0002H 001BH
...
CLINEA 0000H 0001H 0906H 0003H 0030H
	mov	er0,	#0 
	mov	r2,	#0b4h
	mov	r3,	#043h
	push	xr0
...
CLINEA 0000H 0001H 0907H 0003H 003BH
	push	xr0
	l	er0,	NEAR _Mag_Angle
	l	er2,	NEAR _Mag_Angle+02h
	push	xr0
...
CLINEA 0000H 0001H 0908H 0003H 001FH
	push	xr0
	mov	er0,	#0 
	mov	r2,	#034h
	mov	r3,	#043h
...
CLINEA 0000H 0001H 0909H 0004H 002BH
	...
	add	sp,	#4 
	pop	xr0
CBLOCKEND 237 4 2315

;;		else{
CLINEA 0000H 0001H 090CH 0003H 0007H
	bal	_$L475
_$L473 :
CBLOCK 237 5 2316

;;			Mag_PIDError= Mag_PIDAngleScaled;
CLINEA 0000H 0001H 090DH 0004H 0024H
	l	er0,	NEAR _Mag_PIDAngleScaled
	l	er2,	NEAR _Mag_PIDAngleScaled+02h
CBLOCKEND 237 5 2318

;;		}
CLINEA 0000H 0000H 090EH 0003H 0003H
_$L475 :

;;	else{
CLINEA 0000H 0001H 0910H 0002H 0006H
	bal	_$L479
_$L471 :
CBLOCK 237 6 2320

;;		Mag_PIDCorrectionFactor = Mag_PIDSetpoint;					
CLINEA 0000H 0001H 0911H 0003H 0031H
	l	er0,	NEAR _Mag_PIDSetpoint
	l	er2,	NEAR _Mag_PIDSetpoint+02h
	st	er0,	NEAR _Mag_PIDCorrectionFactor
	st	er2,	NEAR _Mag_PIDCorrectionFactor+02h
...
;;		Mag_PIDAngleScaled = Mag_Angle - Mag_PIDCorrectionFactor;
CLINEA 0000H 0001H 0913H 0003H 003BH
	l	er0,	NEAR _Mag_Angle
	l	er2,	NEAR _Mag_Angle+02h
	push	xr0
	l	er0,	NEAR _Mag_PIDSetpoint
...
;;		if(Mag_PIDAngleScaled > 180){
CLINEA 0000H 0001H 0914H 0003H 001FH
	push	xr0
	mov	er0,	#0 
	mov	r2,	#034h
	mov	r3,	#043h
...
;;			Mag_PIDError = Mag_PIDAngleScaled - 360;
CLINEA 0000H 0001H 0915H 0004H 002BH
	l	er0,	NEAR _Mag_PIDAngleScaled
	l	er2,	NEAR _Mag_PIDAngleScaled+02h
	push	xr0
	mov	er0,	#0 
	...
	add	sp,	#4 
	pop	xr0
CBLOCKEND 237 7 2327

;;		else{
CLINEA 0000H 0001H 0918H 0003H 0007H
	bal	_$L479
_$L477 :
CBLOCK 237 8 2328

;;			Mag_PIDError = Mag_PIDAngleScaled;
CLINEA 0000H 0001H 0919H 0004H 0025H
	l	er0,	NEAR _Mag_PIDAngleScaled
	l	er2,	NEAR _Mag_PIDAngleScaled+02h
CBLOCKEND 237 8 2330

;;		}
CLINEA 0000H 0000H 091AH 0003H 0003H
_$L479 :
	st	er0,	NEAR _Mag_PIDError
	st	er2,	NEAR _Mag_PIDError+02h
CBLOCKEND 237 6 2331

;;	Mag_PIDError *= -1;
CLINEA 0000H 0001H 091CH 0002H 0014H
	push	xr0
	mov	er0,	#0 
	mov	r2,	#080h
	mov	r3,	#0bfh
...
CLINEA 0000H 0001H 0922H 0002H 006DH
...
;;	Mag_PIDCounter = 0;
CLINEA 0000H 0001H 0923H 0002H 0014H
	mov	er0,	#0 
	st	er0,	NEAR _Mag_PIDCounter

;;	Mag_PIDErrSum += (Mag_PIDError * Mag_PIDCurrentCount);
CLINEA 0000H 0001H 0926H 0002H 0037H
...
CLINEA 0000H 0001H 092AH 0002H 0024H
	l	er0,	NEAR _Mag_PIDError
	l	er2,	NEAR _Mag_PIDError+02h
	push	xr0
...
CLINEA 0000H 0001H 092BH 0002H 001FH
	l	er0,	NEAR _Mag_PIDError
	l	er2,	NEAR _Mag_PIDError+02h
...
CLINEA 0000H 0001H 092EH 0002H 0063H
	push	xr0
...
;;	PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0932H 0002H 001AH
	rb	0f973h.0
...
CLINEA 0000H 0001H 0937H 0002H 004CH
	l	er0,	0f962h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0938H 0002H 0034H
	l	er0,	0f932h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0939H 0002H 0034H
	l	er0,	0f922h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;	PWCD -= Mag_PIDOutput;
CLINEA 0000H 0001H 093AH 0002H 0017H
	l	er0,	0f912h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;	CheckSafetyLimit();
CLINEA 0000H 0001H 093BH 0002H 0014H
	bl	_CheckSafetyLimit
CBLOCKEND 237 3 2390

;;	PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 093CH 0002H 0019H
	sb	0f973h.0

;;	PERUN = 1;
CLINEA 0000H 0001H 093DH 0002H 000BH
	sb	0f937h.0
...
;;	PCRUN = 1;
CLINEA 0000H 0001H 093FH 0002H 000BH
	sb	0f917h.0

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 0943H 0002H 0017H
	mov	er0,	#0 
_$L482 :
CBLOCK 237 9 2372

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 0945H 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 237 9 2374

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0943H 0002H 0017H
	add	er0,	#1 

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0943H 000EH 0013H
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L482

;;	sprintf(SensorReturn, "%f,%f,%f,%f", Mag_Angle, Mag_PIDOutput, Mag_PID_kd, Mag_PID_kp);
CLINEA 0000H 0001H 0949H 0002H 0058H
	l	er0,	NEAR _Mag_PID_kp
	l	er2,	NEAR _Mag_PID_kp+02h
	push	xr0
	add	sp,	#-4
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 094BH 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 094CH 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 094FH 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 0950H 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(SensorReturn, 150, _funcUartFin);
CLINEA 0000H 0001H 0951H 0002H 0031H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	r2,	#096h
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0952H 0001H 0001H
	bal	_$L491

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0952H 0002H 0019H
_$L489 :
CBLOCK 237 10 2386

;;		NOP1000();
CLINEA 0000H 0001H 0953H 0003H 000CH
	bl	_NOP1000

;;		main_clrWDT();
CLINEA 0000H 0001H 0954H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 237 10 2389
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0952H 000EH 0013H
	l	r0,	NEAR __flgUartFin
	cmp	r0,	#01h
	bne	_$L489
CBLOCKEND 237 2 2390

;;}
CLINEA 0000H 0001H 0956H 0001H 0001H
	pop	xr4
	pop	pc
CBLOCKEND 237 1 2390
CFUNCTIONEND 237
...
CLINEA 0000H 0001H 0958H 0001H 0021H
	push	lr
	push	xr8
	push	xr4
CBLOCK 238 2 2392
...
;;	LED_3 = 1;		//C1, Pin 13
CLINEA 0000H 0001H 096FH 0002H 0019H
	sb	0f260h.1

;;		Accel_PID_XRollError = -CF_XRoll;	//Setpoint - Error (in this case setpoint is 0)
CLINEA 0000H 0001H 0982H 0003H 0053H
...
CLINEA 0000H 0001H 098FH 0003H 0051H
...
CLINEA 0000H 0001H 0995H 0003H 002FH
	push	xr0
	mov	er0,	#0 
	mov	r2,	#048h
	mov	r3,	#043h
...
CLINEA 0000H 0001H 0997H 0004H 002DH
	mov	er0,	#0 
	mov	r2,	#048h
	mov	r3,	#043h
	st	er0,	NEAR _Accel_PID_XRollErrSum
	st	er2,	NEAR _Accel_PID_XRollErrSum+02h
CBLOCKEND 238 3 2456

;;		}
CLINEA 0000H 0000H 0998H 0003H 0003H
_$L493 :

;;		if(Accel_PID_XRollErrSum < -Accel_PID_IBounds)
CLINEA 0000H 0001H 0999H 0003H 0030H
	l	er0,	NEAR _Accel_PID_XRollErrSum
	l	er2,	NEAR _Accel_PID_XRollErrSum+02h
	push	xr0
	mov	er0,	#0 
...
;;			Accel_PID_XRollErrSum = -Accel_PID_IBounds;
CLINEA 0000H 0001H 099BH 0004H 002EH
	mov	er0,	#0 
	mov	r2,	#048h
	mov	r3,	#0c3h
	st	er0,	NEAR _Accel_PID_XRollErrSum
	st	er2,	NEAR _Accel_PID_XRollErrSum+02h
CBLOCKEND 238 4 2460

;;		}
CLINEA 0000H 0000H 099CH 0003H 0003H
_$L495 :

;;		Accel_PID_XRolldErr	/= Accel_PID_XRollCurrentCount;
CLINEA 0000H 0001H 09A1H 0003H 0035H
	l	er0,	NEAR _$ST4
...
CLINEA 0000H 0001H 09A2H 0003H 0030H
	l	er0,	NEAR _$ST4
	l	er2,	NEAR _$ST4+02h
...
CLINEA 0000H 0001H 09A7H 0003H 0044H
	push	xr0
	l	er0,	NEAR _Accel_PID_XRoll_kp
	l	er2,	NEAR _Accel_PID_XRoll_kp+02h
	push	xr0
...
CLINEA 0000H 0001H 0A1CH 0003H 0054H
...
CLINEA 0000H 0001H 0A23H 0003H 0030H
	push	xr0
	mov	er0,	#0 
	mov	r2,	#048h
	mov	r3,	#043h
...
CLINEA 0000H 0001H 0A25H 0004H 002EH
	mov	er0,	#0 
	mov	r2,	#048h
	mov	r3,	#043h
	st	er0,	NEAR _Accel_PID_YPitchErrSum
	st	er2,	NEAR _Accel_PID_YPitchErrSum+02h
CBLOCKEND 238 5 2598

;;		}
CLINEA 0000H 0000H 0A26H 0003H 0003H
_$L497 :

;;		if(Accel_PID_YPitchErrSum < -Accel_PID_IBounds)
CLINEA 0000H 0001H 0A27H 0003H 0031H
	l	er0,	NEAR _Accel_PID_YPitchErrSum
	l	er2,	NEAR _Accel_PID_YPitchErrSum+02h
	push	xr0
	mov	er0,	#0 
...
;;			Accel_PID_YPitchErrSum = -Accel_PID_IBounds;
CLINEA 0000H 0001H 0A29H 0004H 002FH
	mov	er0,	#0 
	mov	r2,	#048h
	mov	r3,	#0c3h
	st	er0,	NEAR _Accel_PID_YPitchErrSum
	st	er2,	NEAR _Accel_PID_YPitchErrSum+02h
CBLOCKEND 238 6 2602

;;		}
CLINEA 0000H 0000H 0A2AH 0003H 0003H
_$L499 :

;;		Accel_PID_YPitchdErr /= Accel_PID_YPitchCurrentCount;
CLINEA 0000H 0001H 0A2FH 0003H 0037H
	l	er0,	NEAR _$ST10
...
CLINEA 0000H 0001H 0A30H 0003H 0032H
	l	er0,	NEAR _$ST10
	l	er2,	NEAR _$ST10+02h
...
CLINEA 0000H 0001H 0A33H 0003H 00A3H
	push	xr0
...
;;		if(PrePIDCount >= 10){
CLINEA 0000H 0001H 0A5BH 0003H 0018H
	l	r0,	NEAR _PrePIDCount
	cmp	r0,	#0ah
	bge	_$M36
	b	_$L501
...
;;			PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0A5CH 0004H 001CH
	rb	0f973h.0

;;			PERUN = 0;
CLINEA 0000H 0001H 0A5DH 0004H 000DH
	rb	0f937h.0

;;			PDRUN = 0;
CLINEA 0000H 0001H 0A5EH 0004H 000DH
	rb	0f927h.0

;;			PCRUN = 0;
CLINEA 0000H 0001H 0A5FH 0004H 000DH
	rb	0f917h.0

;;			PWF0D = PWMIdleDutyRun + Accel_PID_YPitchOutput; 		//Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0A64H 0004H 0067H
...
CLINEA 0000H 0001H 0A6BH 0004H 0032H
	l	er0,	NEAR _PWMIdleDutyRun
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0A6CH 0004H 0033H
	l	er0,	NEAR _PWMIdleDutyRun
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0A6DH 0004H 0031H
	l	er0,	NEAR _PWMIdleDutyRun
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;			CheckSafetyLimit();
CLINEA 0000H 0001H 0A6FH 0004H 0016H
	bl	_CheckSafetyLimit

;;			PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0A70H 0004H 001BH
	sb	0f973h.0

;;			PERUN = 1;
CLINEA 0000H 0001H 0A71H 0004H 000DH
	sb	0f937h.0

;;			PDRUN = 1;
CLINEA 0000H 0001H 0A72H 0004H 000DH
	sb	0f927h.0

;;			PCRUN = 1;
CLINEA 0000H 0001H 0A73H 0004H 000DH
	sb	0f917h.0
CBLOCKEND 238 7 2676

;;		}
CLINEA 0000H 0000H 0A74H 0003H 0003H
_$L501 :

;;	LED_3 = 0;		//C1, Pin 13
CLINEA 0000H 0001H 0AC0H 0002H 0019H
	rb	0f260h.1

;;	LED_2 = 0;			//B7, Pin 11
CLINEA 0000H 0001H 0AC1H 0002H 001AH
	rb	0f258h.7
CBLOCKEND 238 2 2754
...
CLINEA 0000H 0001H 0AC4H 0001H 0021H
	push	lr
	push	xr8
	push	xr4
CBLOCK 239 2 2756
...
CLINEA 0000H 0001H 0AC9H 0002H 0030H
	l	er0,	NEAR _Range_out
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0ACCH 0002H 0071H
...
CLINEA 0000H 0001H 0AD4H 0002H 0028H
	push	xr0
...
CLINEA 0000H 0001H 0AD5H 0002H 0023H
...
CLINEA 0000H 0001H 0AD8H 0002H 0071H
	push	xr0
...
;;	PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0ADCH 0002H 001AH
	rb	0f973h.0

;;	PERUN = 0;
CLINEA 0000H 0001H 0ADDH 0002H 000BH
	rb	0f937h.0

;;	PDRUN = 0;
CLINEA 0000H 0001H 0ADEH 0002H 000BH
	rb	0f927h.0

;;	PCRUN = 0;
CLINEA 0000H 0001H 0ADFH 0002H 000BH
	rb	0f917h.0

;;	PWF0D += Range_PIDOutput; 		//Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0AE0H 0002H 004EH
	l	er0,	0f962h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0AE3H 0002H 0019H
	l	er0,	0f912h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;	CheckSafetyLimit();
CLINEA 0000H 0001H 0AE4H 0002H 0014H
	bl	_CheckSafetyLimit

;;	PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0AE5H 0002H 0019H
	sb	0f973h.0

;;	PERUN = 1;
CLINEA 0000H 0001H 0AE6H 0002H 000BH
	sb	0f937h.0

;;	PDRUN = 1;
CLINEA 0000H 0001H 0AE7H 0002H 000BH
	sb	0f927h.0

;;	PCRUN = 1;
CLINEA 0000H 0001H 0AE8H 0002H 000BH
	sb	0f917h.0

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 0AEAH 0002H 0017H
	mov	er0,	#0 
_$L506 :
CBLOCK 239 3 2795

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 0AECH 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 239 3 2797

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0AEAH 0002H 0017H
	add	er0,	#1 

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0AEAH 000EH 0013H
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L506

;;	sprintf(SensorReturn, "%f,%f,%f", Range_out, Range_PIDCurrentCount,Range_PIDOutput);
CLINEA 0000H 0001H 0AF0H 0002H 0055H
	l	er0,	NEAR _Range_PIDOutput
	l	er2,	NEAR _Range_PIDOutput+02h
	push	xr0
	add	sp,	#-4
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 0AF2H 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 0AF3H 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 0AF6H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 0AF7H 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(SensorReturn, 150, _funcUartFin);
CLINEA 0000H 0001H 0AF8H 0002H 0031H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	r2,	#096h
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0AF9H 0001H 0001H
	bal	_$L514

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0AF9H 0002H 0019H
_$L512 :
CBLOCK 239 4 2809

;;		main_clrWDT();
CLINEA 0000H 0001H 0AFAH 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 239 4 2811
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0AF9H 000EH 0013H
	l	r0,	NEAR __flgUartFin
	cmp	r0,	#01h
	bne	_$L512
CBLOCKEND 239 2 2813

;;}
CLINEA 0000H 0001H 0AFDH 0001H 0001H
	pop	xr4
	pop	xr8
	pop	pc
CBLOCKEND 239 1 2813
CFUNCTIONEND 239
...
CLINEA 0000H 0001H 0AFFH 0001H 001DH
CBLOCK 240 2 2815

;;	if(PWED > PWMUpperDutyLimitRun){
CLINEA 0000H 0001H 0B01H 0002H 0021H
	l	er0,	0f932h
...
CLINEA 0000H 0001H 0B02H 0003H 001EH
	st	er2,	0f932h
CBLOCKEND 240 3 2819

;;	}
CLINEA 0000H 0000H 0B03H 0002H 0002H
_$L516 :

;;	if(PWED < PWMLowerDutyLimitRun){
CLINEA 0000H 0001H 0B04H 0002H 0021H
	l	er0,	0f932h
	l	er2,	NEAR _PWMLowerDutyLimitRun
	cmp	er0,	er2
	bge	_$L518
...
CLINEA 0000H 0001H 0B05H 0003H 001EH
	st	er2,	0f932h
CBLOCKEND 240 4 2822

;;	}
CLINEA 0000H 0000H 0B06H 0002H 0002H
_$L518 :

;;	if(PWF0D > PWMUpperDutyLimitRun){
CLINEA 0000H 0001H 0B07H 0002H 0022H
	l	er0,	0f962h
	l	er2,	NEAR _PWMUpperDutyLimitRun
	cmp	er0,	er2
	ble	_$L520
...
CLINEA 0000H 0001H 0B08H 0003H 001FH
	st	er2,	0f962h
CBLOCKEND 240 5 2825

;;	}
CLINEA 0000H 0000H 0B09H 0002H 0002H
_$L520 :

;;	if(PWF0D < PWMLowerDutyLimitRun){
CLINEA 0000H 0001H 0B0AH 0002H 0022H
	l	er0,	0f962h
	l	er2,	NEAR _PWMLowerDutyLimitRun
	cmp	er0,	er2
	bge	_$L522
...
CLINEA 0000H 0001H 0B0BH 0003H 001FH
	st	er2,	0f962h
CBLOCKEND 240 6 2828

;;	}
CLINEA 0000H 0000H 0B0CH 0002H 0002H
_$L522 :

;;	if(PWDD > PWMUpperDutyLimitRun){
CLINEA 0000H 0001H 0B0DH 0002H 0021H
	l	er0,	0f922h
	l	er2,	NEAR _PWMUpperDutyLimitRun
	cmp	er0,	er2
	ble	_$L524
...
CLINEA 0000H 0001H 0B0EH 0003H 001EH
	st	er2,	0f922h
CBLOCKEND 240 7 2831

;;	}
CLINEA 0000H 0000H 0B0FH 0002H 0002H
_$L524 :

;;	if(PWDD < PWMLowerDutyLimitRun){
CLINEA 0000H 0001H 0B10H 0002H 0021H
	l	er0,	0f922h
	l	er2,	NEAR _PWMLowerDutyLimitRun
	cmp	er0,	er2
	bge	_$L526
...
CLINEA 0000H 0001H 0B11H 0003H 001EH
	st	er2,	0f922h
CBLOCKEND 240 8 2834

;;	}
CLINEA 0000H 0000H 0B12H 0002H 0002H
_$L526 :

;;	if(PWCD > PWMUpperDutyLimitRun){
CLINEA 0000H 0001H 0B13H 0002H 0021H
	l	er0,	0f912h
	l	er2,	NEAR _PWMUpperDutyLimitRun
	cmp	er0,	er2
	ble	_$L528
...
CLINEA 0000H 0001H 0B14H 0003H 001EH
	st	er2,	0f912h
CBLOCKEND 240 9 2837

;;	}
CLINEA 0000H 0000H 0B15H 0002H 0002H
_$L528 :

;;	if(PWCD < PWMLowerDutyLimitRun){
CLINEA 0000H 0001H 0B16H 0002H 0021H
	l	er0,	0f912h
	l	er2,	NEAR _PWMLowerDutyLimitRun
	cmp	er0,	er2
	bge	_$L530
...
CLINEA 0000H 0001H 0B17H 0003H 001EH
	st	er2,	0f912h
CBLOCKEND 240 10 2840

;;	}
CLINEA 0000H 0000H 0B18H 0002H 0002H
_$L530 :
CBLOCKEND 240 2 2841

;;}
CLINEA 0000H 0001H 0B19H 0001H 0001H
	rt
CBLOCKEND 240 1 2841
CFUNCTIONEND 240
...
CLINEA 0000H 0001H 0B1BH 0001H 0025H
CBLOCK 241 2 2843

;;	if(Accel_PID_Motor1 > (49151)){
CLINEA 0000H 0001H 0B1DH 0002H 0020H
...
CLINEA 0000H 0001H 0B1EH 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#0bfh
	st	er0,	NEAR _Accel_PID_Motor1
CBLOCKEND 241 3 2847

;;	}
CLINEA 0000H 0000H 0B1FH 0002H 0002H
_$L533 :

;;	if(Accel_PID_Motor1 < 16383){
CLINEA 0000H 0001H 0B20H 0002H 001EH
	l	er0,	NEAR _Accel_PID_Motor1
	cmp	r0,	#0ffh
	cmpc	r1,	#03fh
	bge	_$L535
...
CLINEA 0000H 0001H 0B21H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor1
CBLOCKEND 241 4 2850

;;	}
CLINEA 0000H 0000H 0B22H 0002H 0002H
_$L535 :

;;	if(Accel_PID_Motor2 > (49151)){
CLINEA 0000H 0001H 0B23H 0002H 0020H
...
CLINEA 0000H 0001H 0B24H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#0bfh
	st	er0,	NEAR _Accel_PID_Motor2
CBLOCKEND 241 5 2853

;;	}
CLINEA 0000H 0000H 0B25H 0002H 0002H
_$L537 :

;;	if(Accel_PID_Motor2 < (16383)){
CLINEA 0000H 0001H 0B26H 0002H 0020H
	l	er0,	NEAR _Accel_PID_Motor2
	cmp	r0,	#0ffh
	cmpc	r1,	#03fh
	bge	_$L539
...
CLINEA 0000H 0001H 0B27H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor2
CBLOCKEND 241 6 2856

;;	}
CLINEA 0000H 0000H 0B28H 0002H 0002H
_$L539 :

;;	if(Accel_PID_Motor3 > (49151)){
CLINEA 0000H 0001H 0B29H 0002H 0020H
...
CLINEA 0000H 0001H 0B2AH 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#0bfh
	st	er0,	NEAR _Accel_PID_Motor3
CBLOCKEND 241 7 2859

;;	}
CLINEA 0000H 0000H 0B2BH 0002H 0002H
_$L541 :

;;	if(Accel_PID_Motor3 < (16383)){
CLINEA 0000H 0001H 0B2CH 0002H 0020H
	l	er0,	NEAR _Accel_PID_Motor3
	cmp	r0,	#0ffh
	cmpc	r1,	#03fh
	bge	_$L543
...
CLINEA 0000H 0001H 0B2DH 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor3
CBLOCKEND 241 8 2862

;;	}
CLINEA 0000H 0000H 0B2EH 0002H 0002H
_$L543 :

;;	if(Accel_PID_Motor4 > (49151)){
CLINEA 0000H 0001H 0B2FH 0002H 0020H
...
CLINEA 0000H 0001H 0B30H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#0bfh
	st	er0,	NEAR _Accel_PID_Motor4
CBLOCKEND 241 9 2865

;;	}
CLINEA 0000H 0000H 0B31H 0002H 0002H
_$L545 :

;;	if(Accel_PID_Motor4 < (16383)){
CLINEA 0000H 0001H 0B32H 0002H 0020H
	l	er0,	NEAR _Accel_PID_Motor4
	cmp	r0,	#0ffh
	cmpc	r1,	#03fh
	bge	_$L547
...
CLINEA 0000H 0001H 0B33H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor4
CBLOCKEND 241 10 2868

;;	}
CLINEA 0000H 0000H 0B34H 0002H 0002H
_$L547 :
CBLOCKEND 241 2 2869

;;}
CLINEA 0000H 0001H 0B35H 0001H 0001H
	rt
CBLOCKEND 241 1 2869
CFUNCTIONEND 241
...
;;void Shutdown(void){
CLINEA 0000H 0001H 0B37H 0001H 0014H
	push	lr
CBLOCK 242 2 2871
CRET 0000H

;;	if((PWED > PWMSafeDuty)||(PWF0D > PWMSafeDuty)||(PWDD > PWMSafeDuty)||(PWCD > PWMSafeDuty)){
CLINEA 0000H 0001H 0B38H 0002H 005DH
	l	er0,	0f932h
	l	er2,	NEAR _PWMSafeDuty
	cmp	er0,	er2
	bgt	_$L551
...
;;			main_clrWDT();					
CLINEA 0000H 0001H 0B3AH 0004H 0016H
	bl	_main_clrWDT

;;			PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0B3BH 0004H 001CH
	rb	0f973h.0

;;			PERUN = 0;
CLINEA 0000H 0001H 0B3CH 0004H 000DH
	rb	0f937h.0

;;			PDRUN = 0;
CLINEA 0000H 0001H 0B3DH 0004H 000DH
	rb	0f927h.0

;;			PCRUN = 0;
CLINEA 0000H 0001H 0B3EH 0004H 000DH
	rb	0f917h.0

;;			PWF0D -= 10; //Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0B3FH 0004H 0041H
	l	er0,	0f962h
	add	er0,	#-10
	st	er0,	0f962h

;;			PWED -= 10;
CLINEA 0000H 0001H 0B40H 0004H 000EH
	l	er0,	0f932h
	add	er0,	#-10
	st	er0,	0f932h

;;			PWDD -= 10;
CLINEA 0000H 0001H 0B41H 0004H 000EH
	l	er0,	0f922h
	add	er0,	#-10
	st	er0,	0f922h

;;			PWCD -= 10;
CLINEA 0000H 0001H 0B42H 0004H 000EH
	l	er0,	0f912h
	add	er0,	#-10
	st	er0,	0f912h

;;			PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0B43H 0004H 001BH
	sb	0f973h.0

;;			PERUN = 1;
CLINEA 0000H 0001H 0B44H 0004H 000DH
	sb	0f937h.0

;;			PDRUN = 1;
CLINEA 0000H 0001H 0B45H 0004H 000DH
	sb	0f927h.0

;;			PCRUN = 1;
CLINEA 0000H 0001H 0B46H 0004H 000DH
	sb	0f917h.0

;;			NOPms(100);
CLINEA 0000H 0001H 0B47H 0004H 000EH
	mov	r0,	#064h
	mov	r1,	#00h
	bl	_NOPms

;;			if(PWED <= PWMSafeDuty){
CLINEA 0000H 0001H 0B49H 0004H 001BH
	l	er0,	0f932h
	l	er2,	NEAR _PWMSafeDuty
	cmp	er0,	er2
	bgt	_$L567
...
;;				PWED = PWMSafeDuty;
CLINEA 0000H 0001H 0B4AH 0005H 0017H
	st	er2,	0f932h
CBLOCKEND 242 5 2891

;;			}
CLINEA 0000H 0000H 0B4BH 0004H 0004H
_$L567 :

;;			if(PWF0D <= PWMSafeDuty){
CLINEA 0000H 0001H 0B4CH 0004H 001CH
	l	er0,	0f962h
	cmp	er0,	er2
	bgt	_$L569
CBLOCK 242 6 2892
...
;;				PWF0D = PWMSafeDuty;
CLINEA 0000H 0001H 0B4DH 0005H 0018H
	st	er2,	0f962h
CBLOCKEND 242 6 2894

;;			}
CLINEA 0000H 0000H 0B4EH 0004H 0004H
_$L569 :

;;			if(PWDD <= PWMSafeDuty){
CLINEA 0000H 0001H 0B4FH 0004H 001BH
	l	er0,	0f922h
	cmp	er0,	er2
	bgt	_$L571
CBLOCK 242 7 2895
...
;;				PWDD = PWMSafeDuty;
CLINEA 0000H 0001H 0B50H 0005H 0017H
	st	er2,	0f922h
CBLOCKEND 242 7 2897

;;			}
CLINEA 0000H 0000H 0B51H 0004H 0004H
_$L571 :

;;			if(PWCD <= PWMSafeDuty){
CLINEA 0000H 0001H 0B52H 0004H 001BH
	l	er0,	0f912h
	cmp	er0,	er2
	bgt	_$L573
CBLOCK 242 8 2898
...
;;				PWCD = PWMSafeDuty;
CLINEA 0000H 0001H 0B53H 0005H 0017H
	st	er2,	0f912h
CBLOCKEND 242 8 2900

;;			}
CLINEA 0000H 0000H 0B54H 0004H 0004H
_$L573 :
CBLOCKEND 242 4 2902

;;		}while((PWED > PWMSafeDuty)||(PWF0D > PWMSafeDuty)||(PWDD > PWMSafeDuty)||(PWCD > PWMSafeDuty));
CLINEA 0000H 0000H 0B56H 0003H 0062H
	l	er0,	0f932h
	cmp	er0,	er2
	ble	_$M42
	b	_$L551
...
_$M45 :
_$L564 :
CBLOCKEND 242 3 2903

;;	Accel_PID_Motor1 = 16383;
CLINEA 0000H 0001H 0B58H 0002H 001AH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor1

;;	Accel_PID_Motor2 = 16383;
CLINEA 0000H 0001H 0B59H 0002H 001AH
	st	er0,	NEAR _Accel_PID_Motor2

;;	Accel_PID_Motor3 = 16383;
CLINEA 0000H 0001H 0B5AH 0002H 001AH
	st	er0,	NEAR _Accel_PID_Motor3

;;	Accel_PID_Motor4 = 16383;
CLINEA 0000H 0001H 0B5BH 0002H 001AH
	st	er0,	NEAR _Accel_PID_Motor4
CBLOCKEND 242 2 2909

;;}
CLINEA 0000H 0001H 0B5DH 0001H 0001H
	pop	pc
CBLOCKEND 242 1 2909
CFUNCTIONEND 242
...
;;void ESC1_PWM(void){
CLINEA 0000H 0001H 0B61H 0001H 0014H
CBLOCK 215 2 2913

;;      PC0DIR = 0;       // PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0B70H 0007H 003BH
	rb	0f261h.0

;;      PC0C1  = 1;       // PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0B73H 0007H 003BH
	sb	0f263h.0

;;      PC0C0  = 1;       
CLINEA 0000H 0001H 0B74H 0007H 0018H
	sb	0f262h.0

;;      PC0MD1  = 1;            // PortC Bit0 set to PWM Output (1,0)...
CLINEA 0000H 0001H 0B77H 0007H 0046H
	sb	0f265h.0

;;      PC0MD0  = 0;      
CLINEA 0000H 0001H 0B78H 0007H 0018H
	rb	0f264h.0

;;      PFCS1 = 0;        //00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 0B7CH 0007H 002FH
	rb	0f972h.1

;;      PFCS0 = 1;
CLINEA 0000H 0001H 0B7DH 0007H 0010H
	sb	0f972h.0

;;      PWFP = PWMPeriod;            // Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0B80H 0007H 0092H
	l	er0,	NEAR _PWMPeriod
	st	er0,	0f960h

;;      PWF0D =    PWMSafeDuty;           //12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 0B8AH 0007H 004CH
	l	er0,	NEAR _PWMSafeDuty
	st	er0,	0f962h

;;      PFRUN = 0;        // OFF to start
CLINEA 0000H 0001H 0B8CH 0007H 0027H
	rb	0f973h.0
CBLOCKEND 215 2 2957

;;}
CLINEA 0000H 0001H 0B8DH 0001H 0001H
	rt
CBLOCKEND 215 1 2957
CFUNCTIONEND 215
...
;;void ESC2_PWM(void){
CLINEA 0000H 0001H 0B92H 0001H 0014H
CBLOCK 216 2 2962

;;      PB2DIR = 0;       // PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0BA1H 0007H 003BH
	rb	0f259h.2

;;      PB2C1  = 1;       // PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0BA4H 0007H 003BH
	sb	0f25bh.2

;;      PB2C0  = 1;       
CLINEA 0000H 0001H 0BA5H 0007H 0018H
	sb	0f25ah.2

;;      PB2MD1  = 0;            // PortB Bit0 set to PWM Output (0,1)...
CLINEA 0000H 0001H 0BA8H 0007H 0046H
	rb	0f25dh.2

;;      PB2MD0  = 1;      
CLINEA 0000H 0001H 0BA9H 0007H 0018H
	sb	0f25ch.2

;;      PECS1 = 0;        //00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 0BADH 0007H 002FH
	rb	0f936h.1

;;      PECS0 = 1;
CLINEA 0000H 0001H 0BAEH 0007H 0010H
	sb	0f936h.0

;;      PWEP = PWMPeriod;            // Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0BB1H 0007H 0092H
	l	er0,	NEAR _PWMPeriod
	st	er0,	0f930h

;;      PWED =    PWMSafeDuty;           //12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 0BBBH 0007H 004BH
	l	er0,	NEAR _PWMSafeDuty
	st	er0,	0f932h

;;      PERUN = 0;        // OFF to start
CLINEA 0000H 0001H 0BBDH 0007H 0027H
	rb	0f937h.0
CBLOCKEND 216 2 3006

;;}
CLINEA 0000H 0001H 0BBEH 0001H 0001H
	rt
CBLOCKEND 216 1 3006
CFUNCTIONEND 216
...
;;void ESC3_PWM(void){
CLINEA 0000H 0001H 0BC4H 0001H 0014H
CBLOCK 217 2 3012

;;      PA1DIR = 0;       // PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0BD3H 0007H 003BH
	rb	0f251h.1

;;      PA1C1  = 1;       // PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0BD6H 0007H 003BH
	sb	0f253h.1

;;      PA1C0  = 1;       
CLINEA 0000H 0001H 0BD7H 0007H 0018H
	sb	0f252h.1

;;      PA1MD1  = 0;            // PortB Bit0 set to PWM Output (0,1)...
CLINEA 0000H 0001H 0BDAH 0007H 0046H
	rb	0f255h.1

;;      PA1MD0  = 1;      
CLINEA 0000H 0001H 0BDBH 0007H 0018H
	sb	0f254h.1

;;      PDCS1 = 0;        //00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 0BDFH 0007H 002FH
	rb	0f926h.1

;;      PDCS0 = 1;
CLINEA 0000H 0001H 0BE0H 0007H 0010H
	sb	0f926h.0

;;      PWDP = PWMPeriod;            // Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0BE3H 0007H 0092H
	l	er0,	NEAR _PWMPeriod
	st	er0,	0f920h

;;      PWDD =    PWMSafeDuty;           //12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 0BEDH 0007H 004BH
	l	er0,	NEAR _PWMSafeDuty
	st	er0,	0f922h

;;      PDRUN = 0;        // OFF to start
CLINEA 0000H 0001H 0BEFH 0007H 0027H
	rb	0f927h.0
CBLOCKEND 217 2 3056

;;}
CLINEA 0000H 0001H 0BF0H 0001H 0001H
	rt
CBLOCKEND 217 1 3056
CFUNCTIONEND 217
...
;;void ESC4_PWM(void){
CLINEA 0000H 0001H 0BF7H 0001H 0014H
CBLOCK 218 2 3063

;;      PA0DIR = 0;       // PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0C06H 0007H 003BH
	rb	0f251h.0

;;      PA0C1  = 1;       // PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0C09H 0007H 003BH
	sb	0f253h.0

;;      PA0C0  = 1;       
CLINEA 0000H 0001H 0C0AH 0007H 0018H
	sb	0f252h.0

;;      PA0MD1  = 0;            // PortB Bit0 set to PWM Output (0,1)...
CLINEA 0000H 0001H 0C0DH 0007H 0046H
	rb	0f255h.0

;;      PA0MD0  = 1;      
CLINEA 0000H 0001H 0C0EH 0007H 0018H
	sb	0f254h.0

;;      PCCS1 = 0;        //00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 0C12H 0007H 002FH
	rb	0f916h.1

;;      PCCS0 = 1;
CLINEA 0000H 0001H 0C13H 0007H 0010H
	sb	0f916h.0

;;      PWCP = PWMPeriod;            // Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0C16H 0007H 0092H
	l	er0,	NEAR _PWMPeriod
	st	er0,	0f910h

;;      PWCD =    PWMSafeDuty;           //12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 0C21H 0007H 004BH
	l	er0,	NEAR _PWMSafeDuty
	st	er0,	0f912h

;;      PCRUN = 0;        // OFF to start
CLINEA 0000H 0001H 0C25H 0007H 0027H
	rb	0f917h.0
CBLOCKEND 218 2 3110

;;}
CLINEA 0000H 0001H 0C26H 0001H 0001H
	rt
CBLOCKEND 218 1 3110
CFUNCTIONEND 218
...
;;{
CLINEA 0000H 0001H 0C2BH 0001H 0001H
CBLOCK 254 2 3115

;;	E128H = 0;	//Turn OFF TBC Interrupt
CLINEA 0000H 0001H 0C2CH 0002H 0024H
	rb	0f016h.5

;;	E128H = 1;	//Turn ON TBC Interrupt
CLINEA 0000H 0001H 0C2DH 0002H 0023H
	sb	0f016h.5
CBLOCKEND 254 2 3118

;;}
CLINEA 0000H 0001H 0C2EH 0001H 0001H
	rt
CBLOCKEND 254 1 3118
CFUNCTIONEND 254
...
;;	LED_1 ^= 1;
CLINEA 0000H 0001H 0C34H 0002H 000CH
	tb	0f250h.2
	beq	_$M52
	rb	0f250h.2
	bal	_$M53
...
;;	Mag_PIDCounter++;
CLINEA 0000H 0000H 0C35H 0002H 0012H
	l	er0,	NEAR _Mag_PIDCounter
	add	er0,	#1 
	st	er0,	NEAR _Mag_PIDCounter

;;	if(Mag_PIDCounter >= 65535){
CLINEA 0000H 0001H 0C36H 0002H 001DH
	mov	er2,	#0 
	cmp	r0,	#0ffh
	cmpc	r1,	#0ffh
	cmpc	r2,	#00h
...
;;		Mag_PIDCounter = 0;
CLINEA 0000H 0001H 0C37H 0003H 0015H
	mov	er0,	#0 
	st	er0,	NEAR _Mag_PIDCounter
CBLOCKEND 255 3 3128
...
;;		Accel_PID_Counter = 0;
CLINEA 0000H 0001H 0C3BH 0003H 0018H
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_Counter
CBLOCKEND 255 4 3132

;;	}
CLINEA 0000H 0000H 0C3CH 0002H 0002H
_$L594 :

;;	Accel_PID_XRollCounter++;
CLINEA 0000H 0000H 0C3DH 0002H 001AH
	l	er0,	NEAR _Accel_PID_XRollCounter
	add	er0,	#1 
	st	er0,	NEAR _Accel_PID_XRollCounter

;;	if(Accel_PID_XRollCounter >= 65535){
CLINEA 0000H 0001H 0C3EH 0002H 0025H
	mov	er2,	#0 
	cmp	r0,	#0ffh
	cmpc	r1,	#0ffh
	cmpc	r2,	#00h
...
;;		Accel_PID_XRollCounter = 0;
CLINEA 0000H 0001H 0C3FH 0003H 001DH
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_XRollCounter
CBLOCKEND 255 5 3136

;;	}
CLINEA 0000H 0000H 0C40H 0002H 0002H
_$L596 :

;;	Accel_PID_YPitchCounter++;
CLINEA 0000H 0000H 0C41H 0002H 001BH
	l	er0,	NEAR _Accel_PID_YPitchCounter
	add	er0,	#1 
	st	er0,	NEAR _Accel_PID_YPitchCounter

;;	if(Accel_PID_YPitchCounter >= 65535){
CLINEA 0000H 0001H 0C42H 0002H 0026H
	mov	er2,	#0 
	cmp	r0,	#0ffh
	cmpc	r1,	#0ffh
	cmpc	r2,	#00h
...
;;		Accel_PID_YPitchCounter = 0;
CLINEA 0000H 0001H 0C43H 0003H 001EH
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_YPitchCounter
CBLOCKEND 255 6 3140
...
;;	Range_PIDCounter++;
CLINEA 0000H 0000H 0C45H 0002H 0014H
	l	er0,	NEAR _Range_PIDCounter
	add	er0,	#1 
	st	er0,	NEAR _Range_PIDCounter

;;	if(Range_PIDCounter >= 65535){
CLINEA 0000H 0001H 0C46H 0002H 001FH
	mov	er2,	#0 
	cmp	r0,	#0ffh
	cmpc	r1,	#0ffh
	cmpc	r2,	#00h
...
;;		Range_PIDCounter = 0;
CLINEA 0000H 0001H 0C47H 0003H 0017H
	mov	er0,	#0 
	st	er0,	NEAR _Range_PIDCounter
CBLOCKEND 255 7 3144

;;	}
CLINEA 0000H 0000H 0C48H 0002H 0002H
_$L600 :

;;	CF_Gyro_Counter++;
CLINEA 0000H 0000H 0C49H 0002H 0013H
	l	er0,	NEAR _CF_Gyro_Counter
	l	er2,	NEAR _CF_Gyro_Counter+02h
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0001H 0C4AH 0002H 001EH
	push	xr0
	mov	r0,	#00h
	mov	r1,	#0ffh
	mov	r2,	#07fh
...
;;		CF_Gyro_Counter = 0;
CLINEA 0000H 0001H 0C4BH 0003H 0016H
	mov	er0,	#0 
	st	er0,	NEAR _CF_Gyro_Counter
	st	er0,	NEAR _CF_Gyro_Counter+02h
CBLOCKEND 255 8 3148

;;	}
CLINEA 0000H 0000H 0C4CH 0002H 0002H
_$L602 :
CBLOCKEND 255 2 3149

;;}
CLINEA 0000H 0001H 0C4DH 0001H 0001H
	pop	pc
CBLOCKEND 255 1 3149
CFUNCTIONEND 255
...
;;	AccGyro_ReadFlag = 1;
CLINEA 0000H 0001H 0C52H 0002H 0016H
	mov	r0,	#01h
	st	r0,	NEAR _AccGyro_ReadFlag
CBLOCKEND 256 2 3155

;;}
CLINEA 0000H 0001H 0C53H 0001H 0001H
	rt
CBLOCKEND 256 1 3155
CFUNCTIONEND 256
...
CLINEA 0000H 0001H 0C5FH 0002H 0054H
	bl	_uart_continue

;;	_flgUartFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0C60H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __flgUartFin
CBLOCKEND 243 2 3170

;;}
CLINEA 0000H 0001H 0C62H 0001H 0001H
	pop	pc
CBLOCKEND 243 1 3170
CFUNCTIONEND 243
...
;;{
CLINEA 0000H 0001H 0C6DH 0001H 0001H
	push	lr
CBLOCK 244 2 3181
CRET 0000H
CARGUMENT 46H 0002H 0000H "size" 02H 00H 01H
...
CLINEA 0000H 0001H 0C6EH 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0C6FH 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin
CBLOCKEND 244 2 3185

;;}
CLINEA 0000H 0001H 0C71H 0001H 0001H
	pop	pc
CBLOCKEND 244 1 3185
CFUNCTIONEND 244
...
;;	i2c_continue();
CLINEA 0000H 0001H 0C7CH 0002H 0010H
	b	_i2c_continue
CBLOCKEND 248 2 3198
CLINEA 0000H 0001H 0C7EH 0001H 0001H
CBLOCKEND 248 1 3198
CFUNCTIONEND 248
...
;;{
CLINEA 0000H 0001H 0C88H 0001H 0001H
	push	lr
CBLOCK 245 2 3208
CRET 0000H
...
;;	while (ret != 1) {
CLINEA 0000H 0000H 0C8DH 0002H 0013H
_$L611 :
CBLOCK 245 3 3213

;;		ret = i2c_continue();
CLINEA 0000H 0000H 0C8EH 0003H 0017H
	bl	_i2c_continue
CBLOCK 245 4 3215
CBLOCKEND 245 4 3217
CBLOCKEND 245 3 3218

;;	while (ret != 1) {
CLINEA 0000H 0000H 0C8DH 000EH 0013H
	cmp	r0,	#01h
	cmpc	r1,	#00h
	bne	_$L611
CBLOCKEND 245 2 3219

;;}
CLINEA 0000H 0001H 0C93H 0001H 0001H
	pop	pc
CBLOCKEND 245 1 3219
CFUNCTIONEND 245
...
;;{
CLINEA 0000H 0001H 0C9DH 0001H 0001H
CBLOCK 246 2 3229

;;	_reqNotHalt = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0C9EH 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __reqNotHalt
CBLOCKEND 246 2 3231

;;}
CLINEA 0000H 0001H 0C9FH 0001H 0001H
	rt
CBLOCKEND 246 1 3231
CFUNCTIONEND 246
...
CLINEA 0000H 0001H 0CAAH 0003H 0047H
	b	_uart_continue
CBLOCKEND 247 2 3243
CLINEA 0000H 0001H 0CABH 0001H 0001H
CBLOCKEND 247 1 3243
CFUNCTIONEND 247
...
CLINEA 0000H 0001H 0CB0H 0001H 0019H
CBLOCK 208 2 3248

;;	SYSC0 = 0;			// Used to select the frequency of the HSCLK => 00=8.192MHz.
CLINEA 0000H 0001H 0CB3H 0002H 004AH
	rb	0f002h.0

;;	SYSC1 = 0;
CLINEA 0000H 0001H 0CB4H 0002H 000BH
	rb	0f002h.1

;;	OSCM1 = 1;			// 10 => Built-in PLL oscillation mode
CLINEA 0000H 0001H 0CB6H 0002H 0034H
	sb	0f002h.3

;;	OSCM0 = 0;
CLINEA 0000H 0001H 0CB7H 0002H 000BH
	rb	0f002h.2
...
CLINEA 0000H 0001H 0CBAH 0002H 0022H
	sb	0f003h.0

;;	LPLL = 1;			//1=Enables the use of PLL oscillation - ADDED 4/30/2013
CLINEA 0000H 0001H 0CBCH 0002H 0045H
	sb	0f003h.7

;;	__EI();			//INT enable
CLINEA 0000H 0001H 0CBEH 0002H 0017H
	ei
CBLOCKEND 208 2 3263

;;}
CLINEA 0000H 0001H 0CBFH 0001H 0001H
	rt
CBLOCKEND 208 1 3263
CFUNCTIONEND 208
...
CLINEA 0000H 0001H 0CC6H 0001H 001DH
CBLOCK 209 2 3270

;;	CMP0EN  = 0x01; 	// Comparator ON...
CLINEA 0000H 0001H 0CDCH 0002H 0025H
	sb	0f950h.0

;;	CMP0E1  = 0x00; 	// No Interupt...
CLINEA 0000H 0001H 0CDDH 0002H 0023H
	rb	0f951h.1

;;	CMP0E0  = 0x00;
CLINEA 0000H 0001H 0CDEH 0002H 0010H
	rb	0f951h.0

;;	CMP0SM1 = 0x00; 	// Detect without Sampling... 
CLINEA 0000H 0001H 0CDFH 0002H 0030H
	rb	0f951h.3

;;	CMP0RFS = 0x01; 	// Differential Input on B5
CLINEA 0000H 0001H 0CE0H 0002H 002DH
	sb	0f951h.4

;;	CMP0EN  = 0x00;
CLINEA 0000H 0001H 0CE3H 0002H 0010H
	rb	0f950h.0
CBLOCKEND 209 2 3302

;;}
CLINEA 0000H 0001H 0CE6H 0001H 0001H
	rt
CBLOCKEND 209 1 3302
CFUNCTIONEND 209
...
;;void PortA_Low(void){
CLINEA 0000H 0001H 0CEEH 0001H 0015H
CBLOCK 210 2 3310
...
;;	PA0C0  = 1;		
CLINEA 0000H 0001H 0CFEH 0002H 000EH
	sb	0f252h.0
...
;;	PA1C0  = 1;	
CLINEA 0000H 0001H 0D00H 0002H 000DH
	sb	0f252h.1
...
;;	PA2C0  = 1;	
CLINEA 0000H 0001H 0D02H 0002H 000DH
	sb	0f252h.2

;;	PA0MD1  = 0;	// PortA Bit0 set to General Purpose Output...
CLINEA 0000H 0001H 0D05H 0002H 003CH
	rb	0f255h.0

;;	PA0MD0  = 0;	
CLINEA 0000H 0001H 0D06H 0002H 000EH
	rb	0f254h.0

;;	PA1MD1  = 0;	// PortA Bit1 set to General Purpose Output...
CLINEA 0000H 0001H 0D07H 0002H 003CH
	rb	0f255h.1

;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 0D08H 0002H 000EH
	rb	0f254h.1

;;	PA2MD1  = 0;	// PortA Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 0D09H 0002H 003CH
	rb	0f255h.2
...
CLINEA 0000H 0001H 0D0DH 0002H 0021H
	rb	0f250h.0

;;	PA1D = 0;		// A.1 Output OFF....
CLINEA 0000H 0001H 0D0EH 0002H 0021H
	rb	0f250h.1

;;	PA2D = 0;		// A.2 Output OFF....
CLINEA 0000H 0001H 0D0FH 0002H 0021H
	rb	0f250h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0D11H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 210 2 3347
CLINEA 0000H 0001H 0D13H 0001H 0001H
CBLOCKEND 210 1 3347
CFUNCTIONEND 210
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 0D19H 0001H 0015H
CBLOCK 211 2 3353

;;	PB0DIR = 0;		// PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0D23H 0002H 0031H
	rb	0f259h.0

;;	PB1DIR = 0;		// PortB Bit1 set to Output Mode...
CLINEA 0000H 0001H 0D24H 0002H 0031H
	rb	0f259h.1

;;	PB2DIR = 0;		// PortB Bit2 set to Output Mode...
CLINEA 0000H 0001H 0D25H 0002H 0031H
	rb	0f259h.2

;;	PB3DIR = 0;		// PortB Bit3 set to Output Mode...
CLINEA 0000H 0001H 0D26H 0002H 0031H
	rb	0f259h.3

;;	PB4DIR = 0;		// PortB Bit4 set to Output Mode...
CLINEA 0000H 0001H 0D27H 0002H 0031H
	rb	0f259h.4

;;	PB5DIR = 0;		// PortB Bit5 set to Output Mode...
CLINEA 0000H 0001H 0D28H 0002H 0031H
	rb	0f259h.5

;;	PB6DIR = 0;		// PortB Bit6 set to Output Mode...
CLINEA 0000H 0001H 0D29H 0002H 0031H
	rb	0f259h.6

;;	PB7DIR = 0;		// PortB Bit7 set to Output Mode...
CLINEA 0000H 0001H 0D2AH 0002H 0031H
	rb	0f259h.7
...
;;	PB1C0  = 1;	
CLINEA 0000H 0001H 0D30H 0002H 000DH
	sb	0f25ah.1
...
;;	PB2C0  = 1;	
CLINEA 0000H 0001H 0D32H 0002H 000DH
	sb	0f25ah.2

;;	PB3C1  = 1;		// PortB Bit3 set to CMOS Output...
CLINEA 0000H 0001H 0D33H 0002H 0031H
	sb	0f25bh.3

;;	PB3C0  = 1;		
CLINEA 0000H 0001H 0D34H 0002H 000EH
	sb	0f25ah.3

;;	PB4C1  = 1;		// PortB Bit4 set to CMOS Output...
CLINEA 0000H 0001H 0D35H 0002H 0031H
	sb	0f25bh.4

;;	PB4C0  = 1;	
CLINEA 0000H 0001H 0D36H 0002H 000DH
	sb	0f25ah.4

;;	PB5C1  = 1;		// PortB Bit5 set to CMOS Output...
CLINEA 0000H 0001H 0D37H 0002H 0031H
	sb	0f25bh.5
...
CLINEA 0000H 0001H 0D39H 0002H 0031H
	sb	0f25bh.6
...
CLINEA 0000H 0001H 0D3BH 0002H 0031H
	sb	0f25bh.7

;;	PB7C0  = 1;	
CLINEA 0000H 0001H 0D3CH 0002H 000DH
	sb	0f25ah.7

;;	PB0MD1  = 0;	// PortB Bit0 set to General Purpose Output...
CLINEA 0000H 0001H 0D3FH 0002H 003CH
	rb	0f25dh.0

;;	PB0MD0  = 0;	
CLINEA 0000H 0001H 0D40H 0002H 000EH
	rb	0f25ch.0

;;	PB1MD1  = 0;	// PortB Bit1 set to General Purpose Output...
CLINEA 0000H 0001H 0D41H 0002H 003CH
	rb	0f25dh.1

;;	PB1MD0  = 0;	
CLINEA 0000H 0001H 0D42H 0002H 000EH
	rb	0f25ch.1

;;	PB2MD1  = 0;	// PortB Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 0D43H 0002H 003CH
	rb	0f25dh.2

;;	PB2MD0  = 0;	
CLINEA 0000H 0001H 0D44H 0002H 000EH
	rb	0f25ch.2

;;	PB3MD1  = 0;	// PortB Bit3 set to General Purpose Output...
CLINEA 0000H 0001H 0D45H 0002H 003CH
	rb	0f25dh.3

;;	PB3MD0  = 0;	
CLINEA 0000H 0001H 0D46H 0002H 000EH
	rb	0f25ch.3
...
;;	PB5MD0  = 0;
CLINEA 0000H 0001H 0D4AH 0002H 000DH
	rb	0f25ch.5
...
;;	PB7MD0  = 0;
CLINEA 0000H 0001H 0D4EH 0002H 000DH
	rb	0f25ch.7

;;	PB0D = 0;		// B.0 Output OFF....
CLINEA 0000H 0001H 0D51H 0002H 0021H
	rb	0f258h.0
...
CLINEA 0000H 0001H 0D5AH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 211 2 3420
CLINEA 0000H 0001H 0D5CH 0001H 0001H
CBLOCKEND 211 1 3420
CFUNCTIONEND 211
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 0D62H 0001H 0015H
CBLOCK 212 2 3426

;;	PC0DIR = 0;		// PortC Bit0 set to Output Mode...
CLINEA 0000H 0001H 0D6CH 0002H 0031H
	rb	0f261h.0

;;	PC1DIR = 0;		// PortC Bit1 set to Output Mode...
CLINEA 0000H 0001H 0D6DH 0002H 0031H
	rb	0f261h.1

;;	PC2DIR = 0;		// PortC Bit2 set to Output Mode...
CLINEA 0000H 0001H 0D6EH 0002H 0031H
	rb	0f261h.2

;;	PC3DIR = 0;		// PortC Bit3 set to Output Mode...
CLINEA 0000H 0001H 0D6FH 0002H 0031H
	rb	0f261h.3

;;	PC4DIR = 0;		// PortC Bit4 set to Output Mode...
CLINEA 0000H 0001H 0D70H 0002H 0031H
	rb	0f261h.4

;;	PC5DIR = 0;		// PortC Bit5 set to Output Mode...
CLINEA 0000H 0001H 0D71H 0002H 0031H
	rb	0f261h.5

;;	PC6DIR = 0;		// PortC Bit6 set to Output Mode...
CLINEA 0000H 0001H 0D72H 0002H 0031H
	rb	0f261h.6
...
CLINEA 0000H 0001H 0D76H 0002H 003BH
	sb	0f263h.0

;;	PC0C0  = 1;		
CLINEA 0000H 0001H 0D77H 0002H 000EH
	sb	0f262h.0

;;	PC1C1  = 1;		// PortC Bit1 set to High-Impedance Output...
CLINEA 0000H 0001H 0D78H 0002H 003BH
	sb	0f263h.1

;;	PC1C0  = 1;	
CLINEA 0000H 0001H 0D79H 0002H 000DH
	sb	0f262h.1

;;	PC2C1  = 1;		// PortC Bit2 set to High-Impedance Output...
CLINEA 0000H 0001H 0D7AH 0002H 003BH
	sb	0f263h.2

;;	PC2C0  = 1;	
CLINEA 0000H 0001H 0D7BH 0002H 000DH
	sb	0f262h.2

;;	PC3C1  = 1;		// PortC Bit3 set to High-Impedance Output...
CLINEA 0000H 0001H 0D7CH 0002H 003BH
	sb	0f263h.3
...
CLINEA 0000H 0001H 0D7EH 0002H 003BH
	sb	0f263h.4
...
CLINEA 0000H 0001H 0D80H 0002H 003BH
	sb	0f263h.5
...
CLINEA 0000H 0001H 0D82H 0002H 003BH
	sb	0f263h.6
...
CLINEA 0000H 0001H 0D84H 0002H 003BH
	sb	0f263h.7
...
CLINEA 0000H 0001H 0D88H 0002H 003CH
	rb	0f265h.0
...
CLINEA 0000H 0001H 0D8AH 0002H 003CH
	rb	0f265h.1
...
CLINEA 0000H 0001H 0D8CH 0002H 003CH
	rb	0f265h.2
...
CLINEA 0000H 0001H 0D8EH 0002H 003CH
	rb	0f265h.3

;;	PC3MD0  = 0;	
CLINEA 0000H 0001H 0D8FH 0002H 000EH
	rb	0f264h.3

;;	PC4MD1  = 0;	// PortC Bit4 set to General Purpose Output...
CLINEA 0000H 0001H 0D90H 0002H 003CH
	rb	0f265h.4

;;	PC4MD0  = 0;	
CLINEA 0000H 0001H 0D91H 0002H 000EH
	rb	0f264h.4
...
;;	PC5MD0  = 0;
CLINEA 0000H 0001H 0D93H 0002H 000DH
	rb	0f264h.5
...
;;	PC7MD0  = 0;
CLINEA 0000H 0001H 0D97H 0002H 000DH
	rb	0f264h.7
...
CLINEA 0000H 0001H 0D9DH 0002H 0021H
	rb	0f260h.3

;;	PC4D = 0;		// C.4 Output OFF....
CLINEA 0000H 0001H 0D9EH 0002H 0021H
	rb	0f260h.4

;;	PC5D = 0;		// C.5 Output OFF....
CLINEA 0000H 0001H 0D9FH 0002H 0021H
	rb	0f260h.5

;;	PC6D = 0;		// C.6 Output OFF....
CLINEA 0000H 0001H 0DA0H 0002H 0021H
	rb	0f260h.6

;;	PC7D = 0;		// C.7 Output OFF....
CLINEA 0000H 0001H 0DA1H 0002H 0021H
	rb	0f260h.7

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0DA3H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 212 2 3493
CLINEA 0000H 0001H 0DA5H 0001H 0001H
CBLOCKEND 212 1 3493
CFUNCTIONEND 212
...
;;void PortD_Low(void){
CLINEA 0000H 0001H 0DABH 0001H 0015H
CBLOCK 213 2 3499
...
CLINEA 0000H 0001H 0DB8H 0002H 0031H
	rb	0f269h.4

;;	PD5DIR = 0;		// PortD Bit5 set to Output Mode...
CLINEA 0000H 0001H 0DB9H 0002H 0031H
	rb	0f269h.5

;;	PD0C1= 1;		// PortD Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0DBCH 0002H 002FH
	sb	0f26bh.0

;;	PD0C0= 1;		
CLINEA 0000H 0001H 0DBDH 0002H 000CH
	sb	0f26ah.0

;;	PD1C1= 1;		// PortD Bit1 set to CMOS Output...
CLINEA 0000H 0001H 0DBEH 0002H 002FH
	sb	0f26bh.1

;;	PD1C0= 1;	
CLINEA 0000H 0001H 0DBFH 0002H 000BH
	sb	0f26ah.1

;;	PD2C1= 1;		// PortD Bit2 set to CMOS Output...
CLINEA 0000H 0001H 0DC0H 0002H 002FH
	sb	0f26bh.2

;;	PD2C0= 1;	
CLINEA 0000H 0001H 0DC1H 0002H 000BH
	sb	0f26ah.2

;;	PD3C1= 1;		// PortD Bit3 set to CMOS Output...
CLINEA 0000H 0001H 0DC2H 0002H 002FH
	sb	0f26bh.3

;;	PD3C0= 1;		
CLINEA 0000H 0001H 0DC3H 0002H 000CH
	sb	0f26ah.3

;;	PD4C1= 1;		// PortD Bit4 set to CMOS Output...
CLINEA 0000H 0001H 0DC4H 0002H 002FH
	sb	0f26bh.4

;;	PD4C0= 1;	
CLINEA 0000H 0001H 0DC5H 0002H 000BH
	sb	0f26ah.4

;;	PD5C1= 1;		// PortD Bit5 set to CMOS Output...
CLINEA 0000H 0001H 0DC6H 0002H 002FH
	sb	0f26bh.5

;;	PD5C0= 1;	
CLINEA 0000H 0001H 0DC7H 0002H 000BH
	sb	0f26ah.5

;;	PD0D = 0;		// D.0 Output OFF....
CLINEA 0000H 0001H 0DCAH 0002H 0021H
	rb	0f268h.0

;;	PD1D = 0;		// D.1 Output OFF....
CLINEA 0000H 0001H 0DCBH 0002H 0021H
	rb	0f268h.1

;;	PD2D = 0;		// D.2 Output OFF....
CLINEA 0000H 0001H 0DCCH 0002H 0021H
	rb	0f268h.2

;;	PD3D = 0;		// D.3 Output OFF....
CLINEA 0000H 0001H 0DCDH 0002H 0021H
	rb	0f268h.3

;;	PD4D = 0;		// D.4 Output OFF....
CLINEA 0000H 0001H 0DCEH 0002H 0021H
	rb	0f268h.4

;;	PD5D = 0;		// D.5 Output OFF....
CLINEA 0000H 0001H 0DCFH 0002H 0021H
	rb	0f268h.5

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0DD2H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 213 2 3540
CLINEA 0000H 0001H 0DD4H 0001H 0001H
CBLOCKEND 213 1 3540
CFUNCTIONEND 213
...
CLINEA 0000H 0001H 0DDAH 0001H 0020H
CBLOCK 214 2 3546

;;	PA0DIR = 1;		// PortA Bit0 set to Input Mode...
CLINEA 0000H 0001H 0DE4H 0002H 0030H
	sb	0f251h.0

;;	PA1DIR = 1;		// PortA Bit1 set to Input Mode...
CLINEA 0000H 0001H 0DE5H 0002H 0030H
	sb	0f251h.1

;;	PA2DIR = 1;		// PortA Bit2 set to Input Mode...
CLINEA 0000H 0001H 0DE6H 0002H 0030H
	sb	0f251h.2

;;	PA0C1  = 1;		// PortA Bit0 set to Input with Pull-Up Resistor...
CLINEA 0000H 0001H 0DEAH 0002H 0041H
	sb	0f253h.0

;;	PA0C0  = 0;		
CLINEA 0000H 0001H 0DEBH 0002H 000EH
	rb	0f252h.0

;;	PA1C1  = 1;		// PortA Bit1 set to Input with Pull-Up Resistor...
CLINEA 0000H 0001H 0DECH 0002H 0041H
	sb	0f253h.1

;;	PA1C0  = 0;	
CLINEA 0000H 0001H 0DEDH 0002H 000DH
	rb	0f252h.1

;;	PA2C1  = 1;		// PortA Bit2 set to Input with Pull-Up Resistor...
CLINEA 0000H 0001H 0DEEH 0002H 0041H
	sb	0f253h.2

;;	PA2C0  = 0;	
CLINEA 0000H 0001H 0DEFH 0002H 000DH
	rb	0f252h.2

;;	PA0MD1  = 0;	// PortA Bit0 set to General Purpose I/O...
CLINEA 0000H 0001H 0DF2H 0002H 0039H
	rb	0f255h.0

;;	PA0MD0  = 0;	
CLINEA 0000H 0001H 0DF3H 0002H 000EH
	rb	0f254h.0

;;	PA1MD1  = 0;	// PortA Bit1 set to General Purpose I/O...
CLINEA 0000H 0001H 0DF4H 0002H 0039H
	rb	0f255h.1

;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 0DF5H 0002H 000EH
	rb	0f254h.1

;;	PA2MD1  = 0;	// PortA Bit2 set to General Purpose I/O...
CLINEA 0000H 0001H 0DF6H 0002H 0039H
	rb	0f255h.2

;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 0DF7H 0002H 000EH
	rb	0f254h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0DF9H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 214 2 3579
CLINEA 0000H 0001H 0DFBH 0001H 0001H
CBLOCKEND 214 1 3579
CFUNCTIONEND 214
...
;;{
CLINEA 0000H 0001H 0E3AH 0001H 0001H
	push	lr
	push	xr4
	push	er8
	mov	r8,	r0
...
;;	tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 0E41H 0002H 0016H
	mov	r0,	#01h
	bl	_tm_init

;;	TempSec = sec;
CLINEA 0000H 0001H 0E42H 0002H 000FH
	mov	r2,	r8

;;	TimeFlag = 0;
CLINEA 0000H 0001H 0E43H 0002H 000EH
	mov	r4,	#00h
...
;;	if(sec == 1){
CLINEA 0000H 0001H 0E48H 0002H 000EH
	cmp	r8,	#01h
	bne	_$L625
CBLOCK 249 3 3656

;;		timerThres = 0x7FFF;
CLINEA 0000H 0001H 0E49H 0003H 0016H
	mov	r6,	#0ffh
	mov	r7,	#07fh

;;		TimeFlag = 0;
CLINEA 0000H 0001H 0E4AH 0003H 000FH
CBLOCKEND 249 3 3659

;;	}
CLINEA 0000H 0000H 0E4BH 0002H 0002H
_$L625 :

;;	if(sec == 2){
CLINEA 0000H 0001H 0E4CH 0002H 000EH
	cmp	r8,	#02h
	bne	_$L627
CBLOCK 249 4 3660

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0E4DH 0003H 0016H
	mov	er6,	#-1

;;		TimeFlag = 0;
CLINEA 0000H 0001H 0E4EH 0003H 000FH
	mov	r4,	#00h
CBLOCKEND 249 4 3663

;;	}
CLINEA 0000H 0000H 0E4FH 0002H 0002H
_$L627 :
...
;;	while(TempSec > 1){
CLINEA 0000H 0000H 0E51H 0001H 0001H
	bal	_$L647

;;	while(TempSec > 1){
CLINEA 0000H 0000H 0E51H 0002H 0014H
_$L633 :
CBLOCK 249 6 3665

;;		TempSec -= 2;
CLINEA 0000H 0001H 0E52H 0003H 000FH
	add	r2,	#0feh

;;		TimeFlag++;
CLINEA 0000H 0000H 0E53H 0003H 000DH
	add	r4,	#01h
CBLOCKEND 249 6 3668
...
;;	while(TempSec > 1){
CLINEA 0000H 0000H 0E51H 000EH 0013H
	cmp	r2,	#01h
	bgt	_$L633

;;	if(TempSec == 1){
CLINEA 0000H 0001H 0E55H 0002H 0012H
	cmp	r2,	#01h
	bne	_$L635
CBLOCK 249 7 3669

;;		timerThres = 0x7FFF;
CLINEA 0000H 0001H 0E56H 0003H 0016H
	mov	r6,	#0ffh
	mov	r7,	#07fh
CBLOCKEND 249 7 3671

;;	else{
CLINEA 0000H 0001H 0E58H 0002H 0006H
	bal	_$L637
_$L635 :
CBLOCK 249 8 3672

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0E59H 0003H 0016H
	mov	er6,	#-1

;;		TimeFlag--;
CLINEA 0000H 0000H 0E5AH 0003H 000DH
	add	r4,	#0ffh
CBLOCKEND 249 8 3675

;;	}
CLINEA 0000H 0000H 0E5BH 0002H 0002H
_$L637 :
CBLOCKEND 249 5 3676

;;	main_clrWDT();	
CLINEA 0000H 0001H 0E5FH 0002H 0010H
	bl	_main_clrWDT
...
CLINEA 0000H 0001H 0E63H 0002H 001BH
	bal	_$L640
_$L642 :
CBLOCK 249 9 3683
...
;;		timer = tm_getABCounter();
CLINEA 0000H 0000H 0E64H 0003H 001CH
CBLOCKEND 249 9 3686

;;	}
CLINEA 0000H 0000H 0E66H 0002H 0002H
_$L640 :

;;	while(timer < timerThres){
CLINEA 0000H 0000H 0E63H 000EH 0013H
	cmp	er0,	er6
	blt	_$L642

;;	if(TimeFlag !=0){
CLINEA 0000H 0001H 0E67H 0002H 0012H
	cmp	r4,	#00h
	beq	_$L645
...
;;		TimeFlag--;
CLINEA 0000H 0000H 0E69H 0003H 000DH
	add	r4,	#0ffh

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0E6AH 0003H 0016H
	mov	er6,	#-1

;;		goto TimerRestart;
CLINEA 0000H 0001H 0E6BH 0003H 0014H
	bal	_$L637

;;	}
CLINEA 0000H 0000H 0E6CH 0002H 0002H
_$L645 :
CBLOCKEND 249 2 3693
...
;;{
CLINEA 0000H 0001H 0E7AH 0001H 0001H
	push	lr
	push	xr4
	push	bp
	push	er8
...
;;TempSec = ms;
CLINEA 0000H 0001H 0E81H 0001H 000DH
	mov	er4,	er0

;;TimeFlag = 0;
CLINEA 0000H 0001H 0E82H 0001H 000DH
	mov	r6,	#00h

;;tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 0E84H 0001H 0015H
	mov	r0,	#01h
	bl	_tm_init
...
;;if(ms < 128){
CLINEA 0000H 0001H 0E88H 0001H 000DH
	mov	er0,	er8
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bge	_$L649
...
;;	timerThres = 0x1FF * ms;
CLINEA 0000H 0001H 0E89H 0002H 0019H
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
...
;;	TimeFlag = 0;
CLINEA 0000H 0001H 0E8AH 0002H 000EH
CBLOCKEND 250 3 3723

;;}
CLINEA 0000H 0000H 0E8BH 0001H 0001H
_$L649 :

;;if(ms == 128){
CLINEA 0000H 0001H 0E8CH 0001H 000EH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bne	_$L651
CBLOCK 250 4 3724
...
;;	timerThres = 0xFFFF;
CLINEA 0000H 0001H 0E8DH 0002H 0015H
	mov	bp,	#-1

;;	TimeFlag = 0;
CLINEA 0000H 0001H 0E8EH 0002H 000EH
	mov	r6,	#00h
CBLOCKEND 250 4 3727

;;}
CLINEA 0000H 0000H 0E8FH 0001H 0001H
_$L651 :

;;if(ms > 128){
CLINEA 0000H 0001H 0E90H 0001H 000DH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	ble	_$L661
CBLOCK 250 5 3728
...
;;	while(TempSec > 128){
CLINEA 0000H 0000H 0E91H 0001H 0001H
	bal	_$L671

;;	while(TempSec > 128){
CLINEA 0000H 0000H 0E91H 0002H 0016H
_$L657 :
CBLOCK 250 6 3729

;;		TempSec -= 128;
CLINEA 0000H 0001H 0E92H 0003H 0011H
	add	r0,	#080h
	addc	r1,	#0ffh
	mov	er4,	er0

;;		TimeFlag++;
CLINEA 0000H 0000H 0E93H 0003H 000DH
	add	r6,	#01h
CBLOCKEND 250 6 3732
...
;;	while(TempSec > 128){
CLINEA 0000H 0000H 0E91H 000EH 0013H
	mov	er0,	er4
	cmp	r4,	#080h
	cmpc	r5,	#00h
	bgt	_$L657
...
;;	if(TempSec != 0){
CLINEA 0000H 0001H 0E95H 0002H 0012H
	mov	er4,	er4
	beq	_$L659
CBLOCK 250 7 3733

;;		timerThres = 0x1FF * TempSec;
CLINEA 0000H 0001H 0E96H 0003H 001FH
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
	...
	subc	r1,	r5
	mov	bp,	er0
CBLOCKEND 250 7 3735

;;	else{
CLINEA 0000H 0001H 0E98H 0002H 0006H
	bal	_$L661
_$L659 :
CBLOCK 250 8 3736

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0E99H 0003H 0016H
	mov	bp,	#-1

;;		TimeFlag--;
CLINEA 0000H 0000H 0E9AH 0003H 000DH
	add	r6,	#0ffh
CBLOCKEND 250 8 3739

;;	}
CLINEA 0000H 0000H 0E9BH 0002H 0002H
_$L661 :
CBLOCKEND 250 5 3740

;;	main_clrWDT();	
CLINEA 0000H 0001H 0E9FH 0002H 0010H
	bl	_main_clrWDT
...
;;	while(timer < timerThres){
CLINEA 0000H 0001H 0EA3H 0002H 001BH
	bal	_$L664
_$L666 :
CBLOCK 250 9 3747
...
;;		timer = tm_getABCounter();
CLINEA 0000H 0000H 0EA4H 0003H 001CH
CBLOCKEND 250 9 3750

;;	}
CLINEA 0000H 0000H 0EA6H 0002H 0002H
_$L664 :

;;	while(timer < timerThres){
CLINEA 0000H 0000H 0EA3H 000EH 0013H
	cmp	er0,	bp
	blt	_$L666
...
;;		TimeFlag--;
CLINEA 0000H 0000H 0EA9H 0003H 000DH
	add	r6,	#0ffh

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0EAAH 0003H 0016H
	mov	bp,	#-1

;;		goto TimerRestart;
CLINEA 0000H 0001H 0EABH 0003H 0014H
	bal	_$L661

;;	}
CLINEA 0000H 0000H 0EACH 0002H 0002H
_$L669 :
CBLOCKEND 250 2 3758

;;}
CLINEA 0000H 0001H 0EAEH 0001H 0001H
	pop	er8
	pop	bp
	pop	xr4
	pop	pc
CBLOCKEND 250 1 3758
CFUNCTIONEND 250
...
;;{
CLINEA 0000H 0001H 0EB8H 0001H 0001H
CBLOCK 251 2 3768

;;	timer_us = 0;
CLINEA 0000H 0001H 0EB9H 0002H 000EH
	mov	er0,	#0 
	st	er0,	NEAR _timer_us

;;	TM8C = 0x00;
CLINEA 0000H 0001H 0EBAH 0002H 000DH
	st	r0,	0f8e1h

;;	ETM8 = 1;
CLINEA 0000H 0001H 0EBBH 0002H 000AH
	sb	0f013h.2

;;	while(timer_us == 0);
CLINEA 0000H 0000H 0EBCH 0002H 0016H
_$L675 :

;;	while(timer_us == 0);
CLINEA 0000H 0000H 0EBCH 000EH 0013H
	l	er0,	NEAR _timer_us
	beq	_$L675
CBLOCKEND 251 2 3773

;;}
CLINEA 0000H 0001H 0EBDH 0001H 0001H
	rt
CBLOCKEND 251 1 3773
CFUNCTIONEND 251
...
CBLOCKEND 252 2 3782

;;}
CLINEA 0000H 0001H 0EC6H 0001H 0001H
	rt
CBLOCKEND 252 1 3782
CFUNCTIONEND 252
...
;;{
CLINEA 0000H 0001H 0EC9H 0001H 0001H
	push	lr
	push	fp
	mov	fp,	sp
	add	sp,	#-028
...
;;	float YoverX = y/x;
CLINEA 0000H 0001H 0ECAH 0002H 0014H
	push	xr0
	l	er0,	4[fp]
	l	er2,	6[fp]
	push	xr0
...
;;	float result = 0;
CLINEA 0000H 0001H 0ECBH 0002H 0012H
	mov	er4,	#0 
	mov	er6,	#0 

;;	if(x>0){
CLINEA 0000H 0001H 0ECDH 0002H 0009H
	l	er0,	4[fp]
	l	er2,	6[fp]
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0000H 0ECEH 0003H 0034H
	l	er0,	-28[fp]
	l	er2,	-26[fp]
	push	xr0
	add	sp,	#-4
	...
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 253 3 3791

;;	}
CLINEA 0000H 0000H 0ECFH 0002H 0002H
_$L683 :

;;	if((x<0)&&(y>=0)){
CLINEA 0000H 0001H 0ED0H 0002H 0013H
	l	er0,	4[fp]
	l	er2,	6[fp]
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0000H 0ED1H 0003H 0039H
	l	er0,	-28[fp]
	l	er2,	-26[fp]
	push	xr0
	add	sp,	#-4
	...
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 253 4 3794

;;	}	
CLINEA 0000H 0000H 0ED2H 0002H 0003H
_$L685 :

;;	if((y<0)&&(x<0)){
CLINEA 0000H 0001H 0ED3H 0002H 0012H
	push	xr8
	mov	er0,	#0 
	mov	er2,	#0 
	push	xr0
...
;;		result = (0.97239*YoverX)-(0.19195*pow(YoverX,3))-3.14;
CLINEA 0000H 0000H 0ED4H 0003H 0039H
	l	er0,	-28[fp]
	l	er2,	-26[fp]
	push	xr0
	add	sp,	#-4
	...
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 253 5 3797

;;	}
CLINEA 0000H 0000H 0ED5H 0002H 0002H
_$L692 :

;;	if((y>0)&&(x==0)){
CLINEA 0000H 0001H 0ED6H 0002H 0013H
	push	xr8
	mov	er0,	#0 
	mov	er2,	#0 
	push	xr0
...
;;		result = 1.57;
CLINEA 0000H 0001H 0ED7H 0003H 0010H
	mov	r0,	#0c3h
	mov	r1,	#0f5h
	mov	r2,	#0c8h
	mov	r3,	#03fh
...
;;	if((y<0)&&(x==0)){
CLINEA 0000H 0001H 0ED9H 0002H 0013H
	push	xr8
	mov	er0,	#0 
	mov	er2,	#0 
	push	xr0
...
;;		result = -1.57;
CLINEA 0000H 0001H 0EDAH 0003H 0011H
	mov	r0,	#0c3h
	mov	r1,	#0f5h
	mov	r2,	#0c8h
	mov	r3,	#0bfh
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 253 7 3803

;;	}
CLINEA 0000H 0000H 0EDBH 0002H 0002H
_$L706 :

;;	if((x==0)&&(y==0)){			//we made this up....
CLINEA 0000H 0001H 0EDCH 0002H 002CH
	l	er0,	4[fp]
	l	er2,	6[fp]
	push	xr0
	mov	er0,	#0 
...
;;		result = (0.97239*YoverX)-(0.19195*pow(YoverX,3));
CLINEA 0000H 0000H 0EE0H 0003H 0034H
	mov	er0,	#0 
	mov	er2,	#0 
	mov	er4,	#0 
	mov	r6,	#08h
	...
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 253 8 3809

;;	}
CLINEA 0000H 0000H 0EE1H 0002H 0002H
_$L713 :

;;	result *= 57.29;
CLINEA 0000H 0001H 0EE2H 0002H 0011H
	push	xr4
	add	sp,	#-4
	bl	__ftodu8sw
	mov	r0,	#085h
...
;;	if(result > 45){
CLINEA 0000H 0001H 0EE4H 0002H 0011H
	push	xr0
	mov	er0,	#0 
	mov	r2,	#034h
	mov	r3,	#042h
...
;;		result = 45;
CLINEA 0000H 0001H 0EE5H 0003H 000EH
	mov	r2,	#034h
	mov	r3,	#042h
	mov	er4,	#0 
	mov	er6,	er2
CBLOCKEND 253 9 3814

;;	}
CLINEA 0000H 0000H 0EE6H 0002H 0002H
_$L720 :
...
;;		result = -45;
CLINEA 0000H 0001H 0EE8H 0003H 000FH
	mov	r2,	#034h
	mov	r3,	#0c2h
	mov	er4,	#0 
	mov	er6,	er2
CBLOCKEND 253 10 3817

;;	}
CLINEA 0000H 0000H 0EE9H 0002H 0002H
_$L722 :

;;	return(result);
CLINEA 0000H 0001H 0EEBH 0002H 0010H
	mov	er0,	er4
	mov	er2,	er6
CBLOCKEND 253 2 3820

;;}
CLINEA 0000H 0000H 0EECH 0001H 0001H
	pop	xr4
	pop	xr8
	mov	sp,	fp
	pop	fp
	pop	pc
CBLOCKEND 253 1 3820
CFUNCTIONEND 253
