...
CFILE 0000H 00000FE5H "main\\main.c"
...
;;		if( Accel_PID_XRollError<0)
CLINEA 0000H 0001H 0A8CH 0003H 001DH
	l	er0,	NEAR _Accel_PID_XRollError
	l	er2,	NEAR _Accel_PID_XRollError+02h
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0001H 0A8EH 0004H 0020H
	l	er0,	NEAR _Accel_PID_XRollErrPrev
	l	er2,	NEAR _Accel_PID_XRollErrPrev+02h
	push	xr0
	mov	er0,	#0 
...
;;				Accel_PID_XRollErrSum = 0;
CLINEA 0000H 0001H 0A90H 0005H 001EH
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_XRollErrSum
	st	er0,	NEAR _Accel_PID_XRollErrSum+02h
CBLOCKEND 240 4 2705

;;			}
CLINEA 0000H 0000H 0A91H 0004H 0004H
_$L524 :
CBLOCKEND 240 3 2706

;;		if( Accel_PID_XRollError>=0)
CLINEA 0000H 0001H 0A94H 0003H 001EH
	l	er0,	NEAR _Accel_PID_XRollError
	l	er2,	NEAR _Accel_PID_XRollError+02h
	push	xr0
	mov	er0,	#0 
...
;;			if(Accel_PID_XRollErrPrev<0)
CLINEA 0000H 0001H 0A96H 0004H 001FH
	l	er0,	NEAR _Accel_PID_XRollErrPrev
	l	er2,	NEAR _Accel_PID_XRollErrPrev+02h
	push	xr0
	mov	er0,	#0 
...
;;				Accel_PID_XRollErrSum = 0;
CLINEA 0000H 0001H 0A98H 0005H 001EH
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_XRollErrSum
	st	er0,	NEAR _Accel_PID_XRollErrSum+02h
...
;;			}
CLINEA 0000H 0000H 0A99H 0004H 0004H
_$L528 :
CBLOCKEND 240 5 2714

;;		Accel_PID_XRollErrPrev = Accel_PID_XRollError;
CLINEA 0000H 0001H 0A9CH 0003H 0030H
	l	er0,	NEAR _Accel_PID_XRollError
	l	er2,	NEAR _Accel_PID_XRollError+02h
	st	er0,	NEAR _Accel_PID_XRollErrPrev
	st	er2,	NEAR _Accel_PID_XRollErrPrev+02h
...
CLINEA 0000H 0001H 0AA9H 0003H 0033H
	l	er0,	NEAR _Accel_PID_XRoll_kd
	l	er2,	NEAR _Accel_PID_XRoll_kd+02h
	push	xr0
...
CLINEA 0000H 0001H 0AABH 0003H 0021H
	l	er0,	NEAR _Accel_PID_XRollError
	l	er2,	NEAR _Accel_PID_XRollError+02h
	push	xr0
	l	er0,	NEAR _Accel_PID_XRoll_kp
...
CLINEA 0000H 0001H 0AAFH 0003H 0056H
...
;;		Accel_PID_YPitchCounter_D = 0;
CLINEA 0000H 0001H 0AB0H 0003H 0020H
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_YPitchCounter_D

;;		Accel_PID_YPitchdErr /= Accel_PID_YPitchCurrentCount;
CLINEA 0000H 0001H 0AB5H 0003H 0037H
	l	er0,	NEAR _Accel_PID_YPitchError
	l	er2,	NEAR _Accel_PID_YPitchError+02h
	push	xr0
...
;;		if( Accel_PID_YPitchError<0)
CLINEA 0000H 0001H 0AB7H 0003H 001EH
	l	er0,	NEAR _Accel_PID_YPitchError
	l	er2,	NEAR _Accel_PID_YPitchError+02h
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0001H 0AB9H 0004H 0022H
	l	er0,	NEAR _Accel_PID_YPitchErrPrev
	l	er2,	NEAR _Accel_PID_YPitchErrPrev+02h
	push	xr0
	mov	er0,	#0 
...
;;				Accel_PID_YPitchErrSum = 0;
CLINEA 0000H 0001H 0ABBH 0005H 001FH
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_YPitchErrSum
	st	er0,	NEAR _Accel_PID_YPitchErrSum+02h
CBLOCKEND 240 8 2748

;;			}
CLINEA 0000H 0000H 0ABCH 0004H 0004H
_$L532 :
CBLOCKEND 240 7 2749

;;		if( Accel_PID_YPitchError>=0)
CLINEA 0000H 0001H 0ABEH 0003H 001FH
	l	er0,	NEAR _Accel_PID_YPitchError
	l	er2,	NEAR _Accel_PID_YPitchError+02h
	push	xr0
	mov	er0,	#0 
...
;;			if(Accel_PID_YPitchErrPrev<0)
CLINEA 0000H 0001H 0AC0H 0004H 0020H
	l	er0,	NEAR _Accel_PID_YPitchErrPrev
	l	er2,	NEAR _Accel_PID_YPitchErrPrev+02h
	push	xr0
	mov	er0,	#0 
...
;;				Accel_PID_YPitchErrSum = 0;
CLINEA 0000H 0001H 0AC2H 0005H 001FH
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_YPitchErrSum
	st	er0,	NEAR _Accel_PID_YPitchErrSum+02h
CBLOCKEND 240 10 2755

;;			}
CLINEA 0000H 0000H 0AC3H 0004H 0004H
_$L536 :
CBLOCKEND 240 9 2756

;;		Accel_PID_YPitchErrPrev = Accel_PID_YPitchError;
CLINEA 0000H 0001H 0AC6H 0003H 0032H
	l	er0,	NEAR _Accel_PID_YPitchError
	l	er2,	NEAR _Accel_PID_YPitchError+02h
	st	er0,	NEAR _Accel_PID_YPitchErrPrev
	st	er2,	NEAR _Accel_PID_YPitchErrPrev+02h
...
CLINEA 0000H 0001H 0AD1H 0003H 00A3H
	push	xr0
	l	er0,	NEAR _Accel_PID_YPitch_kp
	l	er2,	NEAR _Accel_PID_YPitch_kp+02h
	push	xr0
...
;;		if(PrePIDCount >= 10){
CLINEA 0000H 0001H 0AD3H 0003H 0018H
	l	r0,	NEAR _PrePIDCount
	cmp	r0,	#0ah
	bge	_$M42
	b	_$L545
...
;;			if(Accel_PID_XRollError > 0){
CLINEA 0000H 0001H 0AD4H 0004H 0020H
	l	er0,	NEAR _Accel_PID_XRollError
	l	er2,	NEAR _Accel_PID_XRollError+02h
	push	xr0
	mov	er0,	#0 
...
;;				PDRUN = 0;
CLINEA 0000H 0001H 0AD7H 0005H 000EH
	rb	0f927h.0

;;				PWED = PWMIdleDutyRun + Accel_PID_XRollOutput + PWMtoRPMOffset_Mot2;	
CLINEA 0000H 0001H 0ADAH 0005H 0049H
	l	er0,	NEAR _PWMIdleDutyRun
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;				PWDD = PWMIdleDutyRun;
CLINEA 0000H 0001H 0ADDH 0005H 001AH
	l	er0,	NEAR _PWMIdleDutyRun
	st	er0,	0f922h
...
;;				PDRUN = 1;
CLINEA 0000H 0001H 0AE1H 0005H 000EH
CBLOCKEND 240 12 2787

;;			else{
CLINEA 0000H 0001H 0AE4H 0004H 0008H
	bal	_$L542
_$L540 :
CBLOCK 240 13 2788
...
;;				PWED = PWMIdleDutyRun;	
CLINEA 0000H 0001H 0AEAH 0005H 001BH
	l	er0,	NEAR _PWMIdleDutyRun
	st	er0,	0f932h

;;				PWDD = PWMIdleDutyRun - Accel_PID_XRollOutput + PWMtoRPMOffset_Mot4;
CLINEA 0000H 0001H 0AECH 0005H 0048H
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	l	er0,	NEAR _$ST9
...
;;				CheckSafetyLimit();
CLINEA 0000H 0001H 0AEDH 0005H 0017H
	bl	_CheckSafetyLimit

;;				PDRUN = 1;
CLINEA 0000H 0001H 0AF0H 0005H 000EH
CBLOCKEND 240 13 2802

;;			}
CLINEA 0000H 0000H 0AF2H 0004H 0004H
_$L542 :
	sb	0f937h.0
	sb	0f927h.0

;;			if(Accel_PID_YPitchError > 0){
CLINEA 0000H 0001H 0AF3H 0004H 0021H
	l	er0,	NEAR _Accel_PID_YPitchError
	l	er2,	NEAR _Accel_PID_YPitchError+02h
	push	xr0
	mov	er0,	#0 
...
;;				PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0AF4H 0005H 001DH
	rb	0f973h.0

;;				PCRUN = 0;
CLINEA 0000H 0001H 0AF7H 0005H 000EH
	rb	0f917h.0

;;				PWF0D = PWMIdleDutyRun + Accel_PID_YPitchOutput; 		//Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0AF8H 0005H 0068H
	l	er0,	NEAR _PWMIdleDutyRun
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;				PWCD = PWMIdleDutyRun;	
CLINEA 0000H 0001H 0AFAH 0005H 001BH
	l	er0,	NEAR _PWMIdleDutyRun
	st	er0,	0f912h

;;				CheckSafetyLimit();
CLINEA 0000H 0001H 0AFCH 0005H 0017H
	bl	_CheckSafetyLimit

;;				PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0AFDH 0005H 001CH
	sb	0f973h.0

;;				PCRUN = 1;
CLINEA 0000H 0001H 0B00H 0005H 000EH
	sb	0f917h.0
CBLOCKEND 240 14 2817

;;			else{
CLINEA 0000H 0001H 0B02H 0004H 0008H
	bal	_$L545
_$L543 :
CBLOCK 240 15 2818

;;				PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0B03H 0005H 001DH
	rb	0f973h.0

;;				PCRUN = 0;
CLINEA 0000H 0001H 0B06H 0005H 000EH
	rb	0f917h.0

;;				PWF0D = PWMIdleDutyRun; 		//Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0B07H 0005H 004FH
	l	er0,	NEAR _PWMIdleDutyRun
	st	er0,	0f962h

;;				PWCD = PWMIdleDutyRun - Accel_PID_YPitchOutput + PWMtoRPMOffset_Mot3;	
CLINEA 0000H 0001H 0B09H 0005H 004AH
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
	l	er0,	NEAR _$ST11
...
;;				CheckSafetyLimit();
CLINEA 0000H 0001H 0B0BH 0005H 0017H
	bl	_CheckSafetyLimit

;;				PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0B0CH 0005H 001CH
	sb	0f973h.0

;;				PCRUN = 1;
CLINEA 0000H 0001H 0B0FH 0005H 000EH
	sb	0f917h.0
CBLOCKEND 240 15 2832

;;			}
CLINEA 0000H 0000H 0B10H 0004H 0004H
_$L545 :
CBLOCKEND 240 11 2833
CBLOCKEND 240 2 2863

;;}
CLINEA 0000H 0001H 0B2FH 0001H 0001H
	pop	xr4
	pop	xr8
	pop	pc
CBLOCKEND 240 1 2863
CFUNCTIONEND 240
...
CLINEA 0000H 0001H 0B30H 0001H 0021H
	push	lr
	push	xr8
	push	xr4
CBLOCK 241 2 2864
...
CLINEA 0000H 0001H 0B35H 0002H 0030H
	l	er0,	NEAR _Range_out
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0B38H 0002H 0071H
...
CLINEA 0000H 0001H 0B40H 0002H 0028H
	push	xr0
...
CLINEA 0000H 0001H 0B41H 0002H 0023H
...
CLINEA 0000H 0001H 0B44H 0002H 0071H
	push	xr0
...
;;	PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0B48H 0002H 001AH
	rb	0f973h.0

;;	PERUN = 0;
CLINEA 0000H 0001H 0B49H 0002H 000BH
	rb	0f937h.0

;;	PDRUN = 0;
CLINEA 0000H 0001H 0B4AH 0002H 000BH
	rb	0f927h.0

;;	PCRUN = 0;
CLINEA 0000H 0001H 0B4BH 0002H 000BH
	rb	0f917h.0

;;	PWF0D += Range_PIDOutput; 		//Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0B4CH 0002H 004EH
	l	er0,	0f962h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0B4DH 0002H 001AH
	l	er0,	0f932h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0B4EH 0002H 001AH
	l	er0,	0f922h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
CLINEA 0000H 0001H 0B4FH 0002H 0019H
	l	er0,	0f912h
	mov	er2,	#0 
	push	xr0
	bl	__fuldu8sw
...
;;	CheckSafetyLimit();
CLINEA 0000H 0001H 0B50H 0002H 0014H
	bl	_CheckSafetyLimit

;;	PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0B51H 0002H 0019H
	sb	0f973h.0

;;	PERUN = 1;
CLINEA 0000H 0001H 0B52H 0002H 000BH
	sb	0f937h.0

;;	PDRUN = 1;
CLINEA 0000H 0001H 0B53H 0002H 000BH
	sb	0f927h.0

;;	PCRUN = 1;
CLINEA 0000H 0001H 0B54H 0002H 000BH
	sb	0f917h.0

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0001H 0B56H 0002H 0017H
	mov	er0,	#0 
_$L549 :
CBLOCK 241 3 2903

;;		SensorReturn[i] = 0x20;
CLINEA 0000H 0001H 0B58H 0003H 0019H
	mov	r2,	#020h
	st	r2,	NEAR _SensorReturn[er0]
CBLOCKEND 241 3 2905

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0B56H 0002H 0017H
	add	er0,	#1 

;;	for(i = 0; i<150; i++)
CLINEA 0000H 0000H 0B56H 000EH 0013H
	cmp	r0,	#096h
	cmpc	r1,	#00h
	blts	_$L549

;;	sprintf(SensorReturn, "%f,%f,%f", Range_out, Range_PIDCurrentCount,Range_PIDOutput);
CLINEA 0000H 0001H 0B5CH 0002H 0055H
	l	er0,	NEAR _Range_PIDOutput
	l	er2,	NEAR _Range_PIDOutput+02h
	push	xr0
	add	sp,	#-4
...
;;	SensorReturn[148] = 0x0D;
CLINEA 0000H 0001H 0B5EH 0002H 001AH
	mov	r0,	#0dh
	st	r0,	NEAR _SensorReturn+094h

;;	SensorReturn[149] = 0x0A;
CLINEA 0000H 0001H 0B5FH 0002H 001AH
	mov	r0,	#0ah
	st	r0,	NEAR _SensorReturn+095h

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 0B62H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 0B63H 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(SensorReturn, 150, _funcUartFin);
CLINEA 0000H 0001H 0B64H 0002H 0031H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	r2,	#096h
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0B65H 0001H 0001H
	bal	_$L557

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0B65H 0002H 0019H
_$L555 :
CBLOCK 241 4 2917

;;		main_clrWDT();
CLINEA 0000H 0001H 0B66H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 241 4 2919
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 0B65H 000EH 0013H
	l	r0,	NEAR __flgUartFin
	cmp	r0,	#01h
	bne	_$L555
CBLOCKEND 241 2 2921

;;}
CLINEA 0000H 0001H 0B69H 0001H 0001H
	pop	xr4
	pop	xr8
	pop	pc
CBLOCKEND 241 1 2921
CFUNCTIONEND 241
...
CLINEA 0000H 0001H 0B6BH 0001H 001DH
CBLOCK 242 2 2923

;;	if(PWED > PWMUpperDutyLimitRun){
CLINEA 0000H 0001H 0B6DH 0002H 0021H
	l	er0,	0f932h
...
CLINEA 0000H 0001H 0B6EH 0003H 001EH
	st	er2,	0f932h
CBLOCKEND 242 3 2927
...
CLINEA 0000H 0001H 0B70H 0002H 0021H
	l	er0,	0f932h
	l	er2,	NEAR _PWMLowerDutyLimitRun
	cmp	er0,	er2
	bge	_$L561
...
CLINEA 0000H 0001H 0B71H 0003H 001EH
	st	er2,	0f932h
CBLOCKEND 242 4 2930
...
CLINEA 0000H 0001H 0B73H 0002H 0022H
	l	er0,	0f962h
	l	er2,	NEAR _PWMUpperDutyLimitRun
	cmp	er0,	er2
	ble	_$L563
...
CLINEA 0000H 0001H 0B74H 0003H 001FH
	st	er2,	0f962h
CBLOCKEND 242 5 2933
...
CLINEA 0000H 0001H 0B76H 0002H 0022H
	l	er0,	0f962h
	l	er2,	NEAR _PWMLowerDutyLimitRun
	cmp	er0,	er2
	bge	_$L565
...
CLINEA 0000H 0001H 0B77H 0003H 001FH
	st	er2,	0f962h
CBLOCKEND 242 6 2936
...
CLINEA 0000H 0001H 0B79H 0002H 0021H
	l	er0,	0f922h
	l	er2,	NEAR _PWMUpperDutyLimitRun
	cmp	er0,	er2
	ble	_$L567
...
CLINEA 0000H 0001H 0B7CH 0002H 0021H
	l	er0,	0f922h
	l	er2,	NEAR _PWMLowerDutyLimitRun
	cmp	er0,	er2
	bge	_$L569
...
CLINEA 0000H 0001H 0B7DH 0003H 001EH
	st	er2,	0f922h
CBLOCKEND 242 8 2942
...
CLINEA 0000H 0001H 0B7FH 0002H 0021H
	l	er0,	0f912h
	l	er2,	NEAR _PWMUpperDutyLimitRun
	cmp	er0,	er2
	ble	_$L571
...
CLINEA 0000H 0001H 0B80H 0003H 001EH
	st	er2,	0f912h
CBLOCKEND 242 9 2945

;;	}
CLINEA 0000H 0000H 0B81H 0002H 0002H
_$L571 :

;;	if(PWCD < PWMLowerDutyLimitRun){
CLINEA 0000H 0001H 0B82H 0002H 0021H
	l	er0,	0f912h
	l	er2,	NEAR _PWMLowerDutyLimitRun
	cmp	er0,	er2
	bge	_$L573
...
CLINEA 0000H 0001H 0B83H 0003H 001EH
	st	er2,	0f912h
CBLOCKEND 242 10 2948

;;	}
CLINEA 0000H 0000H 0B84H 0002H 0002H
_$L573 :
CBLOCKEND 242 2 2949

;;}
CLINEA 0000H 0001H 0B85H 0001H 0001H
	rt
CBLOCKEND 242 1 2949
CFUNCTIONEND 242
...
CLINEA 0000H 0001H 0B87H 0001H 0025H
CBLOCK 243 2 2951

;;	if(Accel_PID_Motor1 > (49151)){
CLINEA 0000H 0001H 0B89H 0002H 0020H
...
CLINEA 0000H 0001H 0B8AH 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#0bfh
	st	er0,	NEAR _Accel_PID_Motor1
CBLOCKEND 243 3 2955
...
CLINEA 0000H 0001H 0B8CH 0002H 001EH
	l	er0,	NEAR _Accel_PID_Motor1
	cmp	r0,	#0ffh
	cmpc	r1,	#03fh
	bge	_$L578
...
CLINEA 0000H 0001H 0B8DH 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor1
CBLOCKEND 243 4 2958
...
CLINEA 0000H 0001H 0B8FH 0002H 0020H
...
CLINEA 0000H 0001H 0B90H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#0bfh
	st	er0,	NEAR _Accel_PID_Motor2
CBLOCKEND 243 5 2961
...
CLINEA 0000H 0001H 0B92H 0002H 0020H
	l	er0,	NEAR _Accel_PID_Motor2
	cmp	r0,	#0ffh
	cmpc	r1,	#03fh
	bge	_$L582
...
CLINEA 0000H 0001H 0B93H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor2
CBLOCKEND 243 6 2964
...
CLINEA 0000H 0001H 0B95H 0002H 0020H
...
CLINEA 0000H 0001H 0B96H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#0bfh
	st	er0,	NEAR _Accel_PID_Motor3
CBLOCKEND 243 7 2967
...
CLINEA 0000H 0001H 0B98H 0002H 0020H
	l	er0,	NEAR _Accel_PID_Motor3
	cmp	r0,	#0ffh
	cmpc	r1,	#03fh
	bge	_$L586
...
CLINEA 0000H 0001H 0B99H 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor3
CBLOCKEND 243 8 2970
...
CLINEA 0000H 0001H 0B9BH 0002H 0020H
...
CLINEA 0000H 0001H 0B9CH 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#0bfh
	st	er0,	NEAR _Accel_PID_Motor4
CBLOCKEND 243 9 2973
...
CLINEA 0000H 0001H 0B9EH 0002H 0020H
	l	er0,	NEAR _Accel_PID_Motor4
	cmp	r0,	#0ffh
	cmpc	r1,	#03fh
	bge	_$L590
...
CLINEA 0000H 0001H 0B9FH 0003H 001BH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor4
CBLOCKEND 243 10 2976

;;	}
CLINEA 0000H 0000H 0BA0H 0002H 0002H
_$L590 :
CBLOCKEND 243 2 2977

;;}
CLINEA 0000H 0001H 0BA1H 0001H 0001H
	rt
CBLOCKEND 243 1 2977
CFUNCTIONEND 243
...
;;void Shutdown(void){
CLINEA 0000H 0001H 0BA3H 0001H 0014H
	push	lr
CBLOCK 244 2 2979
CRET 0000H

;;	if((PWED > PWMSafeDuty)||(PWF0D > PWMSafeDuty)||(PWDD > PWMSafeDuty)||(PWCD > PWMSafeDuty)){
CLINEA 0000H 0001H 0BA4H 0002H 005DH
	l	er0,	0f932h
	l	er2,	NEAR _PWMSafeDuty
	cmp	er0,	er2
	bgt	_$L594
...
;;			main_clrWDT();					
CLINEA 0000H 0001H 0BA6H 0004H 0016H
	bl	_main_clrWDT

;;			PFRUN = 0;	//Turn OFF PWM
CLINEA 0000H 0001H 0BA7H 0004H 001CH
	rb	0f973h.0

;;			PERUN = 0;
CLINEA 0000H 0001H 0BA8H 0004H 000DH
	rb	0f937h.0

;;			PDRUN = 0;
CLINEA 0000H 0001H 0BA9H 0004H 000DH
	rb	0f927h.0

;;			PCRUN = 0;
CLINEA 0000H 0001H 0BAAH 0004H 000DH
	rb	0f917h.0

;;			PWF0D -= 10; //Can't be running to change (Only this variable)
CLINEA 0000H 0001H 0BABH 0004H 0041H
	l	er0,	0f962h
	add	er0,	#-10
	st	er0,	0f962h

;;			PWED -= 10;
CLINEA 0000H 0001H 0BACH 0004H 000EH
	l	er0,	0f932h
	add	er0,	#-10
	st	er0,	0f932h

;;			PWDD -= 10;
CLINEA 0000H 0001H 0BADH 0004H 000EH
	l	er0,	0f922h
	add	er0,	#-10
	st	er0,	0f922h

;;			PWCD -= 10;
CLINEA 0000H 0001H 0BAEH 0004H 000EH
	l	er0,	0f912h
	add	er0,	#-10
	st	er0,	0f912h

;;			PFRUN = 1;	//Turn ON PWM
CLINEA 0000H 0001H 0BAFH 0004H 001BH
	sb	0f973h.0

;;			PERUN = 1;
CLINEA 0000H 0001H 0BB0H 0004H 000DH
	sb	0f937h.0

;;			PDRUN = 1;
CLINEA 0000H 0001H 0BB1H 0004H 000DH
	sb	0f927h.0

;;			PCRUN = 1;
CLINEA 0000H 0001H 0BB2H 0004H 000DH
	sb	0f917h.0

;;			NOPms(100);
CLINEA 0000H 0001H 0BB3H 0004H 000EH
	mov	r0,	#064h
	mov	r1,	#00h
	bl	_NOPms

;;			if(PWED <= PWMSafeDuty){
CLINEA 0000H 0001H 0BB5H 0004H 001BH
	l	er0,	0f932h
	l	er2,	NEAR _PWMSafeDuty
	cmp	er0,	er2
	bgt	_$L610
...
;;				PWED = PWMSafeDuty;
CLINEA 0000H 0001H 0BB6H 0005H 0017H
	st	er2,	0f932h
CBLOCKEND 244 5 2999
...
CLINEA 0000H 0001H 0BB8H 0004H 001CH
	l	er0,	0f962h
	cmp	er0,	er2
	bgt	_$L612
CBLOCK 244 6 3000
...
;;				PWF0D = PWMSafeDuty;
CLINEA 0000H 0001H 0BB9H 0005H 0018H
	st	er2,	0f962h
CBLOCKEND 244 6 3002

;;			}
CLINEA 0000H 0000H 0BBAH 0004H 0004H
_$L612 :

;;			if(PWDD <= PWMSafeDuty){
CLINEA 0000H 0001H 0BBBH 0004H 001BH
	l	er0,	0f922h
	cmp	er0,	er2
	bgt	_$L614
CBLOCK 244 7 3003
...
;;				PWDD = PWMSafeDuty;
CLINEA 0000H 0001H 0BBCH 0005H 0017H
	st	er2,	0f922h
CBLOCKEND 244 7 3005

;;			}
CLINEA 0000H 0000H 0BBDH 0004H 0004H
_$L614 :

;;			if(PWCD <= PWMSafeDuty){
CLINEA 0000H 0001H 0BBEH 0004H 001BH
	l	er0,	0f912h
	cmp	er0,	er2
	bgt	_$L616
CBLOCK 244 8 3006
...
;;				PWCD = PWMSafeDuty;
CLINEA 0000H 0001H 0BBFH 0005H 0017H
	st	er2,	0f912h
CBLOCKEND 244 8 3008

;;			}
CLINEA 0000H 0000H 0BC0H 0004H 0004H
_$L616 :
CBLOCKEND 244 4 3010

;;		}while((PWED > PWMSafeDuty)||(PWF0D > PWMSafeDuty)||(PWDD > PWMSafeDuty)||(PWCD > PWMSafeDuty));
CLINEA 0000H 0000H 0BC2H 0003H 0062H
	l	er0,	0f932h
	cmp	er0,	er2
	ble	_$M48
	b	_$L594
...
_$M51 :
_$L607 :
CBLOCKEND 244 3 3011

;;	Accel_PID_Motor1 = 16383;
CLINEA 0000H 0001H 0BC4H 0002H 001AH
	mov	r0,	#0ffh
	mov	r1,	#03fh
	st	er0,	NEAR _Accel_PID_Motor1

;;	Accel_PID_Motor2 = 16383;
CLINEA 0000H 0001H 0BC5H 0002H 001AH
	st	er0,	NEAR _Accel_PID_Motor2

;;	Accel_PID_Motor3 = 16383;
CLINEA 0000H 0001H 0BC6H 0002H 001AH
	st	er0,	NEAR _Accel_PID_Motor3

;;	Accel_PID_Motor4 = 16383;
CLINEA 0000H 0001H 0BC7H 0002H 001AH
	st	er0,	NEAR _Accel_PID_Motor4
CBLOCKEND 244 2 3017

;;}
CLINEA 0000H 0001H 0BC9H 0001H 0001H
	pop	pc
CBLOCKEND 244 1 3017
CFUNCTIONEND 244
...
;;void ESC1_PWM(void){
CLINEA 0000H 0001H 0BCDH 0001H 0014H
CBLOCK 215 2 3021

;;      PC0DIR = 0;       // PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0BDCH 0007H 003BH
	rb	0f261h.0

;;      PC0C1  = 1;       // PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0BDFH 0007H 003BH
	sb	0f263h.0

;;      PC0C0  = 1;       
CLINEA 0000H 0001H 0BE0H 0007H 0018H
	sb	0f262h.0

;;      PC0MD1  = 1;            // PortC Bit0 set to PWM Output (1,0)...
CLINEA 0000H 0001H 0BE3H 0007H 0046H
	sb	0f265h.0

;;      PC0MD0  = 0;      
CLINEA 0000H 0001H 0BE4H 0007H 0018H
	rb	0f264h.0

;;      PFCS1 = 0;        //00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 0BE8H 0007H 002FH
	rb	0f972h.1

;;      PFCS0 = 1;
CLINEA 0000H 0001H 0BE9H 0007H 0010H
	sb	0f972h.0

;;      PWFP = PWMPeriod;            // Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0BECH 0007H 0092H
	l	er0,	NEAR _PWMPeriod
	st	er0,	0f960h

;;      PWF0D =    PWMSafeDuty;           //12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 0BF6H 0007H 004CH
	l	er0,	NEAR _PWMSafeDuty
	st	er0,	0f962h

;;      PFRUN = 0;        // OFF to start
CLINEA 0000H 0001H 0BF8H 0007H 0027H
	rb	0f973h.0
CBLOCKEND 215 2 3065

;;}
CLINEA 0000H 0001H 0BF9H 0001H 0001H
	rt
CBLOCKEND 215 1 3065
CFUNCTIONEND 215
...
;;void ESC2_PWM(void){
CLINEA 0000H 0001H 0BFEH 0001H 0014H
CBLOCK 216 2 3070

;;      PB2DIR = 0;       // PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0C0DH 0007H 003BH
	rb	0f259h.2

;;      PB2C1  = 1;       // PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0C10H 0007H 003BH
	sb	0f25bh.2

;;      PB2C0  = 1;       
CLINEA 0000H 0001H 0C11H 0007H 0018H
	sb	0f25ah.2

;;      PB2MD1  = 0;            // PortB Bit0 set to PWM Output (0,1)...
CLINEA 0000H 0001H 0C14H 0007H 0046H
	rb	0f25dh.2

;;      PB2MD0  = 1;      
CLINEA 0000H 0001H 0C15H 0007H 0018H
	sb	0f25ch.2

;;      PECS1 = 0;        //00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 0C19H 0007H 002FH
	rb	0f936h.1

;;      PECS0 = 1;
CLINEA 0000H 0001H 0C1AH 0007H 0010H
	sb	0f936h.0

;;      PWEP = PWMPeriod;            // Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0C1DH 0007H 0092H
	l	er0,	NEAR _PWMPeriod
	st	er0,	0f930h

;;      PWED =    PWMSafeDuty;           //12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 0C27H 0007H 004BH
	l	er0,	NEAR _PWMSafeDuty
	st	er0,	0f932h

;;      PERUN = 0;        // OFF to start
CLINEA 0000H 0001H 0C29H 0007H 0027H
	rb	0f937h.0
CBLOCKEND 216 2 3114

;;}
CLINEA 0000H 0001H 0C2AH 0001H 0001H
	rt
CBLOCKEND 216 1 3114
CFUNCTIONEND 216
...
;;void ESC3_PWM(void){
CLINEA 0000H 0001H 0C30H 0001H 0014H
CBLOCK 217 2 3120

;;      PA1DIR = 0;       // PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0C3FH 0007H 003BH
	rb	0f251h.1

;;      PA1C1  = 1;       // PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0C42H 0007H 003BH
	sb	0f253h.1

;;      PA1C0  = 1;       
CLINEA 0000H 0001H 0C43H 0007H 0018H
	sb	0f252h.1

;;      PA1MD1  = 0;            // PortB Bit0 set to PWM Output (0,1)...
CLINEA 0000H 0001H 0C46H 0007H 0046H
	rb	0f255h.1

;;      PA1MD0  = 1;      
CLINEA 0000H 0001H 0C47H 0007H 0018H
	sb	0f254h.1

;;      PDCS1 = 0;        //00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 0C4BH 0007H 002FH
	rb	0f926h.1

;;      PDCS0 = 1;
CLINEA 0000H 0001H 0C4CH 0007H 0010H
	sb	0f926h.0

;;      PWDP = PWMPeriod;            // Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0C4FH 0007H 0092H
	l	er0,	NEAR _PWMPeriod
	st	er0,	0f920h

;;      PWDD =    PWMSafeDuty;           //12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 0C59H 0007H 004BH
	l	er0,	NEAR _PWMSafeDuty
	st	er0,	0f922h

;;      PDRUN = 0;        // OFF to start
CLINEA 0000H 0001H 0C5BH 0007H 0027H
	rb	0f927h.0
CBLOCKEND 217 2 3164

;;}
CLINEA 0000H 0001H 0C5CH 0001H 0001H
	rt
CBLOCKEND 217 1 3164
CFUNCTIONEND 217
...
;;void ESC4_PWM(void){
CLINEA 0000H 0001H 0C63H 0001H 0014H
CBLOCK 218 2 3171

;;      PA0DIR = 0;       // PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0C72H 0007H 003BH
	rb	0f251h.0

;;      PA0C1  = 1;       // PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0C75H 0007H 003BH
	sb	0f253h.0

;;      PA0C0  = 1;       
CLINEA 0000H 0001H 0C76H 0007H 0018H
	sb	0f252h.0

;;      PA0MD1  = 0;            // PortB Bit0 set to PWM Output (0,1)...
CLINEA 0000H 0001H 0C79H 0007H 0046H
	rb	0f255h.0

;;      PA0MD0  = 1;      
CLINEA 0000H 0001H 0C7AH 0007H 0018H
	sb	0f254h.0

;;      PCCS1 = 0;        //00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 0C7EH 0007H 002FH
	rb	0f916h.1

;;      PCCS0 = 1;
CLINEA 0000H 0001H 0C7FH 0007H 0010H
	sb	0f916h.0

;;      PWCP = PWMPeriod;            // Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0C82H 0007H 0092H
	l	er0,	NEAR _PWMPeriod
	st	er0,	0f910h

;;      PWCD =    PWMSafeDuty;           //12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 0C8DH 0007H 004BH
	l	er0,	NEAR _PWMSafeDuty
	st	er0,	0f912h

;;      PCRUN = 0;        // OFF to start
CLINEA 0000H 0001H 0C91H 0007H 0027H
	rb	0f917h.0
CBLOCKEND 218 2 3218

;;}
CLINEA 0000H 0001H 0C92H 0001H 0001H
	rt
CBLOCKEND 218 1 3218
CFUNCTIONEND 218
...
;;{
CLINEA 0000H 0001H 0C97H 0001H 0001H
CBLOCK 256 2 3223

;;	E128H = 0;	//Turn OFF TBC Interrupt
CLINEA 0000H 0001H 0C98H 0002H 0024H
	rb	0f016h.5

;;	E128H = 1;	//Turn ON TBC Interrupt
CLINEA 0000H 0001H 0C99H 0002H 0023H
	sb	0f016h.5
CBLOCKEND 256 2 3226

;;}
CLINEA 0000H 0001H 0C9AH 0001H 0001H
	rt
CBLOCKEND 256 1 3226
CFUNCTIONEND 256
...
;;	LED_1 ^= 1;
CLINEA 0000H 0001H 0CA0H 0002H 000CH
	tb	0f250h.2
	beq	_$M58
	rb	0f250h.2
	bal	_$M59
...
CLINEA 0000H 0000H 0CA7H 0002H 001CH
	l	er0,	NEAR _Accel_PID_XRollCounter_I
	add	er0,	#1 
	st	er0,	NEAR _Accel_PID_XRollCounter_I

;;	if(Accel_PID_XRollCounter_I >= 65535){
CLINEA 0000H 0001H 0CA8H 0002H 0027H
	mov	er2,	#0 
	cmp	r0,	#0ffh
	cmpc	r1,	#0ffh
	cmpc	r2,	#00h
...
;;		Accel_PID_XRollCounter_I = 0;
CLINEA 0000H 0001H 0CA9H 0003H 001FH
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_XRollCounter_I
CBLOCKEND 257 3 3242

;;	}
CLINEA 0000H 0000H 0CAAH 0002H 0002H
_$L635 :

;;	Accel_PID_YPitchCounter_I++;
CLINEA 0000H 0000H 0CABH 0002H 001DH
	l	er0,	NEAR _Accel_PID_YPitchCounter_I
	add	er0,	#1 
	st	er0,	NEAR _Accel_PID_YPitchCounter_I

;;	if(Accel_PID_YPitchCounter_I >= 65535){
CLINEA 0000H 0001H 0CACH 0002H 0028H
	mov	er2,	#0 
	cmp	r0,	#0ffh
	cmpc	r1,	#0ffh
	cmpc	r2,	#00h
...
;;		Accel_PID_YPitchCounter_I = 0;
CLINEA 0000H 0001H 0CADH 0003H 0020H
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_YPitchCounter_I
CBLOCKEND 257 4 3246

;;	}
CLINEA 0000H 0000H 0CAEH 0002H 0002H
_$L637 :

;;	Accel_PID_XRollCounter_D++;
CLINEA 0000H 0000H 0CAFH 0002H 001CH
	l	er0,	NEAR _Accel_PID_XRollCounter_D
	add	er0,	#1 
	st	er0,	NEAR _Accel_PID_XRollCounter_D

;;	if(Accel_PID_XRollCounter_D >= 65535){
CLINEA 0000H 0001H 0CB0H 0002H 0027H
	mov	er2,	#0 
	cmp	r0,	#0ffh
	cmpc	r1,	#0ffh
	cmpc	r2,	#00h
...
;;		Accel_PID_XRollCounter_D = 0;
CLINEA 0000H 0001H 0CB1H 0003H 001FH
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_XRollCounter_D
CBLOCKEND 257 5 3250

;;	}
CLINEA 0000H 0000H 0CB2H 0002H 0002H
_$L639 :

;;	Accel_PID_YPitchCounter_D++;
CLINEA 0000H 0000H 0CB3H 0002H 001DH
	l	er0,	NEAR _Accel_PID_YPitchCounter_D
	add	er0,	#1 
	st	er0,	NEAR _Accel_PID_YPitchCounter_D

;;	if(Accel_PID_YPitchCounter_D >= 65535){
CLINEA 0000H 0001H 0CB4H 0002H 0028H
	mov	er2,	#0 
	cmp	r0,	#0ffh
	cmpc	r1,	#0ffh
	cmpc	r2,	#00h
...
;;		Accel_PID_YPitchCounter_D = 0;
CLINEA 0000H 0001H 0CB5H 0003H 0020H
	mov	er0,	#0 
	st	er0,	NEAR _Accel_PID_YPitchCounter_D
CBLOCKEND 257 6 3254

;;	}
CLINEA 0000H 0000H 0CB6H 0002H 0002H
_$L641 :

;;	CF_Gyro_Counter++;
CLINEA 0000H 0000H 0CBDH 0002H 0013H
	l	er0,	NEAR _CF_Gyro_Counter
	l	er2,	NEAR _CF_Gyro_Counter+02h
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0001H 0CBEH 0002H 001EH
	push	xr0
	mov	r0,	#00h
	mov	r1,	#0ffh
	mov	r2,	#07fh
...
;;		CF_Gyro_Counter = 0;
CLINEA 0000H 0001H 0CBFH 0003H 0016H
	mov	er0,	#0 
	st	er0,	NEAR _CF_Gyro_Counter
	st	er0,	NEAR _CF_Gyro_Counter+02h
CBLOCKEND 257 7 3264

;;	}
CLINEA 0000H 0000H 0CC0H 0002H 0002H
_$L643 :
CBLOCKEND 257 2 3265

;;}
CLINEA 0000H 0001H 0CC1H 0001H 0001H
	pop	pc
CBLOCKEND 257 1 3265
CFUNCTIONEND 257
...
;;{
CLINEA 0000H 0001H 0CC5H 0001H 0001H
CBLOCK 258 2 3269

;;	AccGyro_ReadFlag = 1;
CLINEA 0000H 0001H 0CC6H 0002H 0016H
	mov	r0,	#01h
	st	r0,	NEAR _AccGyro_ReadFlag
CBLOCKEND 258 2 3271

;;}
CLINEA 0000H 0001H 0CC7H 0001H 0001H
	rt
CBLOCKEND 258 1 3271
CFUNCTIONEND 258
...
CLINEA 0000H 0001H 0CD3H 0002H 0054H
	bl	_uart_continue

;;	_flgUartFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0CD4H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __flgUartFin
CBLOCKEND 245 2 3286

;;}
CLINEA 0000H 0001H 0CD6H 0001H 0001H
	pop	pc
CBLOCKEND 245 1 3286
CFUNCTIONEND 245
...
;;{
CLINEA 0000H 0001H 0CE1H 0001H 0001H
	push	lr
CBLOCK 246 2 3297
CRET 0000H
CARGUMENT 46H 0002H 0000H "size" 02H 00H 01H
...
CLINEA 0000H 0001H 0CE2H 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0CE3H 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin
CBLOCKEND 246 2 3301

;;}
CLINEA 0000H 0001H 0CE5H 0001H 0001H
	pop	pc
CBLOCKEND 246 1 3301
CFUNCTIONEND 246
...
;;	i2c_continue();
CLINEA 0000H 0001H 0CF0H 0002H 0010H
	b	_i2c_continue
CBLOCKEND 250 2 3314
CLINEA 0000H 0001H 0CF2H 0001H 0001H
CBLOCKEND 250 1 3314
CFUNCTIONEND 250
...
;;{
CLINEA 0000H 0001H 0CFCH 0001H 0001H
	push	lr
CBLOCK 247 2 3324
CRET 0000H
...
;;	while (ret != 1) {
CLINEA 0000H 0000H 0D01H 0002H 0013H
_$L652 :
CBLOCK 247 3 3329

;;		ret = i2c_continue();
CLINEA 0000H 0000H 0D02H 0003H 0017H
	bl	_i2c_continue
CBLOCK 247 4 3331
CBLOCKEND 247 4 3333
CBLOCKEND 247 3 3334

;;	while (ret != 1) {
CLINEA 0000H 0000H 0D01H 000EH 0013H
	cmp	r0,	#01h
	cmpc	r1,	#00h
	bne	_$L652
CBLOCKEND 247 2 3335

;;}
CLINEA 0000H 0001H 0D07H 0001H 0001H
	pop	pc
CBLOCKEND 247 1 3335
CFUNCTIONEND 247
...
CLINEA 0000H 0001H 0D12H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __reqNotHalt
CBLOCKEND 248 2 3347

;;}
CLINEA 0000H 0001H 0D13H 0001H 0001H
	rt
CBLOCKEND 248 1 3347
CFUNCTIONEND 248
...
;;{
CLINEA 0000H 0001H 0D1DH 0001H 0001H
CBLOCK 249 2 3357

;;		uart_continue(); //in UART.c: process to continue send and receive...
CLINEA 0000H 0001H 0D1EH 0003H 0047H
	b	_uart_continue
CBLOCKEND 249 2 3359
CLINEA 0000H 0001H 0D1FH 0001H 0001H
CBLOCKEND 249 1 3359
CFUNCTIONEND 249
...
CLINEA 0000H 0001H 0D24H 0001H 0019H
CBLOCK 208 2 3364

;;	SYSC0 = 0;			// Used to select the frequency of the HSCLK => 00=8.192MHz.
CLINEA 0000H 0001H 0D27H 0002H 004AH
	rb	0f002h.0

;;	SYSC1 = 0;
CLINEA 0000H 0001H 0D28H 0002H 000BH
	rb	0f002h.1

;;	OSCM1 = 1;			// 10 => Built-in PLL oscillation mode
CLINEA 0000H 0001H 0D2AH 0002H 0034H
	sb	0f002h.3

;;	OSCM0 = 0;
CLINEA 0000H 0001H 0D2BH 0002H 000BH
	rb	0f002h.2
...
CLINEA 0000H 0001H 0D2EH 0002H 0022H
	sb	0f003h.0

;;	LPLL = 1;			//1=Enables the use of PLL oscillation - ADDED 4/30/2013
CLINEA 0000H 0001H 0D30H 0002H 0045H
	sb	0f003h.7

;;	__EI();			//INT enable
CLINEA 0000H 0001H 0D32H 0002H 0017H
	ei
CBLOCKEND 208 2 3379

;;}
CLINEA 0000H 0001H 0D33H 0001H 0001H
	rt
CBLOCKEND 208 1 3379
CFUNCTIONEND 208
...
CLINEA 0000H 0001H 0D3AH 0001H 001DH
CBLOCK 209 2 3386

;;	CMP0EN  = 0x01; 	// Comparator ON...
CLINEA 0000H 0001H 0D50H 0002H 0025H
	sb	0f950h.0

;;	CMP0E1  = 0x00; 	// No Interupt...
CLINEA 0000H 0001H 0D51H 0002H 0023H
	rb	0f951h.1

;;	CMP0E0  = 0x00;
CLINEA 0000H 0001H 0D52H 0002H 0010H
	rb	0f951h.0

;;	CMP0SM1 = 0x00; 	// Detect without Sampling... 
CLINEA 0000H 0001H 0D53H 0002H 0030H
	rb	0f951h.3

;;	CMP0RFS = 0x01; 	// Differential Input on B5
CLINEA 0000H 0001H 0D54H 0002H 002DH
	sb	0f951h.4

;;	CMP0EN  = 0x00;
CLINEA 0000H 0001H 0D57H 0002H 0010H
	rb	0f950h.0
CBLOCKEND 209 2 3418

;;}
CLINEA 0000H 0001H 0D5AH 0001H 0001H
	rt
CBLOCKEND 209 1 3418
CFUNCTIONEND 209
...
;;	PA1C0  = 1;	
CLINEA 0000H 0001H 0D74H 0002H 000DH
	sb	0f252h.1
...
;;	PA2C0  = 1;	
CLINEA 0000H 0001H 0D76H 0002H 000DH
	sb	0f252h.2

;;	PA0MD1  = 0;	// PortA Bit0 set to General Purpose Output...
CLINEA 0000H 0001H 0D79H 0002H 003CH
	rb	0f255h.0
...
CLINEA 0000H 0001H 0D7BH 0002H 003CH
	rb	0f255h.1

;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 0D7CH 0002H 000EH
	rb	0f254h.1

;;	PA2MD1  = 0;	// PortA Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 0D7DH 0002H 003CH
	rb	0f255h.2

;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 0D7EH 0002H 000EH
	rb	0f254h.2

;;	PA0D = 0;		// A.0 Output OFF....
CLINEA 0000H 0001H 0D81H 0002H 0021H
	rb	0f250h.0

;;	PA1D = 0;		// A.1 Output OFF....
CLINEA 0000H 0001H 0D82H 0002H 0021H
	rb	0f250h.1

;;	PA2D = 0;		// A.2 Output OFF....
CLINEA 0000H 0001H 0D83H 0002H 0021H
	rb	0f250h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0D85H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 210 2 3463
CLINEA 0000H 0001H 0D87H 0001H 0001H
CBLOCKEND 210 1 3463
CFUNCTIONEND 210
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 0D8DH 0001H 0015H
CBLOCK 211 2 3469

;;	PB0DIR = 0;		// PortB Bit0 set to Output Mode...
CLINEA 0000H 0001H 0D97H 0002H 0031H
	rb	0f259h.0

;;	PB1DIR = 0;		// PortB Bit1 set to Output Mode...
CLINEA 0000H 0001H 0D98H 0002H 0031H
	rb	0f259h.1

;;	PB2DIR = 0;		// PortB Bit2 set to Output Mode...
CLINEA 0000H 0001H 0D99H 0002H 0031H
	rb	0f259h.2

;;	PB3DIR = 0;		// PortB Bit3 set to Output Mode...
CLINEA 0000H 0001H 0D9AH 0002H 0031H
	rb	0f259h.3

;;	PB4DIR = 0;		// PortB Bit4 set to Output Mode...
CLINEA 0000H 0001H 0D9BH 0002H 0031H
	rb	0f259h.4

;;	PB5DIR = 0;		// PortB Bit5 set to Output Mode...
CLINEA 0000H 0001H 0D9CH 0002H 0031H
	rb	0f259h.5

;;	PB6DIR = 0;		// PortB Bit6 set to Output Mode...
CLINEA 0000H 0001H 0D9DH 0002H 0031H
	rb	0f259h.6

;;	PB7DIR = 0;		// PortB Bit7 set to Output Mode...
CLINEA 0000H 0001H 0D9EH 0002H 0031H
	rb	0f259h.7

;;	PB0C1  = 1;		// PortB Bit0 set to CMOS Output...
CLINEA 0000H 0001H 0DA1H 0002H 0031H
	sb	0f25bh.0

;;	PB0C0  = 1;		
CLINEA 0000H 0001H 0DA2H 0002H 000EH
	sb	0f25ah.0

;;	PB1C1  = 1;		// PortB Bit1 set to CMOS Output...
CLINEA 0000H 0001H 0DA3H 0002H 0031H
	sb	0f25bh.1

;;	PB1C0  = 1;	
CLINEA 0000H 0001H 0DA4H 0002H 000DH
	sb	0f25ah.1

;;	PB2C1  = 1;		// PortB Bit2 set to CMOS Output...
CLINEA 0000H 0001H 0DA5H 0002H 0031H
	sb	0f25bh.2

;;	PB2C0  = 1;	
CLINEA 0000H 0001H 0DA6H 0002H 000DH
	sb	0f25ah.2

;;	PB3C1  = 1;		// PortB Bit3 set to CMOS Output...
CLINEA 0000H 0001H 0DA7H 0002H 0031H
	sb	0f25bh.3

;;	PB3C0  = 1;		
CLINEA 0000H 0001H 0DA8H 0002H 000EH
	sb	0f25ah.3

;;	PB4C1  = 1;		// PortB Bit4 set to CMOS Output...
CLINEA 0000H 0001H 0DA9H 0002H 0031H
	sb	0f25bh.4

;;	PB4C0  = 1;	
CLINEA 0000H 0001H 0DAAH 0002H 000DH
	sb	0f25ah.4

;;	PB5C1  = 1;		// PortB Bit5 set to CMOS Output...
CLINEA 0000H 0001H 0DABH 0002H 0031H
	sb	0f25bh.5
...
CLINEA 0000H 0001H 0DADH 0002H 0031H
	sb	0f25bh.6
...
;;	PB7C0  = 1;	
CLINEA 0000H 0001H 0DB0H 0002H 000DH
	sb	0f25ah.7

;;	PB0MD1  = 0;	// PortB Bit0 set to General Purpose Output...
CLINEA 0000H 0001H 0DB3H 0002H 003CH
	rb	0f25dh.0
...
CLINEA 0000H 0001H 0DB5H 0002H 003CH
	rb	0f25dh.1
...
CLINEA 0000H 0001H 0DB7H 0002H 003CH
	rb	0f25dh.2
...
CLINEA 0000H 0001H 0DB9H 0002H 003CH
	rb	0f25dh.3

;;	PB3MD0  = 0;	
CLINEA 0000H 0001H 0DBAH 0002H 000EH
	rb	0f25ch.3

;;	PB4MD1  = 0;	// PortB Bit4 set to General Purpose Output...
CLINEA 0000H 0001H 0DBBH 0002H 003CH
	rb	0f25dh.4

;;	PB4MD0  = 0;	
CLINEA 0000H 0001H 0DBCH 0002H 000EH
	rb	0f25ch.4

;;	PB5MD1  = 0;	// PortB Bit5 set to General Purpose Output...
CLINEA 0000H 0001H 0DBDH 0002H 003CH
	rb	0f25dh.5

;;	PB5MD0  = 0;
CLINEA 0000H 0001H 0DBEH 0002H 000DH
	rb	0f25ch.5

;;	PB6MD1  = 0;	// PortB Bit6 set to General Purpose Output...
CLINEA 0000H 0001H 0DBFH 0002H 003CH
	rb	0f25dh.6

;;	PB6MD0  = 0;	
CLINEA 0000H 0001H 0DC0H 0002H 000EH
	rb	0f25ch.6

;;	PB7MD1  = 0;	// PortB Bit7 set to General Purpose Output...
CLINEA 0000H 0001H 0DC1H 0002H 003CH
	rb	0f25dh.7

;;	PB7MD0  = 0;
CLINEA 0000H 0001H 0DC2H 0002H 000DH
	rb	0f25ch.7

;;	PB0D = 0;		// B.0 Output OFF....
CLINEA 0000H 0001H 0DC5H 0002H 0021H
	rb	0f258h.0

;;	PB1D = 0;		// B.1 Output OFF....
CLINEA 0000H 0001H 0DC6H 0002H 0021H
	rb	0f258h.1

;;	PB2D = 0;		// B.2 Output OFF....
CLINEA 0000H 0001H 0DC7H 0002H 0021H
	rb	0f258h.2

;;	PB3D = 0;		// B.3 Output OFF....
CLINEA 0000H 0001H 0DC8H 0002H 0021H
	rb	0f258h.3

;;	PB4D = 0;		// B.4 Output OFF....
CLINEA 0000H 0001H 0DC9H 0002H 0021H
	rb	0f258h.4
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0DCEH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 211 2 3536
CLINEA 0000H 0001H 0DD0H 0001H 0001H
CBLOCKEND 211 1 3536
CFUNCTIONEND 211
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 0DD6H 0001H 0015H
CBLOCK 212 2 3542

;;	PC0DIR = 0;		// PortC Bit0 set to Output Mode...
CLINEA 0000H 0001H 0DE0H 0002H 0031H
	rb	0f261h.0

;;	PC1DIR = 0;		// PortC Bit1 set to Output Mode...
CLINEA 0000H 0001H 0DE1H 0002H 0031H
	rb	0f261h.1

;;	PC2DIR = 0;		// PortC Bit2 set to Output Mode...
CLINEA 0000H 0001H 0DE2H 0002H 0031H
	rb	0f261h.2

;;	PC3DIR = 0;		// PortC Bit3 set to Output Mode...
CLINEA 0000H 0001H 0DE3H 0002H 0031H
	rb	0f261h.3

;;	PC4DIR = 0;		// PortC Bit4 set to Output Mode...
CLINEA 0000H 0001H 0DE4H 0002H 0031H
	rb	0f261h.4

;;	PC5DIR = 0;		// PortC Bit5 set to Output Mode...
CLINEA 0000H 0001H 0DE5H 0002H 0031H
	rb	0f261h.5

;;	PC6DIR = 0;		// PortC Bit6 set to Output Mode...
CLINEA 0000H 0001H 0DE6H 0002H 0031H
	rb	0f261h.6

;;	PC7DIR = 0;		// PortC Bit7 set to Output Mode...
CLINEA 0000H 0001H 0DE7H 0002H 0031H
	rb	0f261h.7

;;	PC0C1  = 1;		// PortC Bit0 set to High-Impedance Output...
CLINEA 0000H 0001H 0DEAH 0002H 003BH
	sb	0f263h.0
...
CLINEA 0000H 0001H 0DECH 0002H 003BH
	sb	0f263h.1
...
CLINEA 0000H 0001H 0DEEH 0002H 003BH
	sb	0f263h.2
...
CLINEA 0000H 0001H 0DF0H 0002H 003BH
	sb	0f263h.3

;;	PC3C0  = 1;		
CLINEA 0000H 0001H 0DF1H 0002H 000EH
	sb	0f262h.3

;;	PC4C1  = 1;		// PortC Bit4 set to High-Impedance Output...
CLINEA 0000H 0001H 0DF2H 0002H 003BH
	sb	0f263h.4

;;	PC4C0  = 1;	
CLINEA 0000H 0001H 0DF3H 0002H 000DH
	sb	0f262h.4

;;	PC5C1  = 1;		// PortC Bit5 set to High-Impedance Output...
CLINEA 0000H 0001H 0DF4H 0002H 003BH
	sb	0f263h.5

;;	PC5C0  = 1;	
CLINEA 0000H 0001H 0DF5H 0002H 000DH
	sb	0f262h.5

;;	PC6C1  = 1;		// PortC Bit6 set to High-Impedance Output...
CLINEA 0000H 0001H 0DF6H 0002H 003BH
	sb	0f263h.6

;;	PC6C0  = 1;	
CLINEA 0000H 0001H 0DF7H 0002H 000DH
	sb	0f262h.6

;;	PC7C1  = 1;		// PortC Bit7 set to High-Impedance Output...
CLINEA 0000H 0001H 0DF8H 0002H 003BH
	sb	0f263h.7

;;	PC7C0  = 1;	
CLINEA 0000H 0001H 0DF9H 0002H 000DH
	sb	0f262h.7

;;	PC0MD1  = 0;	// PortC Bit0 set to General Purpose Output...
CLINEA 0000H 0001H 0DFCH 0002H 003CH
	rb	0f265h.0

;;	PC0MD0  = 0;	
CLINEA 0000H 0001H 0DFDH 0002H 000EH
	rb	0f264h.0

;;	PC1MD1  = 0;	// PortC Bit1 set to General Purpose Output...
CLINEA 0000H 0001H 0DFEH 0002H 003CH
	rb	0f265h.1

;;	PC1MD0  = 0;	
CLINEA 0000H 0001H 0DFFH 0002H 000EH
	rb	0f264h.1

;;	PC2MD1  = 0;	// PortC Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 0E00H 0002H 003CH
	rb	0f265h.2

;;	PC2MD0  = 0;	
CLINEA 0000H 0001H 0E01H 0002H 000EH
	rb	0f264h.2

;;	PC3MD1  = 0;	// PortC Bit3 set to General Purpose Output...
CLINEA 0000H 0001H 0E02H 0002H 003CH
	rb	0f265h.3

;;	PC3MD0  = 0;	
CLINEA 0000H 0001H 0E03H 0002H 000EH
	rb	0f264h.3

;;	PC4MD1  = 0;	// PortC Bit4 set to General Purpose Output...
CLINEA 0000H 0001H 0E04H 0002H 003CH
	rb	0f265h.4

;;	PC4MD0  = 0;	
CLINEA 0000H 0001H 0E05H 0002H 000EH
	rb	0f264h.4

;;	PC5MD1  = 0;	// PortC Bit5 set to General Purpose Output...
CLINEA 0000H 0001H 0E06H 0002H 003CH
	rb	0f265h.5

;;	PC5MD0  = 0;
CLINEA 0000H 0001H 0E07H 0002H 000DH
	rb	0f264h.5

;;	PC6MD1  = 0;	// PortC Bit6 set to General Purpose Output...
CLINEA 0000H 0001H 0E08H 0002H 003CH
	rb	0f265h.6

;;	PC6MD0  = 0;	
CLINEA 0000H 0001H 0E09H 0002H 000EH
	rb	0f264h.6

;;	PC7MD1  = 0;	// PortC Bit7 set to General Purpose Output...
CLINEA 0000H 0001H 0E0AH 0002H 003CH
	rb	0f265h.7

;;	PC7MD0  = 0;
CLINEA 0000H 0001H 0E0BH 0002H 000DH
	rb	0f264h.7

;;	PC0D = 0;		// C.0 Output OFF....
CLINEA 0000H 0001H 0E0EH 0002H 0021H
	rb	0f260h.0

;;	PC1D = 0;		// C.1 Output OFF....
CLINEA 0000H 0001H 0E0FH 0002H 0021H
	rb	0f260h.1

;;	PC2D = 0;		// C.2 Output OFF....
CLINEA 0000H 0001H 0E10H 0002H 0021H
	rb	0f260h.2

;;	PC3D = 0;		// C.3 Output OFF....
CLINEA 0000H 0001H 0E11H 0002H 0021H
	rb	0f260h.3

;;	PC4D = 0;		// C.4 Output OFF....
CLINEA 0000H 0001H 0E12H 0002H 0021H
	rb	0f260h.4

;;	PC5D = 0;		// C.5 Output OFF....
CLINEA 0000H 0001H 0E13H 0002H 0021H
	rb	0f260h.5

;;	PC6D = 0;		// C.6 Output OFF....
CLINEA 0000H 0001H 0E14H 0002H 0021H
	rb	0f260h.6
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0E17H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 212 2 3609
CLINEA 0000H 0001H 0E19H 0001H 0001H
CBLOCKEND 212 1 3609
CFUNCTIONEND 212
...
;;void PortD_Low(void){
CLINEA 0000H 0001H 0E1FH 0001H 0015H
CBLOCK 213 2 3615

;;	PD0DIR = 0;		// PortD Bit0 set to Output Mode...
CLINEA 0000H 0001H 0E28H 0002H 0031H
	rb	0f269h.0
...
CLINEA 0000H 0001H 0E2AH 0002H 0031H
	rb	0f269h.2
...
CLINEA 0000H 0001H 0E2CH 0002H 0031H
	rb	0f269h.4
...
CLINEA 0000H 0001H 0E30H 0002H 002FH
	sb	0f26bh.0

;;	PD0C0= 1;		
CLINEA 0000H 0001H 0E31H 0002H 000CH
	sb	0f26ah.0

;;	PD1C1= 1;		// PortD Bit1 set to CMOS Output...
CLINEA 0000H 0001H 0E32H 0002H 002FH
	sb	0f26bh.1

;;	PD1C0= 1;	
CLINEA 0000H 0001H 0E33H 0002H 000BH
	sb	0f26ah.1

;;	PD2C1= 1;		// PortD Bit2 set to CMOS Output...
CLINEA 0000H 0001H 0E34H 0002H 002FH
	sb	0f26bh.2

;;	PD2C0= 1;	
CLINEA 0000H 0001H 0E35H 0002H 000BH
	sb	0f26ah.2

;;	PD3C1= 1;		// PortD Bit3 set to CMOS Output...
CLINEA 0000H 0001H 0E36H 0002H 002FH
	sb	0f26bh.3

;;	PD3C0= 1;		
CLINEA 0000H 0001H 0E37H 0002H 000CH
	sb	0f26ah.3

;;	PD4C1= 1;		// PortD Bit4 set to CMOS Output...
CLINEA 0000H 0001H 0E38H 0002H 002FH
	sb	0f26bh.4

;;	PD4C0= 1;	
CLINEA 0000H 0001H 0E39H 0002H 000BH
	sb	0f26ah.4

;;	PD5C1= 1;		// PortD Bit5 set to CMOS Output...
CLINEA 0000H 0001H 0E3AH 0002H 002FH
	sb	0f26bh.5

;;	PD5C0= 1;	
CLINEA 0000H 0001H 0E3BH 0002H 000BH
	sb	0f26ah.5

;;	PD0D = 0;		// D.0 Output OFF....
CLINEA 0000H 0001H 0E3EH 0002H 0021H
	rb	0f268h.0

;;	PD1D = 0;		// D.1 Output OFF....
CLINEA 0000H 0001H 0E3FH 0002H 0021H
	rb	0f268h.1

;;	PD2D = 0;		// D.2 Output OFF....
CLINEA 0000H 0001H 0E40H 0002H 0021H
	rb	0f268h.2

;;	PD3D = 0;		// D.3 Output OFF....
CLINEA 0000H 0001H 0E41H 0002H 0021H
	rb	0f268h.3

;;	PD4D = 0;		// D.4 Output OFF....
CLINEA 0000H 0001H 0E42H 0002H 0021H
	rb	0f268h.4

;;	PD5D = 0;		// D.5 Output OFF....
CLINEA 0000H 0001H 0E43H 0002H 0021H
	rb	0f268h.5

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0E46H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 213 2 3656
CLINEA 0000H 0001H 0E48H 0001H 0001H
CBLOCKEND 213 1 3656
CFUNCTIONEND 213
...
CLINEA 0000H 0001H 0E4EH 0001H 0020H
CBLOCK 214 2 3662

;;	PA0DIR = 1;		// PortA Bit0 set to Input Mode...
CLINEA 0000H 0001H 0E58H 0002H 0030H
	sb	0f251h.0

;;	PA1DIR = 1;		// PortA Bit1 set to Input Mode...
CLINEA 0000H 0001H 0E59H 0002H 0030H
	sb	0f251h.1

;;	PA2DIR = 1;		// PortA Bit2 set to Input Mode...
CLINEA 0000H 0001H 0E5AH 0002H 0030H
	sb	0f251h.2

;;	PA0C1  = 1;		// PortA Bit0 set to Input with Pull-Up Resistor...
CLINEA 0000H 0001H 0E5EH 0002H 0041H
	sb	0f253h.0
...
CLINEA 0000H 0001H 0E60H 0002H 0041H
	sb	0f253h.1

;;	PA1C0  = 0;	
CLINEA 0000H 0001H 0E61H 0002H 000DH
	rb	0f252h.1

;;	PA2C1  = 1;		// PortA Bit2 set to Input with Pull-Up Resistor...
CLINEA 0000H 0001H 0E62H 0002H 0041H
	sb	0f253h.2

;;	PA2C0  = 0;	
CLINEA 0000H 0001H 0E63H 0002H 000DH
	rb	0f252h.2

;;	PA0MD1  = 0;	// PortA Bit0 set to General Purpose I/O...
CLINEA 0000H 0001H 0E66H 0002H 0039H
	rb	0f255h.0
...
CLINEA 0000H 0001H 0E68H 0002H 0039H
	rb	0f255h.1

;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 0E69H 0002H 000EH
	rb	0f254h.1

;;	PA2MD1  = 0;	// PortA Bit2 set to General Purpose I/O...
CLINEA 0000H 0001H 0E6AH 0002H 0039H
	rb	0f255h.2

;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 0E6BH 0002H 000EH
	rb	0f254h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0E6DH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 214 2 3695
CLINEA 0000H 0001H 0E6FH 0001H 0001H
CBLOCKEND 214 1 3695
CFUNCTIONEND 214
...
;;	tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 0EB5H 0002H 0016H
	mov	r0,	#01h
	bl	_tm_init

;;	TempSec = sec;
CLINEA 0000H 0001H 0EB6H 0002H 000FH
	mov	r2,	r8

;;	TimeFlag = 0;
CLINEA 0000H 0001H 0EB7H 0002H 000EH
	mov	r4,	#00h
...
;;	if(sec == 1){
CLINEA 0000H 0001H 0EBCH 0002H 000EH
	cmp	r8,	#01h
	bne	_$L666
CBLOCK 251 3 3772

;;		timerThres = 0x7FFF;
CLINEA 0000H 0001H 0EBDH 0003H 0016H
	mov	r6,	#0ffh
	mov	r7,	#07fh

;;		TimeFlag = 0;
CLINEA 0000H 0001H 0EBEH 0003H 000FH
CBLOCKEND 251 3 3775

;;	}
CLINEA 0000H 0000H 0EBFH 0002H 0002H
_$L666 :

;;	if(sec == 2){
CLINEA 0000H 0001H 0EC0H 0002H 000EH
	cmp	r8,	#02h
	bne	_$L668
CBLOCK 251 4 3776

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0EC1H 0003H 0016H
	mov	er6,	#-1

;;		TimeFlag = 0;
CLINEA 0000H 0001H 0EC2H 0003H 000FH
	mov	r4,	#00h
CBLOCKEND 251 4 3779

;;	}
CLINEA 0000H 0000H 0EC3H 0002H 0002H
_$L668 :

;;	if(sec > 2){
CLINEA 0000H 0001H 0EC4H 0002H 000DH
	cmp	r8,	#02h
	ble	_$L678
CBLOCK 251 5 3780

;;	while(TempSec > 1){
CLINEA 0000H 0000H 0EC5H 0001H 0001H
	bal	_$L688

;;	while(TempSec > 1){
CLINEA 0000H 0000H 0EC5H 0002H 0014H
_$L674 :
CBLOCK 251 6 3781

;;		TempSec -= 2;
CLINEA 0000H 0001H 0EC6H 0003H 000FH
	add	r2,	#0feh

;;		TimeFlag++;
CLINEA 0000H 0000H 0EC7H 0003H 000DH
	add	r4,	#01h
CBLOCKEND 251 6 3784
...
;;	while(TempSec > 1){
CLINEA 0000H 0000H 0EC5H 000EH 0013H
	cmp	r2,	#01h
	bgt	_$L674

;;	if(TempSec == 1){
CLINEA 0000H 0001H 0EC9H 0002H 0012H
	cmp	r2,	#01h
	bne	_$L676
CBLOCK 251 7 3785

;;		timerThres = 0x7FFF;
CLINEA 0000H 0001H 0ECAH 0003H 0016H
	mov	r6,	#0ffh
	mov	r7,	#07fh
CBLOCKEND 251 7 3787

;;	else{
CLINEA 0000H 0001H 0ECCH 0002H 0006H
	bal	_$L678
_$L676 :
CBLOCK 251 8 3788

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0ECDH 0003H 0016H
	mov	er6,	#-1

;;		TimeFlag--;
CLINEA 0000H 0000H 0ECEH 0003H 000DH
	add	r4,	#0ffh
CBLOCKEND 251 8 3791

;;	}
CLINEA 0000H 0000H 0ECFH 0002H 0002H
_$L678 :
CBLOCKEND 251 5 3792

;;	main_clrWDT();	
CLINEA 0000H 0001H 0ED3H 0002H 0010H
	bl	_main_clrWDT
...
CLINEA 0000H 0001H 0ED7H 0002H 001BH
	bal	_$L681
_$L683 :
CBLOCK 251 9 3799
...
;;		timer = tm_getABCounter();
CLINEA 0000H 0000H 0ED8H 0003H 001CH
CBLOCKEND 251 9 3802

;;	}
CLINEA 0000H 0000H 0EDAH 0002H 0002H
_$L681 :

;;	while(timer < timerThres){
CLINEA 0000H 0000H 0ED7H 000EH 0013H
	cmp	er0,	er6
	blt	_$L683

;;	if(TimeFlag !=0){
CLINEA 0000H 0001H 0EDBH 0002H 0012H
	cmp	r4,	#00h
	beq	_$L686
...
;;		TimeFlag--;
CLINEA 0000H 0000H 0EDDH 0003H 000DH
	add	r4,	#0ffh

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0EDEH 0003H 0016H
	mov	er6,	#-1

;;		goto TimerRestart;
CLINEA 0000H 0001H 0EDFH 0003H 0014H
	bal	_$L678

;;	}
CLINEA 0000H 0000H 0EE0H 0002H 0002H
_$L686 :
CBLOCKEND 251 2 3809

;;}
CLINEA 0000H 0001H 0EE1H 0001H 0001H
	pop	er8
	pop	xr4
	pop	pc
CBLOCKEND 251 1 3809
CFUNCTIONEND 251
...
;;{
CLINEA 0000H 0001H 0EEEH 0001H 0001H
	push	lr
	push	xr4
	push	bp
	push	er8
...
;;TempSec = ms;
CLINEA 0000H 0001H 0EF5H 0001H 000DH
	mov	er4,	er0

;;TimeFlag = 0;
CLINEA 0000H 0001H 0EF6H 0001H 000DH
	mov	r6,	#00h

;;tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 0EF8H 0001H 0015H
	mov	r0,	#01h
	bl	_tm_init
...
;;if(ms < 128){
CLINEA 0000H 0001H 0EFCH 0001H 000DH
	mov	er0,	er8
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bge	_$L690
...
;;	timerThres = 0x1FF * ms;
CLINEA 0000H 0001H 0EFDH 0002H 0019H
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
...
;;	TimeFlag = 0;
CLINEA 0000H 0001H 0EFEH 0002H 000EH
CBLOCKEND 252 3 3839

;;}
CLINEA 0000H 0000H 0EFFH 0001H 0001H
_$L690 :

;;if(ms == 128){
CLINEA 0000H 0001H 0F00H 0001H 000EH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	bne	_$L692
CBLOCK 252 4 3840
...
;;	timerThres = 0xFFFF;
CLINEA 0000H 0001H 0F01H 0002H 0015H
	mov	bp,	#-1

;;	TimeFlag = 0;
CLINEA 0000H 0001H 0F02H 0002H 000EH
	mov	r6,	#00h
CBLOCKEND 252 4 3843

;;}
CLINEA 0000H 0000H 0F03H 0001H 0001H
_$L692 :

;;if(ms > 128){
CLINEA 0000H 0001H 0F04H 0001H 000DH
	cmp	r8,	#080h
	cmpc	r9,	#00h
	ble	_$L702
CBLOCK 252 5 3844
...
;;	while(TempSec > 128){
CLINEA 0000H 0000H 0F05H 0001H 0001H
	bal	_$L712

;;	while(TempSec > 128){
CLINEA 0000H 0000H 0F05H 0002H 0016H
_$L698 :
CBLOCK 252 6 3845

;;		TempSec -= 128;
CLINEA 0000H 0001H 0F06H 0003H 0011H
	add	r0,	#080h
	addc	r1,	#0ffh
	mov	er4,	er0

;;		TimeFlag++;
CLINEA 0000H 0000H 0F07H 0003H 000DH
	add	r6,	#01h
CBLOCKEND 252 6 3848
...
;;	while(TempSec > 128){
CLINEA 0000H 0000H 0F05H 000EH 0013H
	mov	er0,	er4
	cmp	r4,	#080h
	cmpc	r5,	#00h
	bgt	_$L698
...
;;	if(TempSec != 0){
CLINEA 0000H 0001H 0F09H 0002H 0012H
	mov	er4,	er4
	beq	_$L700
CBLOCK 252 7 3849

;;		timerThres = 0x1FF * TempSec;
CLINEA 0000H 0001H 0F0AH 0003H 001FH
	sllc	r1,	#07h
	sll	r0,	#07h
	sllc	r1,	#02h
	sll	r0,	#02h
	...
	subc	r1,	r5
	mov	bp,	er0
CBLOCKEND 252 7 3851

;;	else{
CLINEA 0000H 0001H 0F0CH 0002H 0006H
	bal	_$L702
_$L700 :
CBLOCK 252 8 3852

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0F0DH 0003H 0016H
	mov	bp,	#-1

;;		TimeFlag--;
CLINEA 0000H 0000H 0F0EH 0003H 000DH
	add	r6,	#0ffh
CBLOCKEND 252 8 3855

;;	}
CLINEA 0000H 0000H 0F0FH 0002H 0002H
_$L702 :
CBLOCKEND 252 5 3856

;;	main_clrWDT();	
CLINEA 0000H 0001H 0F13H 0002H 0010H
	bl	_main_clrWDT
...
;;	while(timer < timerThres){
CLINEA 0000H 0001H 0F17H 0002H 001BH
	bal	_$L705
_$L707 :
CBLOCK 252 9 3863
...
;;		timer = tm_getABCounter();
CLINEA 0000H 0000H 0F18H 0003H 001CH
CBLOCKEND 252 9 3866
...
;;	while(timer < timerThres){
CLINEA 0000H 0000H 0F17H 000EH 0013H
	cmp	er0,	bp
	blt	_$L707

;;	if(TimeFlag !=0){
CLINEA 0000H 0001H 0F1BH 0002H 0012H
	cmp	r6,	#00h
	beq	_$L710
...
;;		TimeFlag--;
CLINEA 0000H 0000H 0F1DH 0003H 000DH
	add	r6,	#0ffh

;;		timerThres = 0xFFFF;
CLINEA 0000H 0001H 0F1EH 0003H 0016H
	mov	bp,	#-1

;;		goto TimerRestart;
CLINEA 0000H 0001H 0F1FH 0003H 0014H
	bal	_$L702

;;	}
CLINEA 0000H 0000H 0F20H 0002H 0002H
_$L710 :
CBLOCKEND 252 2 3874

;;}
CLINEA 0000H 0001H 0F22H 0001H 0001H
	pop	er8
	pop	bp
	pop	xr4
	pop	pc
CBLOCKEND 252 1 3874
CFUNCTIONEND 252
...
;;{
CLINEA 0000H 0001H 0F2CH 0001H 0001H
CBLOCK 253 2 3884

;;	timer_us = 0;
CLINEA 0000H 0001H 0F2DH 0002H 000EH
	mov	er0,	#0 
	st	er0,	NEAR _timer_us

;;	TM8C = 0x00;
CLINEA 0000H 0001H 0F2EH 0002H 000DH
	st	r0,	0f8e1h

;;	ETM8 = 1;
CLINEA 0000H 0001H 0F2FH 0002H 000AH
	sb	0f013h.2

;;	while(timer_us == 0);
CLINEA 0000H 0000H 0F30H 0002H 0016H
_$L716 :
...
CLINEA 0000H 0000H 0F30H 000EH 0013H
	...
	beq	_$L716
CBLOCKEND 253 2 3889

;;}
CLINEA 0000H 0001H 0F31H 0001H 0001H
	rt
CBLOCKEND 253 1 3889
CFUNCTIONEND 253
...
;;{
CLINEA 0000H 0001H 0F34H 0001H 0001H
CBLOCK 254 2 3892
CLOCAL 4AH 0002H 0000H 0002H "ONCNT" 02H 00H 01H
CBLOCKEND 254 2 3898

;;}
CLINEA 0000H 0001H 0F3AH 0001H 0001H
	rt
CBLOCKEND 254 1 3898
CFUNCTIONEND 254
...
;;{
CLINEA 0000H 0001H 0F3DH 0001H 0001H
	push	lr
	push	fp
	mov	fp,	sp
	add	sp,	#-028
...
;;	float YoverX = y/x;
CLINEA 0000H 0001H 0F3EH 0002H 0014H
	push	xr0
	l	er0,	4[fp]
	l	er2,	6[fp]
	push	xr0
...
;;	float result = 0;
CLINEA 0000H 0001H 0F3FH 0002H 0012H
	mov	er4,	#0 
	mov	er6,	#0 

;;	if(x>0){
CLINEA 0000H 0001H 0F41H 0002H 0009H
	l	er0,	4[fp]
	l	er2,	6[fp]
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0000H 0F42H 0003H 0034H
	l	er0,	-28[fp]
	l	er2,	-26[fp]
	push	xr0
	add	sp,	#-4
	...
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 255 3 3907

;;	}
CLINEA 0000H 0000H 0F43H 0002H 0002H
_$L724 :

;;	if((x<0)&&(y>=0)){
CLINEA 0000H 0001H 0F44H 0002H 0013H
	l	er0,	4[fp]
	l	er2,	6[fp]
	push	xr0
	mov	er0,	#0 
...
CLINEA 0000H 0000H 0F45H 0003H 0039H
	l	er0,	-28[fp]
	l	er2,	-26[fp]
	push	xr0
	add	sp,	#-4
	...
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 255 4 3910

;;	}	
CLINEA 0000H 0000H 0F46H 0002H 0003H
_$L726 :

;;	if((y<0)&&(x<0)){
CLINEA 0000H 0001H 0F47H 0002H 0012H
	push	xr8
	mov	er0,	#0 
	mov	er2,	#0 
	push	xr0
...
;;		result = (0.97239*YoverX)-(0.19195*pow(YoverX,3))-3.14;
CLINEA 0000H 0000H 0F48H 0003H 0039H
	l	er0,	-28[fp]
	l	er2,	-26[fp]
	push	xr0
	add	sp,	#-4
	...
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 255 5 3913

;;	}
CLINEA 0000H 0000H 0F49H 0002H 0002H
_$L733 :

;;	if((y>0)&&(x==0)){
CLINEA 0000H 0001H 0F4AH 0002H 0013H
	push	xr8
	mov	er0,	#0 
	mov	er2,	#0 
	push	xr0
...
;;		result = 1.57;
CLINEA 0000H 0001H 0F4BH 0003H 0010H
	mov	r0,	#0c3h
	mov	r1,	#0f5h
	mov	r2,	#0c8h
	mov	r3,	#03fh
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 255 6 3916

;;	}
CLINEA 0000H 0000H 0F4CH 0002H 0002H
_$L740 :

;;	if((y<0)&&(x==0)){
CLINEA 0000H 0001H 0F4DH 0002H 0013H
	push	xr8
	mov	er0,	#0 
	mov	er2,	#0 
	push	xr0
...
;;		result = -1.57;
CLINEA 0000H 0001H 0F4EH 0003H 0011H
	mov	r0,	#0c3h
	mov	r1,	#0f5h
	mov	r2,	#0c8h
	mov	r3,	#0bfh
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 255 7 3919

;;	}
CLINEA 0000H 0000H 0F4FH 0002H 0002H
_$L747 :

;;	if((x==0)&&(y==0)){			//we made this up....
CLINEA 0000H 0001H 0F50H 0002H 002CH
	l	er0,	4[fp]
	l	er2,	6[fp]
	push	xr0
	mov	er0,	#0 
...
;;		result = (0.97239*YoverX)-(0.19195*pow(YoverX,3));
CLINEA 0000H 0000H 0F54H 0003H 0034H
	mov	er0,	#0 
	mov	er2,	#0 
	mov	er4,	#0 
	mov	r6,	#08h
	...
	mov	er4,	er0
	mov	er6,	er2
CBLOCKEND 255 8 3925

;;	}
CLINEA 0000H 0000H 0F55H 0002H 0002H
_$L754 :

;;	result *= 57.29;
CLINEA 0000H 0001H 0F56H 0002H 0011H
	push	xr4
	add	sp,	#-4
	bl	__ftodu8sw
	mov	r0,	#085h
...
;;	if(result > 45){
CLINEA 0000H 0001H 0F58H 0002H 0011H
	push	xr0
	mov	er0,	#0 
	mov	r2,	#034h
	mov	r3,	#042h
...
;;		result = 45;
CLINEA 0000H 0001H 0F59H 0003H 000EH
	mov	r2,	#034h
	mov	r3,	#042h
	mov	er4,	#0 
	mov	er6,	er2
CBLOCKEND 255 9 3930

;;	}
CLINEA 0000H 0000H 0F5AH 0002H 0002H
_$L761 :

;;	if(result < -45){
CLINEA 0000H 0001H 0F5BH 0002H 0012H
	push	xr4
	mov	er0,	#0 
	mov	r2,	#034h
	mov	r3,	#0c2h
...
;;		result = -45;
CLINEA 0000H 0001H 0F5CH 0003H 000FH
	mov	r2,	#034h
	mov	r3,	#0c2h
	mov	er4,	#0 
	mov	er6,	er2
CBLOCKEND 255 10 3933

;;	}
CLINEA 0000H 0000H 0F5DH 0002H 0002H
_$L763 :

;;	return(result);
CLINEA 0000H 0001H 0F5FH 0002H 0010H
	mov	er0,	er4
	mov	er2,	er6
CBLOCKEND 255 2 3936

;;}
CLINEA 0000H 0000H 0F60H 0001H 0001H
	pop	xr4
	pop	xr8
	mov	sp,	fp
	pop	fp
	pop	pc
CBLOCKEND 255 1 3936
CFUNCTIONEND 255
