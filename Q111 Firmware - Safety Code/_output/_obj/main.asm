...
CGLOBAL 00H 42H 0008H "RecWorld" 05H 01H 08H 00H 00H 00H
...
CFILE 0000H 00000351H "main\\main.c"
...
;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 00C8H 0003H 001AH
_$L12 :
CBLOCK 140 4 200

;;			NOP1000();
CLINEA 0000H 0001H 00C9H 0004H 000DH
	bl	_NOP1000

;;			main_clrWDT();
CLINEA 0000H 0001H 00CAH 0004H 0011H
	bl	_main_clrWDT
CBLOCKEND 140 4 203
...
CLINEA 0000H 0001H 00D0H 0003H 0034H
	l	r0,	NEAR _RecWorld
	cmp	r0,	#053h
	bne	_$L20
CBLOCK 140 5 208
...
;;			if(RecWorld[1] == 0x54){
CLINEA 0000H 0001H 00D1H 0004H 001BH
...
;;				if(RecWorld[2] == 0x4F){
CLINEA 0000H 0001H 00D2H 0005H 001CH
...
;;					if(RecWorld[3] == 0x50){
CLINEA 0000H 0001H 00D3H 0006H 001DH
...
;;						PA0D = 0;
CLINEA 0000H 0001H 00D4H 0007H 000FH
	rb	0f250h.0
CBLOCKEND 140 8 213

;;					}
CLINEA 0000H 0000H 00D5H 0006H 0006H
_$L20 :
CBLOCKEND 140 7 214
CBLOCKEND 140 6 215
CBLOCKEND 140 5 216
...
CLINEA 0000H 0001H 00DAH 0003H 0034H
	l	r0,	NEAR _RecWorld
	cmp	r0,	#050h
	bne	_$L3
CBLOCK 140 9 218
...
;;			if(RecWorld[1] == 0x4C){
CLINEA 0000H 0001H 00DBH 0004H 001BH
	l	r0,	NEAR _RecWorld+01h
	cmp	r0,	#04ch
	bne	_$L3
CBLOCK 140 10 219
...
;;				if(RecWorld[2] == 0x41){
CLINEA 0000H 0001H 00DCH 0005H 001CH
	l	r0,	NEAR _RecWorld+02h
	cmp	r0,	#041h
	bne	_$L3
CBLOCK 140 11 220
...
;;					if(RecWorld[3] == 0x59){
CLINEA 0000H 0001H 00DDH 0006H 001DH
	l	r0,	NEAR _RecWorld+03h
	cmp	r0,	#059h
	bne	_$L3
CBLOCK 140 12 221
...
;;						PA0D = 1;
CLINEA 0000H 0001H 00DEH 0007H 000FH
	sb	0f250h.0
CBLOCKEND 140 12 223

;;					}
CLINEA 0000H 0000H 00DFH 0006H 0006H
CBLOCKEND 140 11 224
CBLOCKEND 140 10 225
CBLOCKEND 140 9 226

;;goto Loop;
CLINEA 0000H 0001H 00E4H 0001H 000AH
	bal	_$L3
CBLOCKEND 140 2 230
...
;;	do {
CLINEA 0000H 0001H 0101H 0002H 0005H
_$L34 :
CBLOCK 124 3 257

;;		WDTCON = 0x5Au;
CLINEA 0000H 0001H 0102H 0003H 0011H
	mov	r0,	#05ah
	st	r0,	0f00eh
CBLOCKEND 124 3 259

;;	} while (WDP != 1);
CLINEA 0000H 0000H 0103H 0002H 0014H
	tb	0f00eh.0
	beq	_$L34

;;	WDTCON = 0xA5u;
CLINEA 0000H 0001H 0104H 0002H 0010H
	mov	r0,	#0a5h
	st	r0,	0f00eh
CBLOCKEND 124 2 261
...
CLINEA 0000H 0001H 0121H 0002H 0045H
	sb	0f02ah.0

;;	DUA0	= 0; // 0=> Enables the operation of UART0 (initial value).
CLINEA 0000H 0001H 0122H 0002H 0041H
	rb	0f02ah.2

;;	DUA1  = 1; // 0=> Enables Uart1 (initial value). 
CLINEA 0000H 0001H 0123H 0002H 0032H
	sb	0f02ah.3
...
CLINEA 0000H 0001H 012FH 0002H 0041H
	bl	_PortC_Low

;;	SetOSC(); //8MHz
CLINEA 0000H 0001H 0132H 0002H 0011H
	bl	_SetOSC

;;	irq_di(); 	//Disable Interrupts...
CLINEA 0000H 0001H 0159H 0002H 0023H
	bl	_irq_di

;;	irq_init();	//Initialize Interrupts (All Off and NO Requests)
CLINEA 0000H 0001H 015AH 0002H 003EH
	bl	_irq_init

;;	IE0 = IE1 = IE2 = IE3 = IE4 = IE5 = IE6 = IE7 = 0; // 0=DISABLED; 1=ENABLED
CLINEA 0000H 0001H 0165H 0002H 004CH
	mov	r0,	#00h
	st	r0,	0f017h
	st	r0,	0f016h
	st	r0,	0f015h
...
CLINEA 0000H 0001H 0170H 0002H 0053H
	st	r0,	0f01fh
	st	r0,	0f01eh
	st	r0,	0f01dh
	st	r0,	0f01ch
...
CLINEA 0000H 0001H 0171H 0002H 0046H
	rb	0f017h.3
...
CLINEA 0000H 0001H 0174H 0002H 003CH
...
;;	QI2CM = 1;
CLINEA 0000H 0001H 0177H 0002H 000BH
	sb	0f01ah.7

;;	EUA0 = 1; // EUA0 is the enable flag for the UART0 interrupt (1=ENABLED)
CLINEA 0000H 0001H 0178H 0002H 0049H
	sb	0f014h.0

;;	irq_ei();	// Enable Interrupts...
CLINEA 0000H 0001H 017AH 0002H 0022H
	bl	_irq_ei

;;	WDTMOD = 0x03; 	// 0x03=overflow 8sec...
CLINEA 0000H 0001H 017EH 0002H 0029H
	mov	r0,	#03h
	st	r0,	0f00fh

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 017FH 0002H 001DH
	bl	_main_clrWDT
...
;;	HelloWorld[14] 	= 0x0A;
CLINEA 0000H 0001H 0183H 0002H 0018H
	mov	r0,	#0ah
	st	r0,	NEAR _HelloWorld+0eh

;;	PA0DIR = 1;
CLINEA 0000H 0001H 0186H 0002H 000CH
	sb	0f251h.0
...
;;	PA0C1 = 1;
CLINEA 0000H 0001H 0188H 0002H 000BH
	sb	0f253h.0
...
;;	PA0MD1 = 0;
CLINEA 0000H 0001H 018AH 0002H 000CH
	rb	0f255h.0

;;	(void)i2c_init(I2C_MOD_FST, (unsigned short)HSCLK_KHZ, I2C_SYN_OFF);
CLINEA 0000H 0001H 01A5H 0002H 0045H
	mov	r0,	#00h
	push	r0
	mov	r2,	#040h
	mov	r3,	#01fh
...
;;			     &_uartSetParam );						/* Param... 	 */
CLINEA 0000H 0001H 01AAH 0009H 002FH
...
;;	uart_PortSet();
CLINEA 0000H 0001H 01ABH 0002H 0010H
	bl	_uart_PortSet

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 01ACH 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 01ADH 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(HelloWorld, 15, _funcUartFin); // Send, "Hello World!"
CLINEA 0000H 0001H 01AFH 0002H 0046H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	er2,	#15
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 01B0H 0001H 0015H
	bal	_$L46

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 01B0H 0002H 0019H
_$L44 :
CBLOCK 125 3 432

;;		NOP1000();
CLINEA 0000H 0001H 01B1H 0003H 000CH
	bl	_NOP1000

;;		main_clrWDT();
CLINEA 0000H 0001H 01B2H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 125 3 435
...
;;}//End Initialization
CLINEA 0000H 0001H 01B4H 0001H 0015H
	pop	pc
CBLOCKEND 125 1 436
CFUNCTIONEND 125
...
CLINEA 0000H 0001H 01C1H 0002H 0054H
	bl	_uart_continue
...
CLINEA 0000H 0001H 01C3H 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 133 2 452
...
CLINEA 0000H 0001H 01D0H 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 01D1H 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 01D2H 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 134 2 467
...
;;	(void)i2c_continue();
CLINEA 0000H 0001H 01DEH 0002H 0016H
	bl	_i2c_continue

;;	main_reqNotHalt();
CLINEA 0000H 0001H 01DFH 0002H 0013H
	bl	_main_reqNotHalt
CBLOCKEND 138 2 480
...
;;	while (ret != 1) {
CLINEA 0000H 0000H 01EFH 0002H 0013H
_$L53 :
CBLOCK 135 3 495

;;		ret = i2c_continue();
CLINEA 0000H 0000H 01F0H 0003H 0017H
	bl	_i2c_continue
CBLOCK 135 4 497
CBLOCKEND 135 4 499
CBLOCKEND 135 3 500
...
CLINEA 0000H 0001H 0200H 0002H 0026H
	mov	r0,	#01h
...
CLINEA 0000H 0001H 020CH 0003H 0047H
	b	_uart_continue
CBLOCKEND 137 2 525
...
CLINEA 0000H 0001H 0212H 0001H 0019H
CBLOCK 126 2 530

;;	SYSC0 = 0;			// Used to select the frequency of the HSCLK => 00=8.192MHz.
CLINEA 0000H 0001H 021BH 0002H 004AH
	rb	0f002h.0

;;	SYSC1 = 0;
CLINEA 0000H 0001H 021CH 0002H 000BH
	rb	0f002h.1

;;	OSCM1 = 1;			// 10 => Built-in PLL oscillation mode
CLINEA 0000H 0001H 021EH 0002H 0034H
	sb	0f002h.3

;;	OSCM0 = 0;
CLINEA 0000H 0001H 021FH 0002H 000BH
	rb	0f002h.2
...
CLINEA 0000H 0001H 0222H 0002H 0022H
	sb	0f003h.0
...
CLINEA 0000H 0001H 022FH 0001H 001DH
CBLOCK 127 2 559

;;	CMP0EN  = 0x01; 	// Comparator ON...
CLINEA 0000H 0001H 0245H 0002H 0025H
	sb	0f950h.0

;;	CMP0E1  = 0x00; 	// No Interupt...
CLINEA 0000H 0001H 0246H 0002H 0023H
	rb	0f951h.1

;;	CMP0E0  = 0x00;
CLINEA 0000H 0001H 0247H 0002H 0010H
	rb	0f951h.0

;;	CMP0SM1 = 0x00; 	// Detect without Sampling... 
CLINEA 0000H 0001H 0248H 0002H 0030H
	rb	0f951h.3

;;	CMP0RFS = 0x01; 	// Differential Input on B5
CLINEA 0000H 0001H 0249H 0002H 002DH
	sb	0f951h.4

;;	CMP0EN  = 0x00;
CLINEA 0000H 0001H 024CH 0002H 0010H
	rb	0f950h.0
CBLOCKEND 127 2 591
...
;;void PortA_Low(void){
CLINEA 0000H 0001H 0257H 0001H 0015H
CBLOCK 128 2 599
...
;;	PA1C0  = 1;	
CLINEA 0000H 0001H 0269H 0002H 000DH
	sb	0f252h.1
...
CLINEA 0000H 0001H 026EH 0002H 003CH
	rb	0f255h.0
...
CLINEA 0000H 0001H 0270H 0002H 003CH
	rb	0f255h.1
...
CLINEA 0000H 0001H 0272H 0002H 003CH
	rb	0f255h.2

;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 0273H 0002H 000EH
	rb	0f254h.2
...
CLINEA 0000H 0001H 0278H 0002H 0021H
	rb	0f250h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 027AH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 128 2 636
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 0282H 0001H 0015H
CBLOCK 129 2 642
...
;;	PB2C0  = 1;	
CLINEA 0000H 0001H 029BH 0002H 000DH
	sb	0f25ah.2

;;	PB3C1  = 1;		// PortB Bit3 set to CMOS Output...
CLINEA 0000H 0001H 029CH 0002H 0031H
	sb	0f25bh.3
...
;;	PB4C0  = 1;	
CLINEA 0000H 0001H 029FH 0002H 000DH
	sb	0f25ah.4

;;	PB5C1  = 1;		// PortB Bit5 set to CMOS Output...
CLINEA 0000H 0001H 02A0H 0002H 0031H
	sb	0f25bh.5
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 02C3H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 129 2 709
CLINEA 0000H 0001H 02C5H 0001H 0001H
CBLOCKEND 129 1 709
CFUNCTIONEND 129
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 02CBH 0001H 0015H
CBLOCK 130 2 715
...
;;	PC0C0  = 1;		
CLINEA 0000H 0001H 02DDH 0002H 000EH
	sb	0f262h.0
...
;;	PC1C0  = 1;	
CLINEA 0000H 0001H 02DFH 0002H 000DH
	sb	0f262h.1
...
;;	PC2C0  = 1;	
CLINEA 0000H 0001H 02E1H 0002H 000DH
	sb	0f262h.2
...
CLINEA 0000H 0001H 02E6H 0002H 003CH
	rb	0f265h.0
...
CLINEA 0000H 0001H 02E8H 0002H 003CH
	rb	0f265h.1
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 02F5H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 130 2 759
CLINEA 0000H 0001H 02F7H 0001H 0001H
CBLOCKEND 130 1 759
CFUNCTIONEND 130
...
CLINEA 0000H 0001H 02FDH 0001H 0020H
CBLOCK 131 2 765
...
CLINEA 0000H 0001H 0309H 0002H 0030H
	sb	0f251h.2

;;	PA0C1  = 1;		// PortA Bit0 set to Input with Pull-Up Resistor...
CLINEA 0000H 0001H 030DH 0002H 0041H
	sb	0f253h.0
...
CLINEA 0000H 0001H 030FH 0002H 0041H
	sb	0f253h.1
...
CLINEA 0000H 0001H 0311H 0002H 0041H
	sb	0f253h.2
...
CLINEA 0000H 0001H 0315H 0002H 0039H
	rb	0f255h.0
...
CLINEA 0000H 0001H 0317H 0002H 0039H
	rb	0f255h.1
...
CLINEA 0000H 0001H 0319H 0002H 0039H
	rb	0f255h.2
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 031CH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 131 2 798
...
;;void PinB0_PWM(void){
CLINEA 0000H 0001H 0326H 0001H 0015H
CBLOCK 132 2 806
...
CLINEA 0000H 0001H 0339H 0002H 0036H
	rb	0f25dh.0
...
CLINEA 0000H 0001H 033EH 0002H 0023H
	rb	0f916h.1

;;	PCCS0 = 1;
CLINEA 0000H 0001H 033FH 0002H 000BH
	sb	0f916h.0

;;	PWCP = 4250;		// Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 0342H 0002H 007EH
	mov	r0,	#09ah
	mov	r1,	#010h
	st	er0,	0f910h

;;	PWCD =    12;		//12    ~  0.25% duty cycle @ 160Hz
CLINEA 0000H 0001H 034CH 0002H 0033H
	mov	er0,	#12
	st	er0,	0f912h

;;	PCRUN = 0;		// OFF to start
CLINEA 0000H 0001H 034EH 0002H 001CH
	rb	0f917h.0
CBLOCKEND 132 2 848
